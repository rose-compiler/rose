...
export BOOST_ROOT="/home/dquinlan/local/boost_1_37_0_installTree-gxx-3.4.6"
...
# GCC 3.4.6 is a special case since there is no setup script
...
CONFIGURE_FLAGS=(--with-boost=${BOOST_ROOT} --with-CXX_DEBUG=-g --with-C_DEBUG=-g --with-CXX_WARNINGS=-Wall --with-CXXFLAGS=-fPIC --with-CFLAGS=-fPIC --prefix=${ROSE_TOP}/install "$@") 
