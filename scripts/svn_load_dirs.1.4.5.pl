...
# Grabbed from subversion's source repository 
#   svn co http://svn.collab.net/repos/svn/tags/1.4.5 subversion_1.4.5
#   cp ./contrib/client-side/svn_load_dirs.pl.in  svn_load_dirs.1.4.5.pl
#   Changed 
#      my $svn = '@SVN_BINDIR@/svn';
#   To our installation path of svn 
#      my $svn = '/nfs/apps/subversion/1.4.5/bin/svn';
# By Liao
#
# 7/29/2008
#
# $HeadURL: http://svn.collab.net/repos/svn/tags/1.4.5/contrib/client-side/svn_load_dirs.pl.in $
# $LastChangedDate: 2006-11-10 11:07:14 -0800 (Fri, 10 Nov 2006) $
# $LastChangedBy: dlr $
# $LastChangedRevision: 22266 $
