...
CONFIGURE_FLAGS=( --with-boost=${BOOST_ROOT} --with-pch --enable-dq-developer-tests --with-ROSE_LONG_MAKE_CHECK_RULE=yes --with-CXX_DEBUG=-g --with-C_DEBUG=-g --with-CXX_WARNINGS=-Wall --with-qt=/usr/apps/qt/4.4.2 --with-roseQt --with-haskell=/home/liao6/opt/ghc-6.10.4/bin --prefix=${ROSE_TOP}/install "$@")
