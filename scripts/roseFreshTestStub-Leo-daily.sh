...
CONFIGURE_FLAGS=( --with-boost=${BOOST_ROOT} --with-pch --enable-dq-developer-tests --with-ROSE_LONG_MAKE_CHECK_RULE=yes --with-CXX_DEBUG=-g --with-C_DEBUG=-g --with-CXX_WARNINGS=-Wall --with-qt=/usr/apps/qt/4.4.2 --with-roseQt --with-haskell=/home/liao6/opt/ghc-6.10.4/bin --with-omni_omp_runtime_support=/home/liao6/opt/omni-1.6/lib/openmp/lib --with-gomp_omp_runtime_library=/home/liao6/opt/gcc-svn/lib/ --prefix=${ROSE_TOP}/install "$@")
