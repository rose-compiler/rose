...
IndexOffsetExpressionQuerySynthesizedAttributeType
IndexOffsetQuery::transformation ( SgNode* astNode )
   {
...
#if 0
     printf ("End of Index Offset Query! exiting ... \n");
     ROSE_ABORT();
#endif
...
IndexOffsetExpressionQuerySynthesizedAttributeType
IndexOffsetQuery::evaluateSynthesizedAttribute (
   SgNode* astNode,
...
#if 0
               printf ("Exiting after handling general scalar expression: returnString = %s \n",returnString.c_str());
               ROSE_ABORT();
#endif
               break;
             }
               ...
               switch ( parentExpression->variant() )
                  {
                           ...
                           // have to be handled differently.
                              ...
                              case TransformationSupport::XOR_ASSIGN_OPERATOR_CODE:
                                ...
                                // useless test ???
                                   ...
                                   returnString =
                                        synthesizedAttributeList[0] + "$OPERATOR" + synthesizedAttributeList[1];
                                   break;
                                 }
                    ...
                    default:
                      ...
                      // Not really sure how to handle it since it depends upon what the parent is!
                         ...
                         printf ("In IndexOffsetQuery: parent of SgExprListExp is not a SgFunctionCallExp (need to allow for these cases explicitly) exiting ... \n");
                         ROSE_ABORT();
                       }
                  }
                    ...
                    case TransformationSupport::PARENTHESIS_OPERATOR_CODE:
                       {
                         ...
                         printf ("Indexing of InternalIndex objects using InternalIndex::operator() is not implemented yet! \n");
                         ROSE_ABORT();
                         break;
                       }
          ...
          case VAR_REF:
            ...
            // Check for any array objects (such as for indirect addressing)
               if ( typeName == "intArray" || typeName == "floatArray" || typeName == "doubleArray" )
                  {
                    printf ("Sorry, Indirect addressing not implemented yet (there should be no A++/P++ array objects defined within index expressions) \n");
                    ROSE_ABORT();
                  }
