...
string
ArrayOperandDataBase::displayString() const
   {
...
int
ArrayOperandDataBase::getDimension() const
   {
...
void
ArrayOperandDataBase::setDimension( int dim )
   {
...
ArrayOperandDataBase::getIndexingAccessCode() const
   {
...
void
ArrayOperandDataBase::setIndexingAccessCode( ArrayTransformationSupport::IndexingAccessEnumType code )
   {
  // specify the maximum dimension of all array operands in the array statement
...
string
ArrayOperandDataBase::generateIndexVariableArgumentList() const
   {
...
string
ArrayOperandDataBase::generateIndexIdentifierString() const
   {
  // Used to generate unique identifiers (degree of uniqueness can be improved later)
     string returnString;
...
string
ArrayOperandDataBase::generateIdentifierString() const
   {
  // Used to generate unique identifiers (degree of uniqueness can be improved later)
...
bool
ArrayOperandDataBase::operator== ( const ArrayOperandDataBase & X ) const
   {
...
void
ArrayOperandDataBase::merge( const ArrayOperandDataBase & X )
   {
...
void
ArrayOperandDataBase::merge( vector<ArrayOperandDataBase> & X, const vector<ArrayOperandDataBase> & Y )
   {
...
bool
ArrayOperandDataBase::contains( const vector<ArrayOperandDataBase> & X, const ArrayOperandDataBase & arrayInfo )
   {
...
void
ArrayOperandDataBase::addIndexInformation( const string & indexName, IndexOperandDataBase::constructorValues origin )
   {
