...
string
IndexOperandDataBase::displayString() const
   {
...
bool
IndexOperandDataBase::operator== ( const IndexOperandDataBase & X ) const
   {
...
void
IndexOperandDataBase::merge( const IndexOperandDataBase & X )
   {
