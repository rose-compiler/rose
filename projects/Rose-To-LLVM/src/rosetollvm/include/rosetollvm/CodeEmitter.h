...
class CodeEmitter {
public:
    CodeEmitter(Option &, Control &, std::string);
    ...
    void emitUnconditionalBranch(const char *label, std::string const &debug_md, std::string const &is_parallel_md);
    void emitUnconditionalBranch(const char *label, std::string const &debug_md);
    void emitUnconditionalBranch(std::string label, std::string const &debug_md, std::string const &is_parallel_md);
    void emitUnconditionalBranch(std::string label, std::string const &debug_md);
