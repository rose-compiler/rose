...
allowedFunctionsTest: allowedFunctions.C allowedFunctionsMain.C libcompass.so $(COMPASS_SUPPORT)/compassTestMain.C
	g++ -fPIC -Wall -o $@ allowedFunctions.C allowedFunctionsMain.C -I$(COMPASS_SUPPORT) -I$(ROSE_INSTALL)/include $(LINKER_FLAGS)
