...
*/
/******************************************************************************************************************************/
void Fortran_to_C::lineralizeArray(SgProject* project)
{
  /* 
  ...
  */
  Rose_STL_Container<SgNode*> arrayTypeList = NodeQuery::querySubTree (project,V_SgArrayType);
  for(Rose_STL_Container<SgNode*>::iterator i = arrayTypeList.begin(); i != arrayTypeList.end(); i++)
  {
    // Get original type
    SgArrayType* originalArrayType = isSgArrayType(*i);
    ROSE_ASSERT(originalArrayType);
    // Get dim_info
  ...
  */
  Rose_STL_Container<SgNode*> PntrArrRefExpList = NodeQuery::querySubTree (project,V_SgPntrArrRefExp);
  for(Rose_STL_Container<SgNode*>::iterator i = PntrArrRefExpList.begin(); i != PntrArrRefExpList.end(); i++)
  {
