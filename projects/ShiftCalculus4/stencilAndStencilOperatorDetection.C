...
BLIterator_Attribute::BLIterator_Attribute() {}

BLIterator_Attribute::~BLIterator_Attribute() {}

string
BLIterator_Attribute::toString()
   {
     return "BLIterator_Attribute";
   }

string 
BLIterator_Attribute::additionalNodeOptions()
   {
     return "fillcolor=\"aquamarine\",style=filled";
   }
...
DoubleValue_Attribute::additionalNodeOptions()
   {
  // return "shape=circle,fillcolor=\"blue\",style=filled";
  // return "shape=star,fillcolor=\"blue\",style=filled";
     return "shape=hexagon,fillcolor=\"lightblue\",style=filled";
  // return "";
   }
...
MakePair_Attribute::MakePair_Attribute() {}

MakePair_Attribute::~MakePair_Attribute() {}

string
MakePair_Attribute::toString()
   {
     return "MakePair_Attribute";
   }

string 
MakePair_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=diamond,fillcolor=\"blue\",style=filled";
   }


StencilOrEqualOperator_Attribute::StencilOrEqualOperator_Attribute() {}

StencilOrEqualOperator_Attribute::~StencilOrEqualOperator_Attribute() {}

string
StencilOrEqualOperator_Attribute::toString()
   {
     return "StencilOrEqualOperator_Attribute";
   }

string 
StencilOrEqualOperator_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=diamond,fillcolor=\"blue\",style=filled";
...
StencilOperatorParenthesis_Attribute::StencilOperatorParenthesis_Attribute() {}

StencilOperatorParenthesis_Attribute::~StencilOperatorParenthesis_Attribute() {}

string
StencilOperatorParenthesis_Attribute::toString()
   {
     return "StencilOperatorParenthesis_Attribute";
   }

string 
StencilOperatorParenthesis_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"green\",style=filled";
   }


StencilOperatorPlus_Attribute::StencilOperatorPlus_Attribute() {}

StencilOperatorPlus_Attribute::~StencilOperatorPlus_Attribute() {}

string
StencilOperatorPlus_Attribute::toString()
   {
     return "StencilOperatorPlus_Attribute";
   }

string 
StencilOperatorPlus_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"green\",style=filled";
...
OperatorSquareBrackets_Attribute::OperatorSquareBrackets_Attribute() {}

OperatorSquareBrackets_Attribute::~OperatorSquareBrackets_Attribute() {}

string
OperatorSquareBrackets_Attribute::toString()
   {
     return "OperatorSquareBrackets_Attribute";
   }

string 
OperatorSquareBrackets_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"green\",style=filled";
...
GetBox_Attribute::GetBox_Attribute() {}

GetBox_Attribute::~GetBox_Attribute() {}

string
GetBox_Attribute::toString()
   {
     return "GetBox_Attribute";
   }

string 
GetBox_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"purple\",style=filled";
   }


OperatorStar_Attribute::OperatorStar_Attribute() {}

OperatorStar_Attribute::~OperatorStar_Attribute() {}

string
OperatorStar_Attribute::toString()
   {
     return "OperatorStar_Attribute";
   }

string
OperatorStar_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"red\",style=filled";
   }


OperatorMinusEqual_Attribute::OperatorMinusEqual_Attribute() {}

OperatorMinusEqual_Attribute::~OperatorMinusEqual_Attribute() {}

string
OperatorMinusEqual_Attribute::toString()
   {
     return "OperatorMinusEqual_Attribute";
   }

string
OperatorMinusEqual_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"pink\",style=filled";
   }


OperatorPlusEqual_Attribute::OperatorPlusEqual_Attribute() {}

OperatorPlusEqual_Attribute::~OperatorPlusEqual_Attribute() {}

string
OperatorPlusEqual_Attribute::toString()
   {
     return "OperatorPlusEqual_Attribute";
   }

string
OperatorPlusEqual_Attribute::additionalNodeOptions()
   {
  // return "shape=triangle,fillcolor=\"blue\",style=filled";
  // return "";
     return "shape=circle,fillcolor=\"pink\",style=filled";
...
// DQ: Added new attributes
const string DetectionTraversal::StencilApplyOperator   = dsl_type_string;
const string DetectionTraversal::MakePairConstructor    = dsl_type_string;
const string DetectionTraversal::StencilOrEqualOperator = dsl_type_string;
...
const string DetectionTraversal::BLIteratorVariable   = dsl_type_string;


const string DetectionTraversal::IntegerValue         = dsl_type_string;
const string DetectionTraversal::DoubleValue          = dsl_type_string;

const string DetectionTraversal::StencilOperatorParenthesis = dsl_type_string;
const string DetectionTraversal::OperatorSquareBrackets     = dsl_type_string;
const string DetectionTraversal::GetBox                     = dsl_type_string;
const string DetectionTraversal::OperatorStar               = dsl_type_string;
const string DetectionTraversal::OperatorMinusEqual         = dsl_type_string;
const string DetectionTraversal::OperatorPlusEqual          = dsl_type_string;

const string DetectionTraversal::StencilOperatorPlus        = dsl_type_string;
     ...
     for (SgExpressionPtrList::iterator i = expressions.begin(); i != expressions.end(); i++)
        {
          ...
          SgBinaryOp*  binaryOp  = isSgBinaryOp(scalarExpression);
       ...
       // if (valueExp != NULL || varRefExp != NULL || unaryOp != NULL)
          if (valueExp != NULL || varRefExp != NULL || unaryOp != NULL || binaryOp != NULL)
             {
               ConstantExpression_Attribute* dslAttribute = new ConstantExpression_Attribute();
#if 1
               printf ("Adding (ConstantExpression) dslAttribute = %p \n",dslAttribute);
#endif
               ROSE_ASSERT(dslAttribute != NULL);

            // We need the expression that is on the rhs.
...
#endif
                    scalarExpression = binaryOp->get_rhs_operand();
                    ROSE_ASSERT(scalarExpression != NULL);
                 // scalarExpression->addNewAttribute(ConstantExpression,dslAttribute);
                    ...
                    if (varRefExp != NULL)
                       {
                      // This is a SgVarRefExp to a variable that is required as a constant value and which was not marked as being a DSL variable previously.
                      // This is likely because it was a integer or floating point constnat expression (e.g. not a DSL type).
                      // Now we need to find the declaration and the assignment to this variable and process these as DSL features.
                         ...
                         switch (type->variantT())
                            {
                              case V_SgTypeInt:
                                 {
                                   printf ("This is a variable of type integer: save the constant value in the ConstantExpression_Attribute \n");
                                   delete dslAttribute;
                                   dslAttribute = NULL;
                                   IntegerValue_Attribute* tmp_dslAttribute = new IntegerValue_Attribute();
                                   scalarExpression->addNewAttribute(IntegerValue,tmp_dslAttribute);
                                   break;
                                 }

                              case V_SgTypeDouble:
                                 {
                                   printf ("This is a variable of type double: save the constant value in the ConstantExpression_Attribute \n");
                                   delete dslAttribute;
                                   dslAttribute = NULL;

                                   printf ("Build a DoubleValue_Attribute for the SgVarRefExp = %p = %s \n",scalarExpression,initializedName->get_name().str());

                                   DoubleValue_Attribute* value_dslAttribute_1 = new DoubleValue_Attribute();
                                   scalarExpression->addNewAttribute(DoubleValue,value_dslAttribute_1);

                                // We are looking for the constant expression used to set this variable.
                                // This relaxes some of the constant expression handling to support the DSL.
                                   SgExpression* definingExpression = defining_expression(root,initializedName);
                                   ROSE_ASSERT(definingExpression != NULL);

                                   printf ("definingExpression = %s \n",definingExpression->unparseToString().c_str());

                                // double constant_value = evaluate(definingExpression);
                                   double constant_value = 0.0;
                                   SgValueExp* valueExp = isSgValueExp(definingExpression);
                                   if (valueExp != NULL)
                                      {
                                     // This should be an integer constant value (the only kind that we currently support within constant folding).
                                     // constant_value = valueExp->get_value();
                                        constant_value = (double) SageInterface::getIntegerConstantValue(valueExp);
                                      }
                                     else
                                      {
                                        SgCastExp* castExp = isSgCastExp(definingExpression);
                                        if (castExp != NULL)
                                           {
                                             SgValueExp* valueExp = isSgValueExp(castExp->get_operand());
                                             if (valueExp != NULL)
                                                {
                                               // This should be an integer constant value (the only kind that we currently support within constant folding).
                                               // constant_value = valueExp->get_value();
                                                ...
                                                {
                                                  printf ("Support not implemented: castExp->operand() = %p = %s \n",castExp->get_operand(),castExp->get_operand()->class_name().c_str());
                                                  ROSE_ASSERT(false);
                                                }
                                           }
                                          else
                                           {
                                             printf ("Extracting constant expression value: What is this: definingExpression = %p = %s = %s \n",
                                                  definingExpression,definingExpression->class_name().c_str(),definingExpression->unparseToString().c_str());
                                             ROSE_ASSERT(false);
                                           }
                                      }

                                // Add constant expression attribute to the initializedName.
                                   value_dslAttribute_1->value = constant_value;

                                   printf ("Build a DoubleValue_Attribute for the SgInitializedName = %s \n",initializedName->get_name().str());

                                // Add a dsl attribute to the SgInitializedName (while we are att it).
                                   DoubleValue_Attribute* value_dslAttribute_2 = new DoubleValue_Attribute();
                                   initializedName->addNewAttribute(DoubleValue,value_dslAttribute_2);

                                // tmp_dslAttribute->value = evaluate(definingExpression);
                                   value_dslAttribute_2->value = constant_value;

                                   printf ("Build a DoubleValue_Attribute for the definingExpression = %p = %s = %s \n",
                                        definingExpression,definingExpression->class_name().c_str(),definingExpression->unparseToString().c_str());

                                   DoubleValue_Attribute* value_dslAttribute_3 = new DoubleValue_Attribute();
                                   definingExpression->addNewAttribute(DoubleValue,value_dslAttribute_3);

                                // tmp_dslAttribute->value = evaluate(definingExpression);
                                   value_dslAttribute_3->value = constant_value;
                              ...
                              default:
                                 {
                                   printf ("default reached in initializedName type for detection of DSL variables: type = %p = %s \n",type,type->class_name().c_str());
                                   ROSE_ASSERT(false);
                                 }
                            }
#if 0
...
void
DetectionTraversal::findAndAddAttributeToConstantExpression ( SgConstructorInitializer* constructorInitializer )
   {
  // DQ: Note that this function could be refactored with the other function above.
  ...
  // ROSE_ASSERT(expressions.size() == 1);
     ...
     SgExpressionPtrList::iterator i = expressions.begin();
...
DetectionTraversal::evaluateInheritedAttribute (SgNode* astNode, Detection_InheritedAttribute inheritedAttribute )
  ...
  // if (functionDeclaration != NULL && functionDeclaration->get_name() == "main")
     if (functionDeclaration != NULL)
       ...
       // if (functionDeclaration->get_name() == "main")
          if (functionDeclaration->get_name() == "define" || functionDeclaration->get_name() == "pointRelax")
             {
               ...
               if (classDeclaration != NULL)
                  {
                    ...
                    if (classDeclaration->get_name() == "BLIterator")
                       {
                      // Save the SgInitializedName associated with the BLIterator type.
#if 1
                         printf ("Detected BLIterator typed variable: initializedName = %p name = %s \n",initializedName,initializedName->get_name().str());
#endif
                         checkAndResetToMakeConsistantCompilerGenerated(initializedName);
                         ...
                         if (initializedName->isCompilerGenerated() == false)
                            {
                              ...
                              BLIterator_Attribute* dslAttribute = new BLIterator_Attribute();
                              printf ("Adding (BLIterator) dslAttribute = %p \n",dslAttribute);
                              ROSE_ASSERT(dslAttribute != NULL);

                           // virtual void addNewAttribute (std::string s, AstAttribute *a);
                              initializedName->addNewAttribute(BLIteratorVariable,dslAttribute);
                            }
#if 0
                         printf ("Exiting as a test! \n");
                         ROSE_ASSERT(false);
  ...
  // Find the invocation of the stencil operator (via a SgFunctionCallExp).
     ...
     if (functionCallExp != NULL)
       ...
       // Here we make assumptions on how the stencil is specified in the DSL.
          ...
          if (dotExp != NULL)
            ...
            // bool stencilOrEqualOperatorFound     = false;
               bool stencilOperatorParenthesisFound = false;
               bool getBoxFound                     = false;
               bool operatorSquareBracketsFound     = false;
               bool operatorStarFound               = false;
               bool operatorMinusEqualFound         = false;
            // bool operatorPlusEqualFound          = false;
               bool stencilOperatorPlusFound        = false;
               ...
               if (varRefExp != NULL && memberFunctionRefExp != NULL)
                 ...
                 // Check that this is the correct member function on the correctly typed variable reference.
                    ...
                    stencilOperatorPlusFound = (find(stencilInitializedNameList.begin(),stencilInitializedNameList.end(),initializedName) != stencilInitializedNameList.end()) && (memberFunctionSymbol->get_name() == "operator+");
                 ...
                 // stencilOrEqualOperatorFound = (find(boxInitializedNameList.begin(),boxInitializedNameList.end(),initializedName) != boxInitializedNameList.end()) && (memberFunctionSymbol->get_name() == "operator|=");

                    stencilOperatorParenthesisFound = (find(boxInitializedNameList.begin(),boxInitializedNameList.end(),initializedName) != boxInitializedNameList.end()) && (memberFunctionSymbol->get_name() == "operator()");

                    getBoxFound = (find(boxInitializedNameList.begin(),boxInitializedNameList.end(),initializedName) != boxInitializedNameList.end()) && (memberFunctionSymbol->get_name() == "getBox");

                    operatorStarFound = (find(boxInitializedNameList.begin(),boxInitializedNameList.end(),initializedName) != boxInitializedNameList.end()) && (memberFunctionSymbol->get_name() == "operator*");

                  }

               if (memberFunctionRefExp->get_symbol()->get_name() == "operator()")
                  {
                 // printf ("stencilOperatorParenthesisFound = %s \n",stencilOperatorParenthesisFound ? "true" : "false");
                    if (stencilOperatorParenthesisFound == false)
                       {
                         printf ("Resetting stencilOperatorParenthesisFound since it was not called from a SgInitializedName \n");
                         stencilOperatorParenthesisFound = true;
                       }
#if 0
                    printf ("Exiting as a test! \n");
                    ROSE_ASSERT(false);
               ...
               if (memberFunctionRefExp->get_symbol()->get_name() == "getBox")
                  {
                 // printf ("getBoxFound = %s \n",getBoxFound ? "true" : "false");
                    if (getBoxFound == false)
                       {
                         printf ("Resetting getBoxFound since it was not called from a SgInitializedName ??? \n");
                         getBoxFound = true;
                       }
#if 0
                    printf ("Exiting as a test! \n");
               ...
               if (memberFunctionRefExp->get_symbol()->get_name() == "operator[]")
                  {
                 // printf ("operatorSquareBracketsFound = %s \n",operatorSquareBracketsFound ? "true" : "false");
                    if (operatorSquareBracketsFound == false)
                       {
                         printf ("Resetting operatorSquareBracketsFound since it was not called from a SgInitializedName \n");
                         operatorSquareBracketsFound = true;
                       }
#if 0
                    printf ("Exiting as a test! \n");
                    ROSE_ASSERT(false);
               ...
               if (memberFunctionRefExp->get_symbol()->get_name() == "operator*")
                  {
                    printf ("(before test/reset): operatorStarFound = %s \n",operatorStarFound ? "true" : "false");
                    if (operatorStarFound == false)
                       {
                         printf ("Resetting operatorStarFound since it was not called from a SgInitializedName \n");
                         operatorStarFound = true;
                       }
#if 0
                    printf ("Exiting as a test! \n");
                    ROSE_ASSERT(false);
               ...
               if (memberFunctionRefExp->get_symbol()->get_name() == "operator-=")
                  {
                    printf ("(before test/reset): operatorMinusEqualFound = %s \n",operatorMinusEqualFound ? "true" : "false");
                    if (operatorMinusEqualFound == false)
                       {
                         printf ("Resetting operatorMinusEqualFound since it was not called from a SgInitializedName \n");
                         operatorMinusEqualFound = true;
                       }
#if 0
                    printf ("Exiting as a test! \n");
                    ROSE_ASSERT(false);
...
#if 0
            // This is not used in the stencil DSL.
               if (memberFunctionRefExp->get_symbol()->get_name() == "operator+=")
                  {
                    printf ("(before test/reset): operatorPlusEqualFound = %s \n",operatorPlusEqualFound ? "true" : "false");
                    if (operatorPlusEqualFound == false)
                       {
                         printf ("Resetting operatorPlusEqualFound since it was not called from a SgInitializedName \n");
                         operatorPlusEqualFound = true;
                       }
#if 1
                    printf ("Exiting as a test! \n");
                    ROSE_ASSERT(false);
            ...
            // call (since calling off of a variable is not general enough).
               ...
               if (stencilOperatorPlusFound == true)
                  {
                 // This is the location of the operator where the stencil is to be put in the transformed code.
                 // stencilOperatorFunctionCallList.push_back(functionCallExp);

                    StencilOperatorPlus_Attribute* dslAttribute = new StencilOperatorPlus_Attribute();
#if 0
                    printf ("Adding (Stencil operator+) dslAttribute = %p \n",dslAttribute);
#endif
                    ROSE_ASSERT(dslAttribute != NULL);

                    functionCallExp->addNewAttribute(StencilOperatorPlus,dslAttribute);
                  }
...
#if 0
               if (stencilOrEqualOperatorFound == true)
                  {
                    StencilOrEqualOperator_Attribute* dslAttribute = new StencilOrEqualOperator_Attribute();
#if 1
                    printf ("Adding (operator|=) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(StencilOrEqualOperator,dslAttribute);

                    findAndAddAttributeToConstantExpression(functionCallExp);
                  }
#endif

               if (stencilOperatorParenthesisFound == true)
                  {
                    StencilOperatorParenthesis_Attribute* dslAttribute = new StencilOperatorParenthesis_Attribute();
#if 1
                    printf ("Adding (operator()) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(StencilOperatorParenthesis,dslAttribute);
               ...
               if (operatorSquareBracketsFound == true)
                  {
                    OperatorSquareBrackets_Attribute* dslAttribute = new OperatorSquareBrackets_Attribute();
#if 1
                    printf ("Adding (operator[]) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(OperatorSquareBrackets,dslAttribute);
               ...
               if (getBoxFound == true)
                  {
                    GetBox_Attribute* dslAttribute = new GetBox_Attribute();
#if 1
                    printf ("Adding (getbox) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(GetBox,dslAttribute);
#if 0
                    printf ("Exiting as a test! \n");
                    ROSE_ASSERT(false);
#endif
               ...
               if (operatorStarFound == true)
                  {
                    OperatorStar_Attribute* dslAttribute = new OperatorStar_Attribute();
#if 1
                    printf ("Adding (operator*) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(OperatorStar,dslAttribute);
               ...
               if (operatorMinusEqualFound == true)
                  {
                    OperatorMinusEqual_Attribute* dslAttribute = new OperatorMinusEqual_Attribute();
#if 1
                    printf ("Adding (operator-=) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(OperatorMinusEqual,dslAttribute);
...
#if 0
            // This is not used in the stencil DSL.
               if (operatorPlusEqualFound == true)
                  {
                    OperatorPlusEqual_Attribute* dslAttribute = new OperatorPlusEqual_Attribute();
#if 1
                    printf ("Adding (operator+=) dslAttribute = %p \n",dslAttribute);
#endif
                    functionCallExp->addNewAttribute(OperatorPlusEqual,dslAttribute);
          ...
          if (functionRefExp != NULL)
            ...
            // if (functionSymbol->get_name() == "make_pair")
               if (templateInstantiationFunctionDecl != NULL && templateInstantiationFunctionDecl->get_templateName() == "make_pair")
                  {
                    MakePair_Attribute* dslAttribute = new MakePair_Attribute();
#if 1
                    printf ("Adding (MakePair) dslAttribute = %p \n",dslAttribute);
#endif
                    ROSE_ASSERT(dslAttribute != NULL);

                    printf ("templateInstantiationFunctionDecl->get_name() = %s \n",templateInstantiationFunctionDecl->get_name().str());

                 // functionCallExp->addNewAttribute("MakePair",dslAttribute);
                    functionCallExp->addNewAttribute(MakePairConstructor,dslAttribute);

                  }

            // if (functionSymbol->get_name() == "operator|=")
               if (templateInstantiationFunctionDecl != NULL && templateInstantiationFunctionDecl->get_templateName() == "operator|=")
                  {
                    StencilOrEqualOperator_Attribute* dslAttribute = new StencilOrEqualOperator_Attribute();
#if 1
                    printf ("Adding (operator|=()) dslAttribute = %p \n",dslAttribute);
     ...
     if (constructorInitializer != NULL)
        {
          printf ("Found Constructor Initializer: check if this is a relevant one \n");

          SgClassDeclaration* classDeclaration = isSgClassDeclaration(constructorInitializer->get_class_decl());
          ROSE_ASSERT(classDeclaration != NULL);

       // I think this is the function type, not the class that that we want.
       // SgClassType* classType = isSgClassType(constructorInitializer->get_type());
          SgClassType* classType = isSgClassType(classDeclaration->get_type());
       ...
       // DQ: Test the DSL support.
       // ROSE_ASSERT(isMatchingClassType(classType,"Stencil",true) == true);
          if (isMatchingClassType(classType,"Stencil",true) == true)
            {
           // seperate out the cases specific to the Stencil constructors.

              SgMemberFunctionDeclaration* constructor = constructorInitializer->get_declaration();
              ROSE_ASSERT(constructor != NULL);

              findAndAddAttributeToConstantExpression(constructorInitializer);
            }
#if 0
          printf ("Exiting as a test! \n");
          ROSE_ASSERT(false);
     ...
     if (varRefExp != NULL)
        {
          ...
          ROSE_ASSERT(initializedName != NULL);
#if 0
          printf ("### Case of SgVarRefExp: looking for initializedName = %p = %s in stencilInitializedNameList.size() = %zu \n",initializedName,initializedName->get_name().str(),stencilInitializedNameList.size());
#endif
...
#if 0
          printf ("### Case of SgVarRefExp: stencilVariableFound = %s \n",stencilVariableFound ? "true" : "false");
#endif
...
#if 0
  // DQ: I think this should be a part of the synthesized attribute evaluation.
     SgBinaryOp* binaryOp = isSgBinaryOp(astNode);
     if (binaryOp != NULL)
        {
          printf ("Found binary operator: binaryOp = %p = %s \n",binaryOp,binaryOp->class_name().c_str());

          SgType* type = binaryOp->get_type();
          printf ("   --- binary operator type: type = %p = %s \n",type,type->class_name().c_str());
#if 1
          printf ("Exiting as a test! \n");
          ROSE_ASSERT(false);
#endif
...
DetectionTraversal::evaluateSynthesizedAttribute (SgNode* astNode, Detection_InheritedAttribute inheritedAttribute, SubTreeSynthesizedAttributes synthesizedAttributeList )
  ...
  // We have to handle the DSL specific SgForStatement within the evaluateSynthesizedAttribute() function (after traversing children).
     ...
     if (forStatement != NULL)
        {
       // For normal non-DSL for loops we don't want to mistakenly mark them.
       // Check the loop bound to see if it is a constant value (a better test will be more useful later).
          bool isDslLoop = false;
          SgExprStatement* expressionStatement = isSgExprStatement(forStatement->get_test());
          if (expressionStatement != NULL)
             {
               SgExpression* expression = expressionStatement->get_expression();
               ROSE_ASSERT(expression != NULL);
               SgBinaryOp* binaryOp = isSgBinaryOp(expressionStatement->get_expression());

            // ROSE_ASSERT(binaryOp != NULL);
               if (binaryOp != NULL)
                  {
                    SgValueExp* valueExp = isSgValueExp(binaryOp->get_rhs_operand());
                    if (valueExp != NULL)
                       {
                      // This is a loop with a constant bound (fixme).
                         isDslLoop = true;
                       }
                  }
                 else
                  {
                    printf ("Note: not a dsl for loop: expression = %p = %s \n",expression,expression->class_name().c_str());

                 // Test for BLIterator::iterator type (this is a dsl type). This loop is over all of the Boxlib patches in a level.
                    printf ("checking for a dsl for loop: expression = %p = %s \n",forStatement->get_test(),forStatement->get_test()->class_name().c_str());

                    SgForInitStatement* forInitStatement = isSgForInitStatement(forStatement->get_for_init_stmt());
                    ROSE_ASSERT(forInitStatement != NULL);

                    ROSE_ASSERT(forInitStatement->get_init_stmt().empty() == false);
                 // SgVariableDeclaration* variableDeclaration = forInitStatement->get_init_stmt()[0];
                    SgStatement* statement = *(forInitStatement->get_init_stmt().begin());
                 ...
                 // ROSE_ASSERT(variableDeclaration != NULL);
                    ...
                    if (variableDeclaration != NULL)
                       {
                         type = variableDeclaration->get_type();
                         ROSE_ASSERT(type != NULL);
                       }
                      else
                       {
                         SgExprStatement* expressionStatement = isSgExprStatement(statement);
                         ROSE_ASSERT(expressionStatement != NULL);
                         ROSE_ASSERT(expressionStatement->get_expression() != NULL);

                         type = expressionStatement->get_expression()->get_type();
                         ROSE_ASSERT(type != NULL);
                       }
                 ...
                 // if (classType != NULL && classType->get_symbol()->get_declaration()->get_name() == "BLIterator")
                    ...
                    if (classType != NULL && classDeclaration->get_name() == "BLIterator")
                       {
                         isDslLoop = true;
                       }
#if 0
            ...
            else
             {
               ...
               printf ("Error: not a dsl for loop: forStatement->get_test() = %p = %s \n",forStatement->get_test(),forStatement->get_test()->class_name().c_str());
#if 0
               printf ("Exitng as a test! \n");
               ROSE_ASSERT(false);
#endif
          ...
          printf ("@@@@@@@@@@@@ Case of SgForStatement: forStatement = %p isDslLoop = %s \n",forStatement,isDslLoop ? "true" : "false");
       ...
       // if (return_synthesizedAttribute.dslChildren.empty() == false)
          if (isDslLoop == true && return_synthesizedAttribute.dslChildren.empty() == false)
             {
  ...
  // DQ: Added new operator support.
     ...
     if (binaryOp != NULL)
       ...
       // DQ: Only testing the SgAssignOp for now (not clear what others apply).
          bool qualified_dsl_operator = isSgAssignOp(binaryOp)   != NULL ||
                                     // isSgAddOp(binaryOp)      != NULL || 
                                     // isSgSubtractOp(binaryOp) != NULL || 
                                        false;

          printf ("   --- binary operator: qualified_dsl_operator = %s \n",qualified_dsl_operator ? "true" : "false");
          printf ("   --- binary operator: return_synthesizedAttribute.dslChildren.size() = %zu \n",return_synthesizedAttribute.dslChildren.size());

       // Detect the case of a for loop over DSL abstractions (we might just want to restrict this to stencil abstractions, not clear yet).
          if (qualified_dsl_operator == true && return_synthesizedAttribute.dslChildren.empty() == false)
             {
               ConstantExpression_Attribute* dslAttribute = new ConstantExpression_Attribute();
#if 1
               printf ("Adding (binary operator for ConstantExpression) dslAttribute = %p \n",dslAttribute);
#endif
               ROSE_ASSERT(dslAttribute != NULL);

               binaryOp->addNewAttribute("dsl expression",dslAttribute);
#if 0
               printf ("Exiting as a test! \n");
               ROSE_ASSERT(false);
#endif
