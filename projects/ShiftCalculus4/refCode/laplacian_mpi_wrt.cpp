// Manual generated MPI code, using XOMP-MPI runtime library call
// Liao, 9/17/2015
// Trans x.01 
#include "mpi.h"
...
int main(int argc,char *argv[])
{
  ...
  // Trans x.02  move loop variable declarations into a single place
  int i,j,k;
  
  // Trans x.02  move declaration up
  ...
  // Trans x.03 , calculate new src and dest addresses
  // This approach will hook the distribution runtime
  double *distsrc;
  double *distdest;
