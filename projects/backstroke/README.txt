...
Goal: Support the automatd generation of the reverse functions for optimistic discrete
      event simulation.
...
Inital work will support +,-,*, and \.  Zero divide will be our proxy 
