...
vector<SgFunctionDefinition*>
buildEventList (SgProject* project)
   {
...
// class RestrictionTraversal : public AstBottomUpProcessing<SynthesizedAttribute>
...
bool
RestrictionTraversal::evaluateSynthesizedAttribute ( SgNode* node, SynthesizedAttributesList childAttributes )
   {
  ...
  // Test if this is an acceptable type
     switch (node->variantT())
       ...
       // This sort of statement is NOT OK (we do need to specify everything that is unaccpetable).
          case V_SgWhileStmt:        localResult = true; break;
          case V_SgForStatement:     localResult = true; break;
          case V_SgIfStmt:           localResult = true; break;
          case V_SgClassDeclaration: localResult = true; break;
       ...
       // And don't allow any of this complexity!
          case V_SgPragma:               localResult = true; break;
          case V_SgTemplateArgument:     localResult = true; break;
          case V_SgBaseClass:            localResult = true; break;
          case V_SgLabelRefExp:          localResult = true; break;
          case V_SgMemberFunctionRefExp: localResult = true; break;

          case V_SgTemplateInstantiationDirectiveStatement: localResult = true; break;
          case V_SgUsingDirectiveStatement:                 localResult = true; break;
          case V_SgUsingDeclarationStatement:               localResult = true; break;
          case V_SgNamespaceDefinitionStatement:            localResult = true; break;
          case V_SgNamespaceAliasDeclarationStatement:      localResult = true; break;
          case V_SgNamespaceDeclarationStatement:           localResult = true; break;
          case V_SgTemplateDeclaration:                     localResult = true; break;
          case V_SgContinueStmt:                            localResult = true; break;
          case V_SgBreakStmt:                               localResult = true; break;
          case V_SgDefaultOptionStmt:                       localResult = true; break;
          case V_SgTryStmt:                                 localResult = true; break;
          case V_SgCaseOptionStmt:                          localResult = true; break;
          case V_SgLabelStatement:                          localResult = true; break;
          case V_SgTypedefDeclaration:                      localResult = true; break;
          case V_SgAsmStmt:                                 localResult = true; break;
          case V_SgEnumDeclaration:                         localResult = true; break;
          case V_SgCatchOptionStmt:                         localResult = true; break;
          case V_SgSwitchStatement:                         localResult = true; break;
          case V_SgDoWhileStmt:                             localResult = true; break;
          case V_SgCtorInitializerList:                     localResult = true; break;
          case V_SgCatchStatementSeq:                       localResult = true; break;
          case V_SgForInitStatement:                        localResult = true; break;
          case V_SgLshiftAssignOp:         localResult = true; break;
          case V_SgRshiftAssignOp:         localResult = true; break;
          case V_SgConditionalExp:         localResult = true; break;
          case V_SgSizeOfOp:               localResult = true; break;
          case V_SgAggregateInitializer:   localResult = true; break;
          case V_SgConstructorInitializer: localResult = true; break;
          case V_SgNewExp:                 localResult = true; break;
          case V_SgDeleteExp:              localResult = true; break;
          case V_SgThisExp:                localResult = true; break;
          case V_SgPointerDerefExp:        localResult = true; break;
          case V_SgThrowOp:                localResult = true; break;
          case V_SgArrowExp:               localResult = true; break;
          case V_SgDotExp:                 localResult = true; break;
          case V_SgDotStarOp:              localResult = true; break;
          case V_SgArrowStarOp:            localResult = true; break;
          case V_SgCommaOpExp:             localResult = true; break;
          case V_SgLshiftOp:               localResult = true; break;
          case V_SgRshiftOp:               localResult = true; break;
          case V_SgPntrArrRefExp:          localResult = true; break;
          case V_SgScopeOp:                localResult = true; break;

       // Unclear if we shudl allow casts (maybe implicit casts will be OK.
       ...
       // This sort of statement IS OK (but we don't need to specify everything that is acceptable).
          case V_SgExprStatement: localResult = false; break;
...
bool
violatesRestrictionsOnEventFunctions ( SgFunctionDefinition* functionDefinition )
   {
  // Build the traversal object
...
bool
violatesRestrictionsOnEventFunctions ( vector<SgFunctionDefinition*> eventList )
   {
...
main( int argc, char * argv[] )
  ...
  // Build the AST used by ROSE
     ...
     violatesRestrictionsOnEventFunctions( eventList );
