...
{
  m -> m_int = (++m -> m_int?++m -> m_int : --m -> m_int);
}
...
{
  m -> m_int = (rand() > 1073741823?++m -> m_int : --m -> m_int);
}
...
{
  m -> m_int = (++m -> m_int?++m -> m_int : (m -> m_int = 2190));
}
...
{
  m -> m_int = (rand() > 1073741823?++m -> m_int : (m -> m_int = 2190));
}
...
{
  m -> m_int = (++m -> m_int?(m -> m_int = 2190) : (m -> m_int += 2190));
}
...
{
  m -> m_int = (rand() > 1073741823?(m -> m_int = 2190) : (m -> m_int += 2190));
}
...
{
  m -> m_int = (++m -> m_int?((m -> m_int , 2190)) : rand());
}
...
{
  m -> m_int = (rand() > 1073741823?((m -> m_int , 2190)) : rand());
}
