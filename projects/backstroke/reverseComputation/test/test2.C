...
{
    int i = ++m -> model::i_;
    srand(m -> model::i_ = m -> model::i_ = 3621);
  }
}
...
{
    int i = ++m -> model::i_;
    srand(m -> model::i_ = (++m -> model::i_?++m -> model::i_ : (m -> model::i_ = 3621)));
  }
}
...
{
    int i = ++m -> model::i_;
    srand(m -> model::i_ = (rand() > 1073741823?++m -> model::i_ : (m -> model::i_ = 3621)));
  }
}
...
{
    int i = ++m -> model::i_;
    srand(m -> model::i_ = (++m -> model::i_?(m -> model::i_ = 3621) : (m -> model::i_ += 3621)));
  }
}
...
{
    int i = ++m -> model::i_;
    srand(m -> model::i_ = (rand() > 1073741823?(m -> model::i_ = 3621) : (m -> model::i_ += 3621)));
  }
}
