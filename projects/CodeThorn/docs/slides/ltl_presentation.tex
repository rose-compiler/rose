  ...
  \begin{algorithm}[H]
    ...
    \Begin{
        \Switch{e}{
          ...
          \lCase{$\G a\quad$}{$\colon\quad$fix($\bot, \lub, \lambda s\colon s_a\cap\comb$)}\\
          \lCase{$\F a\quad\:$}{$\colon\quad$fix($\bot, \lub, \lambda s\colon s_a\cup\comb)$}\\
          \lCase{a \R b}{$\colon\quad$fix($\bot, \lub, \lambda s\colon s_b\cap(s_a\cup\comb))$}\\
          \lCase{a \U b}{$\colon\quad$fix($\bot, \lub, \lambda s\colon s_b\cup(s_a\cap\comb))$}\\
