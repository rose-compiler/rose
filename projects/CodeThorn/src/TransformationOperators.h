...
class TransformationOperators {
 public:
  ...
  static std::list<SgExpression*> varRefExpOfVar(SgNode* root, SPRAY::VariableId varId, SPRAY::VariableIdMapping* variableIdMapping );
  ...
  static void substituteUsesWithAvailableExpRhsOfDef(std::string udAttributeName, SgNode* root, SPRAY::Labeler* labeler, SPRAY::VariableIdMapping* variableIdMapping);
