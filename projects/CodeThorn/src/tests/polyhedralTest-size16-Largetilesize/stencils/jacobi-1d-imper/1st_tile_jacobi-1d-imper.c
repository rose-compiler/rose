...
#pragma scop
{
    ...
    for (c0 = 1; c0 <= 17; c0++) {
      ...
      for (c2 = (0 > (((c0 + -14) * 2 < 0?-(-(c0 + -14) / 2) : ((2 < 0?(-(c0 + -14) + - 2 - 1) / - 2 : (c0 + -14 + 2 - 1) / 2))))?0 : (((c0 + -14) * 2 < 0?-(-(c0 + -14) / 2) : ((2 < 0?(-(c0 + -14) + - 2 - 1) / - 2 : (c0 + -14 + 2 - 1) / 2))))); c2 <= ((1 < (((c0 + -2) * 2 < 0?((2 < 0?-((-(c0 + -2) + 2 + 1) / 2) : -((-(c0 + -2) + 2 - 1) / 2))) : (c0 + -2) / 2))?1 : (((c0 + -2) * 2 < 0?((2 < 0?-((-(c0 + -2) + 2 + 1) / 2) : -((-(c0 + -2) + 2 - 1) / 2))) : (c0 + -2) / 2)))); c2++) {
