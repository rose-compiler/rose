...
#pragma omp parallel for private(c4, c3)
      for (c2 = (0 > c1 + -15?0 : c1 + -15); c2 <= (((c1 + -3) * 3 < 0?((3 < 0?-((-(c1 + -3) + 3 + 1) / 3) : -((-(c1 + -3) + 3 - 1) / 3))) : (c1 + -3) / 3)); c2++) {
      ...
      c2 = ((((c1 + -2) * 3 < 0?-(-(c1 + -2) / 3) : ((3 < 0?(-(c1 + -2) + - 3 - 1) / - 3 : (c1 + -2 + 3 - 1) / 3)))) > c1 + -15?(((c1 + -2) * 3 < 0?-(-(c1 + -2) / 3) : ((3 < 0?(-(c1 + -2) + - 3 - 1) / - 3 : (c1 + -2 + 3 - 1) / 3)))) : c1 + -15);
