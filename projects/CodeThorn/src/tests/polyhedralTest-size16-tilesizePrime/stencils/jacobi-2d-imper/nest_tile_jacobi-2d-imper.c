...
#pragma scop
{
    ...
    for (c0 = 0; c0 <= 2; c0++) {
      for (c2 = 1; c2 <= 17; c2++) {
        if (c2 >= 15) {
          if ((c2 + 1) % 2 == 0) {
            for (c4 = (7 * c0 > c2 + -13?7 * c0 : c2 + -13); c4 <= ((c2 < 7 * c0 + 6?c2 : 7 * c0 + 6)); c4++) {
        ...
        for (c3 = (0 > (((c2 + -14) * 2 < 0?-(-(c2 + -14) / 2) : ((2 < 0?(-(c2 + -14) + - 2 - 1) / - 2 : (c2 + -14 + 2 - 1) / 2))))?0 : (((c2 + -14) * 2 < 0?-(-(c2 + -14) / 2) : ((2 < 0?(-(c2 + -14) + - 2 - 1) / - 2 : (c2 + -14 + 2 - 1) / 2))))); c3 <= ((1 < (((c2 + -2) * 2 < 0?((2 < 0?-((-(c2 + -2) + 2 + 1) / 2) : -((-(c2 + -2) + 2 - 1) / 2))) : (c2 + -2) / 2))?1 : (((c2 + -2) * 2 < 0?((2 < 0?-((-(c2 + -2) + 2 + 1) / 2) : -((-(c2 + -2) + 2 - 1) / 2))) : (c2 + -2) / 2)))); c3++) {
          ...
          for (c4 = (7 * c0 > 2 * c3 + 2?7 * c0 : 2 * c3 + 2); c4 <= ((7 * c0 + 6 < 2 * c3 + 14?7 * c0 + 6 : 2 * c3 + 14)); c4++) {
        ...
        if (c2 <= 3) {
          if ((c2 + 1) % 2 == 0) {
            for (c4 = (7 * c0 > c2?7 * c0 : c2); c4 <= ((7 * c0 + 6 < c2 + 13?7 * c0 + 6 : c2 + 13)); c4++) {
