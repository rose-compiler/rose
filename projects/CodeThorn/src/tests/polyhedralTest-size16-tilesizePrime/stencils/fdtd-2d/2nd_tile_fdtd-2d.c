    ...
    int c2;
{
      ...
      for (c4 = 1; c4 <= 4; c4++) {
        ...
        for (c7 = (2 > 5 * c4 + -5?2 : 5 * c4 + -5); c7 <= ((15 < 5 * c4 + -1?15 : 5 * c4 + -1)); c7++) {
      ...
      for (c4 = 5; c4 <= 19; c4++) {
        if (c4 <= 18) {
          ey[c4 + -3][15] = ey[c4 + -3][15] - 0.5 * (hz[c4 + -3][15] - hz[c4 + -3 - 1][15]);
        }
        if (c4 >= 16) {
          for (c7 = (1 > 5 * c4 + -80?1 : 5 * c4 + -80); c7 <= ((15 < 5 * c4 + -76?15 : 5 * c4 + -76)); c7++) {
