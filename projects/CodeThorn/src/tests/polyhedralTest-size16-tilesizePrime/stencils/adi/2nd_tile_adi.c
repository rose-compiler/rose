...
#pragma omp parallel for private(c1)
              for (c0 = ((7 * c2 + -4) * 5 < 0?-(-(7 * c2 + -4) / 5) : ((5 < 0?(-(7 * c2 + -4) + - 5 - 1) / - 5 : (7 * c2 + -4 + 5 - 1) / 5))); c0 <= ((3 < (((7 * c2 + 6) * 5 < 0?((5 < 0?-((-(7 * c2 + 6) + 5 + 1) / 5) : -((-(7 * c2 + 6) + 5 - 1) / 5))) : (7 * c2 + 6) / 5))?3 : (((7 * c2 + 6) * 5 < 0?((5 < 0?-((-(7 * c2 + 6) + 5 + 1) / 5) : -((-(7 * c2 + 6) + 5 - 1) / 5))) : (7 * c2 + 6) / 5)))); c0++) {
#pragma ivdep
#pragma vector always
#pragma simd
                for (c1 = (5 * c0 > 7 * c2?5 * c0 : 7 * c2); c1 <= ((((15 < 5 * c0 + 4?15 : 5 * c0 + 4)) < 7 * c2 + 6?((15 < 5 * c0 + 4?15 : 5 * c0 + 4)) : 7 * c2 + 6)); c1++) {
