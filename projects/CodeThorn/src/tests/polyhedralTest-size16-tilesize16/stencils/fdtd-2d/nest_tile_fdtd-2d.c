    ...
    for (c0 = 0; c0 <= 1; c0++) {
      for (c2 = 1; c2 <= 16; c2++) {
        ...
        if (c2 == 1) {
          ...
          for (c4 = (2 > 16 * c0?2 : 16 * c0); c4 <= ((16 < 16 * c0 + 15?16 : 16 * c0 + 15)); c4++) {
        ...
        if (c2 >= 2) {
          for (c3 = (((0 > 16 * c0 + -15?0 : 16 * c0 + -15)) > c2 + -15?((0 > 16 * c0 + -15?0 : 16 * c0 + -15)) : c2 + -15); c3 <= 1; c3++) {
            if (c0 == 0 && c3 == 1) {
              ey[c2 + -1][0] = ey[c2 + -1][0] - 0.5 * (hz[c2 + -1][0] - hz[c2 + -1 - 1][0]);
            }
            for (c4 = (16 * c0 > c3 + 1?16 * c0 : c3 + 1); c4 <= ((16 * c0 + 15 < c3 + 15?16 * c0 + 15 : c3 + 15)); c4++) {
