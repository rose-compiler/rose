...
#pragma scop
{
    ...
    int c4;
    for (c2 = 2; c2 <= 30; c2++) {
      for (c3 = (0 > (((c2 + -28) * 2 < 0?-(-(c2 + -28) / 2) : ((2 < 0?(-(c2 + -28) + - 2 - 1) / - 2 : (c2 + -28 + 2 - 1) / 2))))?0 : (((c2 + -28) * 2 < 0?-(-(c2 + -28) / 2) : ((2 < 0?(-(c2 + -28) + - 2 - 1) / - 2 : (c2 + -28 + 2 - 1) / 2))))); c3 <= ((1 < (((c2 + -2) * 2 < 0?((2 < 0?-((-(c2 + -2) + 2 + 1) / 2) : -((-(c2 + -2) + 2 - 1) / 2))) : (c2 + -2) / 2))?1 : (((c2 + -2) * 2 < 0?((2 < 0?-((-(c2 + -2) + 2 + 1) / 2) : -((-(c2 + -2) + 2 - 1) / 2))) : (c2 + -2) / 2)))); c3++) {
        for (c4 = (c3 + 1 > c2 + -1 * c3 + -14?c3 + 1 : c2 + -1 * c3 + -14); c4 <= ((c3 + 14 < c2 + -1 * c3 + -1?c3 + 14 : c2 + -1 * c3 + -1)); c4++) {
