...
#pragma scop
{
    ...
    for (c0 = 0; c0 <= 1; c0++) {
      ...
      for (c1 = 2 * c0 + 2; c1 <= 2 * c0 + 62; c1++) {
        ...
        A[-2 * c0 + c1 + -1][62] = B[-2 * c0 + c1 + -1][62];
      }
      for (c2 = 2 * c0 + 2; c2 <= 2 * c0 + 63; c2++) {
        A[62][-2 * c0 + c2 + -1] = B[62][-2 * c0 + c2 + -1];
      }
    }
  }
