...
#pragma simd
              for (c1 = 2 * c0; c1 <= 2 * c0 + 1; c1++) {
                X[c1][64 - c8 - 2] = (X[c1][64 - 2 - c8] - X[c1][64 - 2 - c8 - 1] * A[c1][64 - c8 - 3]) / B[c1][64 - 3 - c8];
              }
            }
          }
        }
...
#pragma simd
              for (c1 = 2 * c0; c1 <= 2 * c0 + 1; c1++) {
                X[64 - 2 - c8][c1] = (X[64 - 2 - c8][c1] - X[64 - c8 - 3][c1] * A[64 - 3 - c8][c1]) / B[64 - 2 - c8][c1];
              }
            }
          }
        }
