...
#pragma omp parallel for private(c3, c2)
{
        ...
        int c4;
        if (c0 >= 1 && c0 <= 70) {
          for (c4 = ((4 * c0 + -4) * 9 < 0?-(-(4 * c0 + -4) / 9) : ((9 < 0?(-(4 * c0 + -4) + - 9 - 1) / - 9 : (4 * c0 + -4 + 9 - 1) / 9))); c4 <= ((31 < ((c0 * 2 < 0?((2 < 0?-((-c0 + 2 + 1) / 2) : -((-c0 + 2 - 1) / 2))) : c0 / 2))?31 : ((c0 * 2 < 0?((2 < 0?-((-c0 + 2 + 1) / 2) : -((-c0 + 2 - 1) / 2))) : c0 / 2)))); c4++) {
#pragma ivdep
