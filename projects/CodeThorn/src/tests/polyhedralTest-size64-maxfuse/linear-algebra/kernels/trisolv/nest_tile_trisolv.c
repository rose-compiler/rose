...
#pragma omp parallel for private(c3, c4)
      for (c2 = (0 > c1 + -31?0 : c1 + -31); c2 <= (((c1 + -3) * 3 < 0?((3 < 0?-((-(c1 + -3) + 3 + 1) / 3) : -((-(c1 + -3) + 3 - 1) / 3))) : (c1 + -3) / 3)); c2++) {
      ...
      c2 = ((((c1 + -2) * 3 < 0?-(-(c1 + -2) / 3) : ((3 < 0?(-(c1 + -2) + - 3 - 1) / - 3 : (c1 + -2 + 3 - 1) / 3)))) > c1 + -31?(((c1 + -2) * 3 < 0?-(-(c1 + -2) / 3) : ((3 < 0?(-(c1 + -2) + - 3 - 1) / - 3 : (c1 + -2 + 3 - 1) / 3)))) : c1 + -31);
