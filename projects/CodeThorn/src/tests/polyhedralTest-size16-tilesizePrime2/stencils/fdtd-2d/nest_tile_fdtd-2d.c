...
#pragma scop
{
    ...
    for (c0 = 0; c0 <= 1; c0++) {
      for (c2 = 1; c2 <= 16; c2++) {
        if (c2 == 1) {
          for (c4 = (1 > 11 * c0?1 : 11 * c0); c4 <= ((15 < 11 * c0 + 10?15 : 11 * c0 + 10)); c4++) {
        ...
        if (c2 == 1) {
          ...
          for (c4 = (2 > 11 * c0?2 : 11 * c0); c4 <= ((16 < 11 * c0 + 10?16 : 11 * c0 + 10)); c4++) {
        ...
        if (c2 >= 2) {
          for (c3 = (0 > c2 + -15?0 : c2 + -15); c3 <= 1; c3++) {
            ...
            for (c4 = (11 * c0 > c3 + 1?11 * c0 : c3 + 1); c4 <= ((11 * c0 + 10 < c3 + 15?11 * c0 + 10 : c3 + 15)); c4++) {
