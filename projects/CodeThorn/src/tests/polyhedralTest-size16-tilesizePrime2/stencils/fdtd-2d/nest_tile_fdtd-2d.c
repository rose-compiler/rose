...
#pragma scop
{
    ...
    for (c0 = 0; c0 <= 1; c0++) {
      for (c2 = 1; c2 <= 16; c2++) {
        if (c2 == 1) {
          for (c4 = (1 > 13 * c0?1 : 13 * c0); c4 <= ((15 < 13 * c0 + 12?15 : 13 * c0 + 12)); c4++) {
        ...
        if (c2 == 1) {
          ...
          for (c4 = (2 > 13 * c0?2 : 13 * c0); c4 <= ((16 < 13 * c0 + 12?16 : 13 * c0 + 12)); c4++) {
        ...
        if (c2 >= 2) {
          for (c3 = (0 > c2 + -15?0 : c2 + -15); c3 <= 1; c3++) {
            ...
            for (c4 = (13 * c0 > c3 + 1?13 * c0 : c3 + 1); c4 <= ((13 * c0 + 12 < c3 + 15?13 * c0 + 12 : c3 + 15)); c4++) {
