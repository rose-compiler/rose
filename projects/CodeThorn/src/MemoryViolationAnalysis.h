...
namespace CodeThorn {
 ...
 public:
    enum MemoryAccessViolationType {ACCESS_ERROR,ACCESS_DEFINITELY_NP, ACCESS_POTENTIALLY_NP, ACCESS_DEFINITELY_INSIDE_BOUNDS, ACCESS_POTENTIALLY_OUTSIDE_BOUNDS, ACCESS_DEFINITELY_OUTSIDE_BOUNDS, ACCESS_NON_EXISTING};
