...
-estate-properties", po::value< string >(), "transition graph 1: visualize all estate-properties [=yes|no]")
	...
	("precision-bool",po::value< string >(),"use precise top with intbool-(and/or) operators (used in LTL)")
