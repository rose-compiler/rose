...
public:
  ...
  std::string externalFunctionsCSVFileName="external-functions.csv"; // generated by FunctionCallMapping
  std::string analysisReportOverviewFileName="overview.txt"; // generated by AnalysisReporting
  std::string analyzedExternalFunctionCallsCSVFileName="analyzed-external-functions.csv"; // generated by analysis
  int threads=1;
  bool unparse=false;
