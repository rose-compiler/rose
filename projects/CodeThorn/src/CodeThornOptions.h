...
struct CodeThornOptions : public CodeThorn::Options {
  ...
  std::string analyzedFunctionsCSVFileName; // generated by analysis+reporting
  std::string analyzedFilesCSVFileName; // generated by analys+reporting
  std::string externalFunctionCallsCSVFileName;  // generated by analysis+reporting
  std::string externalFunctionsCSVFileName; // generated by FunctionCallMapping
  int threads=1;
  bool unparse=false;
  ...
  bool astConsistencySymbolCheckFlag=true; // performed by VariableIdMapping
