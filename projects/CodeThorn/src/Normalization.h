...
namespace SPRAY {
  ...
  private:
    ...
    enum SubExprTransformationEnum { GEN_UNDEFINED, GEN_TMPVAR, GEN_FALSE_BOOL_VAR_DECL, GEN_BOOL_VAR_IF_ELSE_STMT, GEN_BOOL_VAR_IF_STMT, GEN_IF_ELSE_STMT, GEN_LOG_OP_REPLACEMENT };
