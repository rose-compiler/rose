...
namespace SPRAY {
  ...
  private:
    ...
    enum SubExprTransformationEnum { GEN_UNDEFINED, GEN_TMPVAR, GEN_FALSE_BOOL_VAR_DECL, GEN_BOOL_VAR_IF_ELSE_STMT, GEN_BOOL_VAR_IF_STMT, GEN_LOG_OP_REPLACEMENT };
    struct RegisteredSubExprTransformation {
      ...
      RegisteredSubExprTransformation(SubExprTransformationEnum, SgStatement* s, SgExpression* e, SgVariableDeclaration* d, SgStatement* falseBody);
      SgStatement* stmt;
      SgExpression* expr;
    ...
    SgIfStmt* generateBoolVarIfElseStmt(SgExpression* cond, SgVarRefExp* varRefExp, SgStatement* false_body, SgScopeStatement* scope);
    void registerBoolVarIfElseStmt(SgStatement* stmt, SgExpression  * expr, SgVariableDeclaration* decl, SgStatement* false_body, SubExprTransformationList& subExprTransformationList);
