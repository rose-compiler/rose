...
class RoseRDAnalysis {
 public:
  static void generateRoseRDDotFiles(Labeler* labeler, SgProject* root);
 private:
  static void generateRoseRDDotFile(VariableRenaming* varRen,std::string filename);
  static void generateRoseRDDotFile2(Labeler* labeler, VariableRenaming* varRen,std::string filename);
