...
#include "OmpLoopRATransformationCocoCodes.h"
...
#include "astInterface/AstInterface.h"
...
public:
 ...
 // DQ (7/27/2005): the isVisited flag has been removed now!
...
unsigned short int OmpLoopRATransformationParser::SymSet[][MAXSYM] = {
  /*EOF_Sym */
...
void OmpLoopRATransformationParser::Get()
{ do {
    Sym = Scanner->Get();
...
void OmpLoopRATransformationParser::ExpectWeak(int n, int follow)
{ if (Sym == n) Get();
  else {
    GenError(n);
...
int OmpLoopRATransformationParser::WeakSeparator(int n, int syFol, int repFol)
...
void OmpLoopRATransformationParser::SgNode()
{
...
void OmpLoopRATransformationParser::SgSupport()
{
	switch (Sym) {
		case SgNameSym:  
			Get();
...
void OmpLoopRATransformationParser::SgLocatedNode()
{
	unsigned int forNestingLevel=0;
...
void OmpLoopRATransformationParser::SgSymbol()
{
	switch (Sym) {
...
void OmpLoopRATransformationParser::SgInitializedNameNT()
{
...
void OmpLoopRATransformationParser::SgFileNT()
{
	Expect(SgFileSym);
	{;
...
void OmpLoopRATransformationParser::SgClassDeclarationNT()
{
...
void OmpLoopRATransformationParser::SgAttribute()
{
	if (Sym == SgPragmaSym) {
		Get();
		{;
...
void OmpLoopRATransformationParser::SgGlobalNT()
{
	Expect(SgGlobalSym);
	{;
...
void OmpLoopRATransformationParser::SgDeclarationStatement()
{
	switch (Sym) {
...
void OmpLoopRATransformationParser::SgInitializer()
{
...
void OmpLoopRATransformationParser::SgBitAttribute()
{
...
void OmpLoopRATransformationParser::SgStatement(unsigned int forNestingLevel)
{
	switch (Sym) {
...
void OmpLoopRATransformationParser::SgExpression()
{
	switch (Sym) {
		case SgVarRefExpSym:  
			Get();
...
void OmpLoopRATransformationParser::SgExpressionRootNT()
{
...
void OmpLoopRATransformationParser::SgBasicBlockNT(unsigned int forNestingLevel)
{
...
void OmpLoopRATransformationParser::SgFunctionCallExpNT()
{
...
#if 0
// DQ (2/8/2004): These are no longer included in the SAGE III AST
void OmpLoopRATransformationParser::SgC_PreprocessorDirectiveStatem()
{
	switch (Sym) {
		case SgIncludeDirectiveStatementSym:  
			Get();
...
#if 0
// DQ (2/8/2004): These are no longer included in the SAGE III AST
void OmpLoopRATransformationParser::SgCommentStatement()
{
...
void OmpLoopRATransformationParser::SgScopeStatement(unsigned int forNestingLevel)
{
	switch (Sym) {
		case SgGlobalSym:  
			Get();
		...
		case SgForStatementSym:  
			...
			SgExpressionRootNT();
			SgExpressionRootNT();
			SgBasicBlockNT(forNestingLevel+1);
			Expect(RparenSym);
...
void OmpLoopRATransformationParser::SgForInitStatementNT(unsigned int forNestingLevel)
{
...
void OmpLoopRATransformationParser::SgUnsignedLongValNT()
{
...
void OmpLoopRATransformationParser::SgFunctionParameterListNT()
{
...
void OmpLoopRATransformationParser::SgCtorInitializerListNT()
{
...
void OmpLoopRATransformationParser::SgFunctionDeclarationNT()
{
...
void OmpLoopRATransformationParser::SgClassDefinitionNT()
{
...
void OmpLoopRATransformationParser::SgFunctionDefinitionNT()
{
	unsigned int forNestingLevel=0;
...
void OmpLoopRATransformationParser::SgExprListExpNT()
{
...
void OmpLoopRATransformationParser::SgConstructorInitializerNT()
{
...
void OmpLoopRATransformationParser::SgValueExp()
{
	switch (Sym) {
		case SgBoolValExpSym:  
			Get();
...
void OmpLoopRATransformationParser::SgBinaryOp()
{
	switch (Sym) {
		case SgArrowExpSym:  
			Get();
...
void OmpLoopRATransformationParser::SgUnaryOp()
{
	switch (Sym) {
		case SgExpressionRootSym:  
			SgExpressionRootNT();
...
void OmpLoopRATransformationParser::SgClassSymbol()
{
#if 0
...
void OmpLoopRATransformationParser::SgFunctionSymbolNT()
{
...
void OmpLoopRATransformationParser::Parse()
{ Scanner->Reset(); Get();
  SgNode();
}
