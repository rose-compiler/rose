                   ...
                   if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                     {
                       for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                       {
                         for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                         {
                           double tmp = 0.0;
                           for (int d = 1;d<=dist;d++) 
                             tmp+=arraySection[local_index3D(i-d,-1+locallocallocal_size1,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,-1+locallocallocal_size1,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size1-d,k,locallocallocal_size0,locallocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[1][2][1]][otherCore_index3D(i,-1+d,k,localrightlocal_size0,localrightlocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size1,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size1,k+d,locallocallocal_size0,locallocallocal_size1)];
                   ...
                   if (leftlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][0]) 
                     {
                       for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                       {
                         for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                         {
                           double tmp = 0.0;
                           for (int d = 1;d<=dist;d++) 
                             tmp+=arraySection[local_index3D(i-d,j,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,j,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,j+d,0,locallocallocal_size0,locallocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[0][1][1]][otherCore_index3D(i,j,leftlocallocal_size2-d,leftlocallocal_size0,leftlocallocal_size1)]+arraySection[local_index3D(i,j,0+d,locallocallocal_size0,locallocallocal_size1)];
                           ...
                           if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                             {
                               for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=arraySection[local_index3D(i-d,-1+locallocallocal_size1,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,-1+locallocallocal_size1,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size1-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[1][2][1]][otherCore_index3D(i,-1+d,0,localrightlocal_size0,localrightlocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[0][1][1]][otherCore_index3D(i,-1+locallocallocal_size1,leftlocallocal_size2-d,leftlocallocal_size0,leftlocallocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size1,0+d,locallocallocal_size0,locallocallocal_size1)];
                         ...
                         if (leftlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][0]) 
                           {
                             for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(i-d,0,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,0,locallocallocal_size0,locallocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[0][1][1]][otherCore_index3D(i,leftlocallocal_size2-d,0,leftlocallocal_size0,leftlocallocal_size1)]+arraySection[local_index3D(i,0+d,0,locallocallocal_size0,locallocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[0][1][1]][otherCore_index3D(i,0,leftlocallocal_size2-d,leftlocallocal_size0,leftlocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[2][1][1]][otherCore_index3D(i,0,-1+d,rightlocallocal_size0,rightlocallocal_size1)];
                               old_arraySection[local_index3D(i,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                             if (locallocallocal_size1>1) 
                               {
                         ...
                         if (rightlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][1]) 
                           {
                             for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(i-d,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size2-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[2][1][1]][otherCore_index3D(i,-1+d,0,rightlocallocal_size0,rightlocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[0][1][1]][otherCore_index3D(i,-1+locallocallocal_size2,leftlocallocal_size2-d,leftlocallocal_size0,leftlocallocal_size1)]+arraySectionPointers[cur_core->coreArrayNeighborhoodLinearized_3D[2][1][1]][otherCore_index3D(i,-1+locallocallocal_size2,-1+d,rightlocallocal_size0,rightlocallocal_size1)];
