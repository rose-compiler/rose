                   ...
                   if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                     for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                     {
                       for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                       {
                         double tmp = 0.0;
                         for (int d = 1;d<=dist;d++) 
                           tmp+=locallocalleft_cp[dist+(-d+(k*(dist*locallocalleft_size1)+j*dist))] +arraySection[local_index3D(0+d,j,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j-d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j,k+d,locallocallocal_size0,locallocallocal_size1)];
                 ...
                 if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                   {
                     for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                     {
                       for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                       {
                         double tmp = 0.0;
                         for (int d = 1;d<=dist;d++) 
                           tmp+=locallocalleft_cp[dist+(-d+(k*(dist*locallocalleft_size1)+j*dist))] +locallocalright_cp[d+(-1+(k*(dist*locallocalright_size1)+j*dist))] +arraySection[local_index3D(0,j-d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j,k+d,locallocallocal_size0,locallocallocal_size1)];
                         old_arraySection[local_index3D(0,j,k,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                       }
                     }
                   }
                   ...
                   if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                     {
                       for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                       {
                         for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                         {
                           double tmp = 0.0;
                           for (int d = 1;d<=dist;d++) 
                             tmp+=arraySection[local_index3D(i-d,0,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,k,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[i+(k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0))] +arraySection[local_index3D(i,0+d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                           ...
                           if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                             {
                               for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=locallocalleft_cp[k*(dist*locallocalleft_size1)+(-d+dist)] +arraySection[local_index3D(0+d,0,k,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0)] +arraySection[local_index3D(0,0+d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                           ...
                           if (locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1]) 
                             {
                               for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=arraySection[local_index3D(-1+locallocallocal_size0-d,0,k,locallocallocal_size0,locallocallocal_size1)]+locallocalright_cp[k*(dist*locallocalright_size1)+(-1+d)] +localleftlocal_cp[locallocallocal_size0+(-1+(k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0)))] +arraySection[local_index3D(-1+locallocallocal_size0,0+d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(-1+locallocallocal_size0,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(-1+locallocallocal_size0,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                         ...
                         if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                           {
                             for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=locallocalleft_cp[k*(dist*locallocalleft_size1)+(-d+dist)] +locallocalright_cp[k*(dist*locallocalright_size1)+(-1+d)] +localleftlocal_cp[k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0)] +arraySection[local_index3D(0,0+d,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                               old_arraySection[local_index3D(0,0,k,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                           }
                     }
                           ...
                           if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                             {
                               for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=locallocalleft_cp[-d+(k*(dist*locallocalleft_size1)+locallocallocal_size1*dist)] +arraySection[local_index3D(0+d,-1+locallocallocal_size1,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,-1+locallocallocal_size1-d,k,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[k*(localrightlocal_size0*dist)+(-localrightlocal_size0+d*localrightlocal_size0)] +arraySection[local_index3D(0,-1+locallocallocal_size1,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,-1+locallocallocal_size1,k+d,locallocallocal_size0,locallocallocal_size1)];
                 ...
                 if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                   {
                     for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                     {
                       for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                       {
                         double tmp = 0.0;
                         for (int d = 1;d<=dist;d++) 
                           tmp+=arraySection[local_index3D(i-d,0,k,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,k,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[i+(k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0))] +localrightlocal_cp[i+(k*(localrightlocal_size0*dist)+(-localrightlocal_size0+d*localrightlocal_size0))] +arraySection[local_index3D(i,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                         old_arraySection[local_index3D(i,0,k,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                       }
                     }
                     if (locallocallocal_size1>1) 
                         ...
                         if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                           {
                             for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(k*(localleftlocal_size0*dist)+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0)))] +arraySection[local_index3D(0+d,0,k,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0)] +localrightlocal_cp[k*(localrightlocal_size0*dist)+(-localrightlocal_size0+d*localrightlocal_size0)] +arraySection[local_index3D(0,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                               old_arraySection[local_index3D(0,0,k,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                           }
                         if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                           {
                             for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(-1+locallocallocal_size1-d,0,k,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[k*(localrightlocal_size0*dist)+(-1+d)] +localleftlocal_cp[locallocallocal_size1+(-1+(k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0)))] +localrightlocal_cp[locallocallocal_size1+(-1+(k*(localrightlocal_size0*dist)+(-localrightlocal_size0+d*localrightlocal_size0)))] +arraySection[local_index3D(-1+locallocallocal_size1,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(-1+locallocallocal_size1,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                       ...
                       if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                         {
                           for (k=dist; k<locallocallocal_size2-dist; k=k+dist)
                           {
                             double tmp = 0.0;
                             for (int d = 1;d<=dist;d++) 
                               tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(k*(localleftlocal_size0*dist)+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0)))] +localrightlocal_cp[k*(localrightlocal_size0*dist)+(-1+d)] +localleftlocal_cp[k*(localleftlocal_size0*dist)+(-d*localleftlocal_size0+dist*localleftlocal_size0)] +localrightlocal_cp[k*(localrightlocal_size0*dist)+(-localrightlocal_size0+d*localrightlocal_size0)] +arraySection[local_index3D(0,0,k-d,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,k+d,locallocallocal_size0,locallocallocal_size1)];
                             old_arraySection[local_index3D(0,0,k,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                           }
                         }
                   }
                   ...
                   if (leftlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][0]) 
                     {
                       for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                       {
                         for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                         {
                           double tmp = 0.0;
                           for (int d = 1;d<=dist;d++) 
                             tmp+=arraySection[local_index3D(i-d,j,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,j,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[i+(j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +arraySection[local_index3D(i,j,0+d,locallocallocal_size0,locallocallocal_size1)];
                           ...
                           if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                             {
                               for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=locallocalleft_cp[j*dist+(-d+dist)] +arraySection[local_index3D(0+d,j,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +arraySection[local_index3D(0,j,0+d,locallocallocal_size0,locallocallocal_size1)];
                           ...
                           if (locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1]) 
                             {
                               for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=arraySection[local_index3D(-1+locallocallocal_size0-d,j,0,locallocallocal_size0,locallocallocal_size1)]+locallocalright_cp[j*dist+(-1+d)] +arraySection[local_index3D(-1+locallocallocal_size0,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(-1+locallocallocal_size0,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[locallocallocal_size0+(-1+(j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))))] +arraySection[local_index3D(-1+locallocallocal_size0,j,0+d,locallocallocal_size0,locallocallocal_size1)];
                         ...
                         if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                           {
                             for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=locallocalleft_cp[j*dist+(-d+dist)] +locallocalright_cp[j*dist+(-1+d)] +arraySection[local_index3D(0,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +arraySection[local_index3D(0,j,0+d,locallocallocal_size0,locallocallocal_size1)];
                               old_arraySection[local_index3D(0,j,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                           }
                       if (locallocallocal_size1>1) 
                           ...
                           if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                             {
                               for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=arraySection[local_index3D(i-d,0,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,0,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[i+(-d*localleftlocal_size0+dist*localleftlocal_size0)] +arraySection[local_index3D(i,0+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[i+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +arraySection[local_index3D(i,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                                   ...
                                   if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                                     {
                                       double tmp = 0.0;
                                       for (int d = 1;d<=dist;d++) 
                                         tmp+=locallocalleft_cp[-d+dist] +arraySection[local_index3D(0+d,0,0,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[-d*localleftlocal_size0+dist*localleftlocal_size0] +arraySection[local_index3D(0,0+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +arraySection[local_index3D(0,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                                   ...
                                   if (locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1]) 
                                     {
                                       double tmp = 0.0;
                                       for (int d = 1;d<=dist;d++) 
                                         tmp+=arraySection[local_index3D(-1+locallocallocal_size0-d,0,0,locallocallocal_size0,locallocallocal_size1)]+locallocalright_cp[-1+d] +localleftlocal_cp[locallocallocal_size0+(-1+(-d*localleftlocal_size0+dist*localleftlocal_size0))] +arraySection[local_index3D(-1+locallocallocal_size0,0+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[locallocallocal_size0+(-1+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +arraySection[local_index3D(-1+locallocallocal_size0,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                                 ...
                                 if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=locallocalleft_cp[-d+dist] +locallocalright_cp[-1+d] +localleftlocal_cp[-d*localleftlocal_size0+dist*localleftlocal_size0] +arraySection[local_index3D(0,0+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +arraySection[local_index3D(0,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                                     old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                   }
                             }
                           if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                                   ...
                                   if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                                     {
                                       double tmp = 0.0;
                                       for (int d = 1;d<=dist;d++) 
                                         tmp+=locallocalleft_cp[-d+locallocallocal_size1*dist] +arraySection[local_index3D(0+d,-1+locallocallocal_size1,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,-1+locallocallocal_size1-d,0,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[-localrightlocal_size0+d*localrightlocal_size0] +leftlocallocal_cp[locallocallocal_size1*leftlocallocal_size0+(-leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +arraySection[local_index3D(0,-1+locallocallocal_size1,0+d,locallocallocal_size0,locallocallocal_size1)];
                         ...
                         if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                           {
                             for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(i-d,0,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,0,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[i+(-d*localleftlocal_size0+dist*localleftlocal_size0)] +localrightlocal_cp[i+(-localrightlocal_size0+d*localrightlocal_size0)] +leftlocallocal_cp[i+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +arraySection[local_index3D(i,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                               old_arraySection[local_index3D(i,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                             if (locallocallocal_size1>1) 
                               {
                                 if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0))] +arraySection[local_index3D(0+d,0,0,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[-d*localleftlocal_size0+dist*localleftlocal_size0] +localrightlocal_cp[-localrightlocal_size0+d*localrightlocal_size0] +leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +arraySection[local_index3D(0,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                                     old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                   }
                                 if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                                   {
                               ...
                               if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                                 {
                                   double tmp = 0.0;
                                   for (int d = 1;d<=dist;d++) 
                                     tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0))] +localrightlocal_cp[-1+d] +localleftlocal_cp[-d*localleftlocal_size0+dist*localleftlocal_size0] +localrightlocal_cp[-localrightlocal_size0+d*localrightlocal_size0] +leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +arraySection[local_index3D(0,0,0+d,locallocallocal_size0,locallocallocal_size1)];
                                   old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                 }
                           }
                     }
                         ...
                         if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                           {
                             for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=locallocalleft_cp[dist+(-d+(j*dist+(-(dist*locallocalleft_size1)+locallocallocal_size2*(dist*locallocalleft_size1))))] +locallocalright_cp[d+(-1+(j*dist+(-(dist*locallocalright_size1)+locallocallocal_size2*(dist*locallocalright_size1))))] +arraySection[local_index3D(0,j-d,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[j*rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))] ;
                               old_arraySection[local_index3D(0,j,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                           }
                       if (locallocallocal_size1>1) 
                                   ...
                                   if (locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0]) 
                                     {
                                       double tmp = 0.0;
                                       for (int d = 1;d<=dist;d++) 
                                         tmp+=locallocalleft_cp[dist+(-d+(-(dist*locallocalleft_size1)+locallocallocal_size2*(dist*locallocalleft_size1)))] +arraySection[local_index3D(0+d,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))] +arraySection[local_index3D(0,0+d,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                   ...
                                   if (locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1]) 
                                     {
                                       double tmp = 0.0;
                                       for (int d = 1;d<=dist;d++) 
                                         tmp+=arraySection[local_index3D(-1+locallocallocal_size0-d,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+locallocalright_cp[d+(-1+(-(dist*locallocalright_size1)+locallocallocal_size2*(dist*locallocalright_size1)))] +localleftlocal_cp[locallocallocal_size0+(-1+(dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))))] +arraySection[local_index3D(-1+locallocallocal_size0,0+d,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(-1+locallocallocal_size0,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[locallocallocal_size0+(-1+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)))] ;
                                 ...
                                 if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=locallocalleft_cp[dist+(-d+(-(dist*locallocalleft_size1)+locallocallocal_size2*(dist*locallocalleft_size1)))] +locallocalright_cp[d+(-1+(-(dist*locallocalright_size1)+locallocallocal_size2*(dist*locallocalright_size1)))] +localleftlocal_cp[dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))] +arraySection[local_index3D(0,0+d,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                     old_arraySection[local_index3D(0,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                   }
                             }
                           if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                                 ...
                                 if ((locallocalleft_size0>0&&!cur_core->boundaryCore_3D[0][0])&&(locallocalright_size0>0&&!cur_core->boundaryCore_3D[0][1])) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=locallocalleft_cp[-d+(locallocallocal_size1*dist+(-(dist*locallocalleft_size1)+locallocallocal_size2*(dist*locallocalleft_size1)))] +locallocalright_cp[d+(-1+(locallocallocal_size1*dist+(-dist+(-(dist*locallocalright_size1)+locallocallocal_size2*(dist*locallocalright_size1)))))] +arraySection[local_index3D(0,-1+locallocallocal_size1-d,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[d*localrightlocal_size0+(-localrightlocal_size0+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist)))] +arraySection[local_index3D(0,-1+locallocallocal_size1,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[locallocallocal_size1*rightlocallocal_size0+(-rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)))] ;
                                     old_arraySection[local_index3D(0,-1+locallocallocal_size1,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                   }
                             }
                         }
                         ...
                         if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                           {
                             for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(i-d,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[i+(dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist))))] +localrightlocal_cp[i+(d*localrightlocal_size0+(-localrightlocal_size0+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist))))] +arraySection[local_index3D(i,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[i+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))] ;
                               old_arraySection[local_index3D(i,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                             if (locallocallocal_size1>1) 
                               {
                                 if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(dist*localleftlocal_size0+(-localleftlocal_size1*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))))] +arraySection[local_index3D(0+d,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+localleftlocal_cp[dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))] +localrightlocal_cp[d*localrightlocal_size0+(-localrightlocal_size0+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist)))] +arraySection[local_index3D(0,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                     old_arraySection[local_index3D(0,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                   }
                                 if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=arraySection[local_index3D(-1+locallocallocal_size1-d,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[d+(-1+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist)))] +localleftlocal_cp[locallocallocal_size1+(-1+(dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))))] +localrightlocal_cp[locallocallocal_size1+(-1+(d*localrightlocal_size0+(-localrightlocal_size0+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist)))))] +arraySection[local_index3D(-1+locallocallocal_size1,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[locallocallocal_size1+(-1+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)))] ;
                               ...
                               if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                                 {
                                   double tmp = 0.0;
                                   for (int d = 1;d<=dist;d++) 
                                     tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(dist*localleftlocal_size0+(-localleftlocal_size1*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))))] +localrightlocal_cp[d+(-1+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist)))] +localleftlocal_cp[dist*localleftlocal_size0+(-d*localleftlocal_size0+(-(localleftlocal_size0*dist)+locallocallocal_size2*(localleftlocal_size0*dist)))] +localrightlocal_cp[d*localrightlocal_size0+(-localrightlocal_size0+(-(localrightlocal_size0*dist)+locallocallocal_size2*(localrightlocal_size0*dist)))] +arraySection[local_index3D(0,0,-1+locallocallocal_size2-d,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                   old_arraySection[local_index3D(0,0,-1+locallocallocal_size2,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                 }
                           }
                     }
                         ...
                         if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                           {
                             for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(j*localleftlocal_size0+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0)))] +arraySection[local_index3D(0+d,j,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +rightlocallocal_cp[j*rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))] ;
                               old_arraySection[local_index3D(0,j,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                             }
                           }
                         if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                           {
                             for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(-1+locallocallocal_size1-d,j,0,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[j*localrightlocal_size0+(-1+d)] +arraySection[local_index3D(-1+locallocallocal_size1,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(-1+locallocallocal_size1,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[locallocallocal_size1+(-1+(j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))))] +rightlocallocal_cp[locallocallocal_size1+(-1+(j*rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))))] ;
                       ...
                       if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                         {
                           for (j=dist; j<locallocallocal_size1-dist; j=j+dist)
                           {
                             double tmp = 0.0;
                             for (int d = 1;d<=dist;d++) 
                               tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(j*localleftlocal_size0+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0)))] +localrightlocal_cp[j*localrightlocal_size0+(-1+d)] +arraySection[local_index3D(0,j-d,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,j+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[j*leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +rightlocallocal_cp[j*rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))] ;
                             old_arraySection[local_index3D(0,j,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                           }
                         }
                     if (locallocallocal_size2>1) 
                                 ...
                                 if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0))] +arraySection[local_index3D(0+d,0,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[-d*leftlocallocal_size0+(leftlocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +arraySection[local_index3D(0,0+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                     old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                   }
                                 if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                                   {
                               ...
                               if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                                 {
                                   double tmp = 0.0;
                                   for (int d = 1;d<=dist;d++) 
                                     tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(-localleftlocal_size1*localleftlocal_size0+dist*localleftlocal_size0))] +localrightlocal_cp[-1+d] +leftlocallocal_cp[-d*leftlocallocal_size0+(leftlocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +arraySection[local_index3D(0,0+d,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                   old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                 }
                           }
                         if (rightlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][1]) 
                           {
                             for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                             {
                               double tmp = 0.0;
                               for (int d = 1;d<=dist;d++) 
                                 tmp+=arraySection[local_index3D(i-d,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i,-1+locallocallocal_size2-d,0,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[i+(-rightlocallocal_size0+d*rightlocallocal_size0)] +leftlocallocal_cp[i+(locallocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))))] +rightlocallocal_cp[i+(locallocallocal_size2*rightlocallocal_size0+(-rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))))] ;
                                 ...
                                 if (localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0]) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(dist*localleftlocal_size0+(-localleftlocal_size1*localleftlocal_size0+(-localleftlocal_size0+locallocallocal_size2*localleftlocal_size0))))] +arraySection[local_index3D(0+d,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(0,-1+locallocallocal_size2-d,0,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[-rightlocallocal_size0+d*rightlocallocal_size0] +leftlocallocal_cp[locallocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +rightlocallocal_cp[locallocallocal_size2*rightlocallocal_size0+(-rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)))] ;
                                 ...
                                 if (localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1]) 
                                   {
                                     double tmp = 0.0;
                                     for (int d = 1;d<=dist;d++) 
                                       tmp+=arraySection[local_index3D(-1+locallocallocal_size1-d,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)]+localrightlocal_cp[d+(-1+(-localrightlocal_size0+locallocallocal_size2*localrightlocal_size0))] +arraySection[local_index3D(-1+locallocallocal_size1,-1+locallocallocal_size2-d,0,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[locallocallocal_size1+(-1+(-rightlocallocal_size0+d*rightlocallocal_size0))] +leftlocallocal_cp[locallocallocal_size1+(-1+(locallocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))))] +rightlocallocal_cp[locallocallocal_size1+(-1+(locallocallocal_size2*rightlocallocal_size0+(-rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)))))] ;
                               ...
                               if ((localleftlocal_size1>0&&!cur_core->boundaryCore_3D[1][0])&&(localrightlocal_size1>0&&!cur_core->boundaryCore_3D[1][1])) 
                                 {
                                   double tmp = 0.0;
                                   for (int d = 1;d<=dist;d++) 
                                     tmp+=localleftlocal_cp[-d+(localleftlocal_size1+(dist*localleftlocal_size0+(-localleftlocal_size1*localleftlocal_size0+(-localleftlocal_size0+locallocallocal_size2*localleftlocal_size0))))] +localrightlocal_cp[d+(-1+(-localrightlocal_size0+locallocallocal_size2*localrightlocal_size0))] +arraySection[local_index3D(0,-1+locallocallocal_size2-d,0,locallocallocal_size0,locallocallocal_size1)]+rightlocallocal_cp[-rightlocallocal_size0+d*rightlocallocal_size0] +leftlocallocal_cp[locallocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size0+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +rightlocallocal_cp[locallocallocal_size2*rightlocallocal_size0+(-rightlocallocal_size0+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)))] ;
                                   old_arraySection[local_index3D(0,-1+locallocallocal_size2,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                 }
                           }
                       }
                       ...
                       if ((leftlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][0])&&(rightlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][1])) 
                         {
                           for (i=dist; i<locallocallocal_size0-dist; i=i+dist)
                           {
                             double tmp = 0.0;
                             for (int d = 1;d<=dist;d++) 
                               tmp+=arraySection[local_index3D(i-d,0,0,locallocallocal_size0,locallocallocal_size1)]+arraySection[local_index3D(i+d,0,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[i+(-d*leftlocallocal_size0+(leftlocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))))] +rightlocallocal_cp[i+(-rightlocallocal_size0+d*rightlocallocal_size0)] +leftlocallocal_cp[i+(-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1))] +rightlocallocal_cp[i+(-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1))] ;
                             old_arraySection[local_index3D(i,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                           }
                           if (locallocallocal_size2>1) 
                             {
                               if (leftlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][0]) 
                                 {
                                   double tmp = 0.0;
                                   for (int d = 1;d<=dist;d++) 
                                     tmp+=leftlocallocal_cp[-d+(leftlocallocal_size2+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +arraySection[local_index3D(0+d,0,0,locallocallocal_size0,locallocallocal_size1)]+leftlocallocal_cp[-d*leftlocallocal_size0+(leftlocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +rightlocallocal_cp[-rightlocallocal_size0+d*rightlocallocal_size0] +leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                   old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                                 }
                               if (rightlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][1]) 
                                 {
                             ...
                             if ((leftlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][0])&&(rightlocallocal_size2>0&&!cur_core->boundaryCore_3D[2][1])) 
                               {
                                 double tmp = 0.0;
                                 for (int d = 1;d<=dist;d++) 
                                   tmp+=leftlocallocal_cp[-d+(leftlocallocal_size2+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +rightlocallocal_cp[-1+d] +leftlocallocal_cp[-d*leftlocallocal_size0+(leftlocallocal_size2*leftlocallocal_size0+(-leftlocallocal_size2*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)))] +rightlocallocal_cp[-rightlocallocal_size0+d*rightlocallocal_size0] +leftlocallocal_cp[-d*(leftlocallocal_size0*leftlocallocal_size1)+dist*(leftlocallocal_size0*leftlocallocal_size1)] +rightlocallocal_cp[-(rightlocallocal_size0*rightlocallocal_size1)+d*(rightlocallocal_size0*rightlocallocal_size1)] ;
                                 old_arraySection[local_index3D(0,0,0,locallocallocal_size0,locallocallocal_size1)] = tmp/(6.0*dist);
                               }
                         }
                   }
