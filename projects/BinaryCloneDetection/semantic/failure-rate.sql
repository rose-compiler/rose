...
create table fr_clone_pairs as
    select func1_id, func2_id
        from semantic_funcsim where ((euclidean_d < 14) OR (euclidean_d <= 20 AND euclidean_d >= 14 AND euclidean_d_ratio < 15)  ) AND similarity >= (select similarity_threshold from fr_settings) ;
