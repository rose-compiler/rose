...
struct UnsignedInt_Type0 fn1(struct UnsignedInt_Type0 input_str)
{
  ...
  printf("input: %u\n", *Deref(input_str));
  return UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(400U));
}
...
int main()
{
  ...
  ((ptr_str.UnsignedInt_Type0::ptr = ptr , ptr_str.addr = (reinterpret_cast < unsigned long long  >  ((&ptr)))) , ((Assign(&ptr_str,UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(400U))) , ptr = ptr_str.UnsignedInt_Type0::ptr)));
  unsigned int *ptr2;
  struct UnsignedInt_Type0 ptr2_str;
  ((ptr2_str.UnsignedInt_Type0::ptr = ptr2 , ptr2_str.addr = (reinterpret_cast < unsigned long long  >  ((&ptr2)))) , ((Assign(&ptr2_str,UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(40U))) , ptr2 = ptr2_str.UnsignedInt_Type0::ptr)));
  ...
  ((start_ptr3_str.UnsignedInt_Type0::ptr = start_ptr3 , start_ptr3_str.addr = (reinterpret_cast < unsigned long long  >  ((&start_ptr3)))) , ((Assign(&start_ptr3_str,UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(400U))) , start_ptr3 = start_ptr3_str.UnsignedInt_Type0::ptr)));
  ...
  do {
    ...
    ((forptr2_str.UnsignedInt_Type0::ptr = forptr2 , forptr2_str.addr = (reinterpret_cast < unsigned long long  >  ((&forptr2)))) , ((Assign(&forptr2_str,UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(400U))) , forptr2 = forptr2_str.UnsignedInt_Type0::ptr)));
    unsigned int *doptr2;
...
// CIRM Review Code
  ...
  ((p_str.UnsignedInt_Type0::ptr = p , p_str.addr = (reinterpret_cast < unsigned long long  >  ((&p)))) , ((Assign(&p_str,UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(400U))) , p = p_str.UnsignedInt_Type0::ptr)));
  unsigned int *index;
