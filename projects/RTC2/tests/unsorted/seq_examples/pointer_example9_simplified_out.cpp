...
struct Int_Type6 Assign(struct Int_Type6 *,struct Int_Type6 );
struct Int_Type6 AddressOf(unsigned long long ,unsigned int );
struct Float_Type1 Assign(struct Float_Type1 *,struct Float_Type1 );
float f_PntrArrRef_Float_Type1_i(struct Float_Type1 ,unsigned long );
float *Deref(struct Float_Type1 );
struct Float_Type1 Float_Type1_Add_Float_Type1_i(struct Float_Type1 ,int );
struct Float_Type1 Float_Type1_Cast_Int_Type6(struct Int_Type6 );
struct Int_Type6 Int_Type6_Cast_Float_Type1(struct Float_Type1 );
void bounds_check(unsigned long long ,unsigned long );
unsigned int Ui_PntrArrRef_UnsignedInt_Type0_i(struct UnsignedInt_Type0 ,unsigned long );
struct Int_Type6 Int_Type6_Sub_Int_Type6_i(struct Int_Type6 ,int );
int *Deref(struct Int_Type6 );
struct Int_Type6 Int_Type6_Increment_Int_Type6(struct Int_Type6 *);
bool b_LessThan_Int_Type6_Int_Type6(struct Int_Type6 ,struct Int_Type6 );
struct Int_Type6 Int_Type6_Assign_Int_Type6_Int_Type6(struct Int_Type6 *,struct Int_Type6 );
struct Int_Type6 Int_Type6_Add_Int_Type6_i(struct Int_Type6 ,int );
struct Int_Type6 Int_Type6_Cast_UnsignedInt_Type0(struct UnsignedInt_Type0 );
...
;
void create_entry(unsigned long long ,unsigned long long ,unsigned long );
...
// Added code
  unsigned long int_array1_index5 = 29UL;
  unsigned int int_array1[int_array1_index5];
  struct UnsignedInt_Type0 int_array1_str;
  ((int_array1_str.UnsignedInt_Type0::ptr = int_array1 , int_array1_str.addr = (reinterpret_cast < unsigned long long  >  ((&int_array1)))) , create_entry(int_array1_str.addr,(reinterpret_cast < unsigned long long  >  (int_array1_str.UnsignedInt_Type0::ptr)),int_array1_index5));
   *Deref(int_array1_str) = 29U;
  int *int_array_index;
  struct Int_Type6 int_array_index_str;
  (int_array_index_str.UnsignedInt_Type0::ptr = int_array_index , int_array_index_str.addr = (reinterpret_cast < unsigned long long  >  ((&int_array_index))));
  printf("Input array\n");
  for (((Int_Type6_Assign_Int_Type6_Int_Type6(&int_array_index_str,Int_Type6_Add_Int_Type6_i(Int_Type6_Cast_UnsignedInt_Type0(int_array1_str),1)) , int_array_index = int_array_index_str.UnsignedInt_Type0::ptr) , int_array_index_str); b_LessThan_Int_Type6_Int_Type6(int_array_index_str,Int_Type6_Add_Int_Type6_i(Int_Type6_Cast_UnsignedInt_Type0(int_array1_str),29)); ((Int_Type6_Increment_Int_Type6(&int_array_index_str) , int_array_index = int_array_index_str.UnsignedInt_Type0::ptr) , int_array_index_str)) {
     *Deref(int_array_index_str) = ( *Deref(Int_Type6_Sub_Int_Type6_i(int_array_index_str,1)) + 1);
    printf("%u\n", *Deref(int_array_index_str));
  }
  printf("Done\n");
  printf("External printing\n");
  print_array(int_array1_str,29U);
  printf("Internal printing\n");
  int index2;
  for (index2 = 0; index2 < 29; index2++) {
    unsigned long int_array1_index7 = index2;
    printf("%u\n",((bounds_check(int_array1_str.addr,int_array1_index7) , Ui_PntrArrRef_UnsignedInt_Type0_i(int_array1_str,int_array1_index7))));
  }
  printf("Done\n");
  unsigned long float_array2_index8 = 49UL;
  float float_array2[float_array2_index8];
  struct Float_Type1 float_array2_str;
  ((float_array2_str.UnsignedInt_Type0::ptr = float_array2 , float_array2_str.addr = (reinterpret_cast < unsigned long long  >  ((&float_array2)))) , create_entry(float_array2_str.addr,(reinterpret_cast < unsigned long long  >  (float_array2_str.UnsignedInt_Type0::ptr)),float_array2_index8));
  ((Int_Type6_Assign_Int_Type6_Int_Type6(&int_array_index_str,Int_Type6_Cast_Float_Type1(float_array2_str)) , int_array_index = int_array_index_str.UnsignedInt_Type0::ptr) , int_array_index_str);
  printf("sizeof(float): %lu\n",4ULL);
  index2 = 0;
  for (; b_LessThan_Int_Type6_Int_Type6(int_array_index_str,Int_Type6_Add_Int_Type6_i(Int_Type6_Cast_Float_Type1(float_array2_str),49)); (((Int_Type6_Assign_Int_Type6_Int_Type6(&int_array_index_str,Int_Type6_Cast_Float_Type1(Float_Type1_Add_Float_Type1_i(Float_Type1_Cast_Int_Type6(int_array_index_str),1))) , int_array_index = int_array_index_str.UnsignedInt_Type0::ptr) , int_array_index_str) , index2++)) {
     *Deref(Float_Type1_Cast_Int_Type6(int_array_index_str)) = 50.0000F;
    unsigned long float_array2_index9 = index2;
    printf("%f\n",((bounds_check(float_array2_str.addr,float_array2_index9) , f_PntrArrRef_Float_Type1_i(float_array2_str,float_array2_index9))));
    printf("%llu\n",(reinterpret_cast < unsigned long long  >  (int_array_index_str)));
  }
  float *float_index;
  struct Float_Type1 float_index_str;
  ((float_index_str.UnsignedInt_Type0::ptr = float_index , float_index_str.addr = (reinterpret_cast < unsigned long long  >  ((&float_index)))) , ((Assign(&float_index_str,Float_Type1_Add_Float_Type1_i(float_array2_str,48)) , float_index = float_index_str.UnsignedInt_Type0::ptr)));
  ( *Deref(float_index_str))++;
  unsigned long float_array2_index10 = 48;
  printf("random location:%f\n",((bounds_check(float_array2_str.addr,float_array2_index10) , f_PntrArrRef_Float_Type1_i(float_array2_str,float_array2_index10))));
  int stack_var = 5;
  int *stack_ptr;
  struct Int_Type6 stack_ptr_str;
