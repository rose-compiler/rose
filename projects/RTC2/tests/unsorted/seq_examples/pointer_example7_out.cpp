...
struct UnsignedInt_Type0 fn1(struct UnsignedInt_Type0 input_str)
{
  ...
  (create_entry((reinterpret_cast < unsigned long long  >  ((&input_recr))),input_str.addr) , ((input_str.ptr = input_recr , input_str.addr = (reinterpret_cast < unsigned long long  >  ((&input_recr))))));
...
{
  char *input4_recr;
  (create_entry((reinterpret_cast < unsigned long long  >  ((&input4_recr))),input4_str.addr) , ((input4_str.ptr = input4_recr , input4_str.addr = (reinterpret_cast < unsigned long long  >  ((&input4_recr))))));
  double *input3_recr;
  (create_entry((reinterpret_cast < unsigned long long  >  ((&input3_recr))),input3_str.addr) , ((input3_str.ptr = input3_recr , input3_str.addr = (reinterpret_cast < unsigned long long  >  ((&input3_recr))))));
  float *input2_recr;
  (create_entry((reinterpret_cast < unsigned long long  >  ((&input2_recr))),input2_str.addr) , ((input2_str.ptr = input2_recr , input2_str.addr = (reinterpret_cast < unsigned long long  >  ((&input2_recr))))));
  unsigned int *input_recr;
  (create_entry((reinterpret_cast < unsigned long long  >  ((&input_recr))),input_str.addr) , ((input_str.ptr = input_recr , input_str.addr = (reinterpret_cast < unsigned long long  >  ((&input_recr))))));
...
int main()
{
   ...
   *Deref(ptr2_str) = 9U;
    #endif
  for (unsigned int *new_ptr, struct UnsignedInt_Type0 new_ptr_str, ((new_ptr_str.UnsignedInt_Type0::ptr = new_ptr , new_ptr_str.addr = (reinterpret_cast < unsigned long long  >  ((&new_ptr)))) , ((Assign(&new_ptr_str,start_ptr_str) , new_ptr = new_ptr_str.UnsignedInt_Type0::ptr))); b_LessThan_UnsignedInt_Type0_UnsignedInt_Type0(new_ptr_str,UnsignedInt_Type0_Add_UnsignedInt_Type0_i(start_ptr_str,100)); ((UnsignedInt_Type0_Increment_UnsignedInt_Type0(&new_ptr_str) , new_ptr = new_ptr_str.UnsignedInt_Type0::ptr) , new_ptr_str)) {
  ...
  do {
    ...
    for (unsigned int *forptr2, struct UnsignedInt_Type0 forptr2_str, ((forptr2_str.UnsignedInt_Type0::ptr = forptr2 , forptr2_str.addr = (reinterpret_cast < unsigned long long  >  ((&forptr2)))) , ((Assign(&forptr2_str,UnsignedInt_Type0_Cast_Void_Type4(malloc_overload(400UL))) , forptr2 = forptr2_str.UnsignedInt_Type0::ptr))), *doptr2, struct UnsignedInt_Type0 doptr2_str, ((doptr2_str.UnsignedInt_Type0::ptr = doptr2 , doptr2_str.addr = (reinterpret_cast < unsigned long long  >  ((&doptr2)))) , ((Assign(&doptr2_str,forptr2_str) , doptr2 = doptr2_str.UnsignedInt_Type0::ptr))); b_LessThan_UnsignedInt_Type0_UnsignedInt_Type0(doptr2_str,UnsignedInt_Type0_Add_UnsignedInt_Type0_i(forptr2_str,100)); ((UnsignedInt_Type0_Increment_UnsignedInt_Type0(&doptr2_str) , doptr2 = doptr2_str.UnsignedInt_Type0::ptr) , doptr2_str)) {
    }
