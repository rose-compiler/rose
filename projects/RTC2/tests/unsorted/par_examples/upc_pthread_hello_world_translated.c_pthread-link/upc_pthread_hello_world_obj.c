...
/*******************************************************
 * C file translated from WHIRL Tue Jun  5 11:46:29 2012
 *******************************************************/
...
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338921989_GASNetConfig_gen, 
 "$GASNetConfig: (/var/folders/kd/kdVECwdpHSeKwaqanpfDlU++Zak/-Tmp-//upcc-vanka1-92237-1338921988/upc_pthread_hello_world.trans.c) RELEASE=1.18.2,SPEC=1.8,CONDUIT=SMP(SMP-1.9/SMP-1.1),THREADMODEL=PAR,SEGMENT=FAST,PTR=32bit,align,nopshm,nodebug,notrace,nostats,nodebugmalloc,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338921989_UPCRConfig_gen,
 "$UPCRConfig: (/var/folders/kd/kdVECwdpHSeKwaqanpfDlU++Zak/-Tmp-//upcc-vanka1-92237-1338921988/upc_pthread_hello_world.trans.c) VERSION=2.14.2,PLATFORMENV=shared,SHMEM=pthreads,SHAREDPTRREP=packed/p22:t10:a32,TRANS=berkeleyupc,nodebug,nogasp,notv,dynamicthreads $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338921989_translatetime, 
 "$UPCTranslateTime: (upc_pthread_hello_world.o) Tue Jun  5 11:46:29 2012 $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338921989_GASNetConfig_obj, 
