...
/*******************************************************
 * C file translated from WHIRL Tue Jun  5 10:15:42 2012
 *******************************************************/
...
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_GASNetConfig_gen, 
 "$GASNetConfig: (/var/folders/kd/kdVECwdpHSeKwaqanpfDlU++Zak/-Tmp-//upcc-vanka1-91818-1338916542/upc_pthread_hello_world.trans.c) RELEASE=1.18.2,SPEC=1.8,CONDUIT=SMP(SMP-1.9/SMP-1.1),THREADMODEL=PAR,SEGMENT=FAST,PTR=32bit,align,nopshm,nodebug,notrace,nostats,nodebugmalloc,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_UPCRConfig_gen,
 "$UPCRConfig: (/var/folders/kd/kdVECwdpHSeKwaqanpfDlU++Zak/-Tmp-//upcc-vanka1-91818-1338916542/upc_pthread_hello_world.trans.c) VERSION=2.14.2,PLATFORMENV=shared,SHMEM=pthreads,SHAREDPTRREP=packed/p22:t10:a32,TRANS=berkeleyupc,nodebug,nogasp,notv,dynamicthreads $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_translatetime, 
 "$UPCTranslateTime: (upc_pthread_hello_world.o) Tue Jun  5 10:15:42 2012 $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_GASNetConfig_obj, 
 "$GASNetConfig: (upc_pthread_hello_world.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_UPCRConfig_obj,
 "$UPCRConfig: (upc_pthread_hello_world.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_translator, 
...
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_upcver, 
 "$UPCVersion: (upc_pthread_hello_world.o) 2.14.2 $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_compileline, 
 "$UPCCompileLine: (upc_pthread_hello_world.o) /Users/vanka1/research/compilers/bupc/berkeley_upc-2.14.2/opt/bin/upcc.pl -pthreads upc_pthread_hello_world.upc $");
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_backendcompiler, 
 "$UPCRBackendCompiler: (upc_pthread_hello_world.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_configuremismatch, 
   "$UPCRConfigureMismatch: (upc_pthread_hello_world.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_configuredcompiler, 
   "$UPCRConfigureCompiler: (upc_pthread_hello_world.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_buildcompiler, 
   "$UPCRBuildCompiler: (upc_pthread_hello_world.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_upc_pthread_hello_world_o_1338916542_transver_2,
