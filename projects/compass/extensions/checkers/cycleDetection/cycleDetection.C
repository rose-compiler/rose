...
static void run(Compass::Parameters params, Compass::OutputObject* output) {
  ...
  //  CompassAnalyses::CycleDetection::Traversal(params, output).init(graph);
  //dfanalysis->traverseGraph(rootNodes, &CompassAnalyses::CycleDetection::Traversal(params, output), interprocedural);
