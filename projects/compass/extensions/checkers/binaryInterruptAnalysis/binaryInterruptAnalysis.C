...
// Binary Interrupt Analysis Analysis
// Author: Thomas Panas
// Date: 18-August-2008
...
{ 
  namespace BinaryInterruptAnalysis
  { 
    /*! \brief Binary Interrupt Analysis: Add your description here 
     */
...
CheckerOutput::CheckerOutput ( SgNode* node )
  : OutputViolationBase(node,::binaryInterruptAnalysisChecker->checkerName,::binaryInterruptAnalysisChecker->shortDescription)
{}

CompassAnalyses::BinaryInterruptAnalysis::Traversal::
Traversal(Compass::Parameters inputParameters, Compass::OutputObject* output)
  : output(output)
{
  // Initalize checker specific parameters here, for example: 
  // YourParameter = Compass::parseInteger(inputParameters["BinaryInterruptAnalysis.YourParameter"]);
...
static void run(Compass::Parameters params, Compass::OutputObject* output) {
  ...
  CompassAnalyses::BinaryInterruptAnalysis::Traversal checker(params, output);
...
std::string
CompassAnalyses::BinaryInterruptAnalysis::Traversal::getIntCallName(uint64_t rax,
                                                         DataTypes& data_ebx,
                                                         DataTypes& data_ecx,
                                                         DataTypes& data_edx,
...
std::string
CompassAnalyses::BinaryInterruptAnalysis::Traversal::getIntCallName_Linux32bit(uint64_t rax,
                                                                    DataTypes& data_ebx,
                                                                    DataTypes& data_ecx,
                                                                    DataTypes& data_edx,
                                                                    vector<uint64_t>& val_rbx, 
...
std::string
CompassAnalyses::BinaryInterruptAnalysis::Traversal::getIntCallName_Linux64bit(uint64_t rax,
                                                                    DataTypes& data_ebx,
                                                                    DataTypes& data_ecx,
                                                                    DataTypes& data_edx,
                                                                    vector<uint64_t>& val_rbx, 
