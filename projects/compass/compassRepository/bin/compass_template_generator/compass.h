       ...
       public:
        //! Emit one error message
         ...
         // virtual SgNode* getNode() const = 0;
            const std::vector<OutputViolationBase*> & getOutputList() { return outputList; }
     ...
     class TraversalBase
        {
          ...
          public:
           ...
           /// Compute the initial inherited attribute passed to traversals using attributes (ignored by others).
               virtual void *initialInheritedAttribute() const {return 0;} //fix. 9/6/2007
