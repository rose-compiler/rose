...
public:
    ...
    virtual bool operator()(bool enabled, const Args &args) {
        ...
        if (enabled && args.insn->get_address()==trigger_addr) {
            ...
            BinaryAnalysis::YicesSolver smt_solver;
            smt_solver.set_linkage(BinaryAnalysis::YicesSolver::LM_EXECUTABLE);
            ...
            if (!arg1.is_known()) {
                using namespace BinaryAnalysis::InsnSemanticsExpr;
                ...
                if (BinaryAnalysis::SMTSolver::SAT_YES==smt_solver.satisfiable(expr)) {
