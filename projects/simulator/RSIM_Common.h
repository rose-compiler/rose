...
void print_user_desc_32(RTS_Message *f, const uint8_t *_ud, size_t sz);
void print_int_32(RTS_Message *f, const uint8_t *ptr, size_t sz);
void print_rlimit(RTS_Message *f, const uint8_t *ptr, size_t sz);
void print_kernel_stat_32(RTS_Message *f, const uint8_t *_sb, size_t sz);
void print_timespec_32(RTS_Message *f, const uint8_t *_ts, size_t sz);
void print_timeval_32(RTS_Message *f, const uint8_t *_tv, size_t sz);
void print_sigaction_32(RTS_Message *f, const uint8_t *_sa, size_t sz);
void print_dentries_helper(RTS_Message *f, const uint8_t *_sa, size_t sz, size_t wordsize);
...
void print_statfs_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_statfs64_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_robust_list_head_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_ipc64_perm_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_msqid64_ds_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_ipc_kludge_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_shmid64_ds_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_shm_info_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_shminfo64_32(RTS_Message *f, const uint8_t *_v, size_t sz);
void print_pt_regs_32(RTS_Message *f, const uint8_t *_v, size_t sz);
