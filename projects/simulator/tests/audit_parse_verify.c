 ...
 */
rec_part *
translate_syscall (struct audit_record *src)
{
  rec_part *rec = NULL;
...
rec_part *
translate_path (struct audit_record * src, int arg)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_user (struct audit_record * src)
{
  rec_part *rec = NULL;
  ...
  strncpy (rec->data.user.terminal, src->login_data.terminal,
           LOGIN_TERM_SIZE);
  strncpy (rec->data.user.msg, src->login_data.msg, AUIDMSG_SIZE);
  strncpy (rec->data.user.user, src->login_data.user, LOGIN_USER_SIZE);
  strncpy (rec->data.user.addr, src->login_data.address, LOGIN_ADDRESS_SIZE);
  ...
  if (src->login_data.result == LOGIN_SUCCESS)
    ...
    strncpy (rec->data.user.result, "failed", LOGIN_RESULT_SIZE);
 ...
 */
rec_part *
translate_config (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_chauthtok (struct audit_record * src)
{
  rec_part *rec = NULL;
  ...
  if (src->login_data.res == LOGIN_SUCCESS)
    ...
    strncpy (rec->data.chauthtok.res, "failed", LOGIN_RESULT_SIZE);
  else
 ...
 */
rec_part *
translate_load_pol (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_rbac (struct audit_record * src)
{
  rec_part *rec = NULL;
  ...
  if (src->res == SUCCESS_YES)
    ...
    strncpy (rec->data.rbac.res, "failed", LOGIN_RESULT_SIZE);
  else
 ...
 */
rec_part *
translate_dev_usys (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_avc (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_mac (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_role_change (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_cipso (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_ipsec (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
rec_part *
translate_cups (struct audit_record * src)
{
  rec_part *rec = NULL;
 ...
 */
main_list *
translate_for_parser (struct audit_record * src)
{
  rec_part *rec = NULL;
  rec_part *head = NULL;
  main_list *list = NULL;
  ...
  if (src->audit_type == TYPE_USER_ACCT
      ...
      || src->audit_type == TYPE_USER || src->audit_type == TYPE_USER_LOGIN)
    {
  ...
  if ((src->audit_type == TYPE_MAC) || src->audit_type == TYPE_MAC_CONFIG)
    {
 ...
 */
int
check_syscall (rec_part * expected_rec, rec_part * actual_rec, int sys_flag)
{
 ...
 */
int
check_path (rec_part * expected_rec, rec_part * actual_rec, int path_flag)
{
 ...
 */
int
check_user (rec_part * expected_rec, rec_part * actual_rec, int user_flag)
{
  ...
  if (expected_rec->data.user.host[0] != '\0')
    {
      user_flag = user_flag &
        !(strcmp (expected_rec->data.user.host, actual_rec->data.user.host));
    }
 ...
 */
int
check_config (rec_part * expected_rec, rec_part * actual_rec, int config_flag)
{
 ...
 */
int
check_chauthtok (rec_part * expected_rec, rec_part * actual_rec,
                 int chauth_flag)
{
 ...
 */
int
check_load_pol (rec_part * expected_rec, rec_part * actual_rec, int pol_flag)
{
 ...
 */
int
check_dev_usys (rec_part * expected_rec, rec_part * actual_rec, int dev_flag)
{
 ...
 */
int
check_rbac (rec_part * expected_rec, rec_part * actual_rec, int rbac_flag)
{
  ...
  if (expected_rec->data.rbac.res[0] != '\0')
    {
      rbac_flag = rbac_flag &
        !(strcmp (expected_rec->data.rbac.res, actual_rec->data.rbac.res));
    }
 ...
 */
int
check_avc (rec_part * expected_rec, rec_part * actual_rec, int avc_flag)
{
 ...
 */
int
check_mac (rec_part * expected_rec, rec_part * actual_rec, int mac_flag)
{
 ...
 */
int
check_role_change (rec_part * expected_rec, rec_part * actual_rec,
                   int role_chng_flag)
{
  if (expected_rec->data.role_chng.pid != VAL_NOT_SET)
    {
      role_chng_flag = role_chng_flag &
        (expected_rec->data.role_chng.pid == actual_rec->data.role_chng.pid);
    }
  ...
  if (expected_rec->data.role_chng.uid != VAL_NOT_SET)
    {
      role_chng_flag = role_chng_flag &
        (expected_rec->data.role_chng.uid == actual_rec->data.role_chng.uid);
    }
 ...
 */
int
check_cipso (rec_part * expected_rec, rec_part * actual_rec, int cipso_flag)
{
 ...
 */
int
check_ipsec (rec_part * expected_rec, rec_part * actual_rec, int ipsec_flag)
{
 ...
 */
int
check_cups (rec_part * expected_rec, rec_part * actual_rec, int cups_flag)
{
 ...
 */
int
compare_rec (main_list * actual, main_list * expected)
{
          ...
          if (strcmp (expected_rec->type, "SYSCALL") == 0)
                   ...
                   || (strcmp (expected_rec->type, "USYS_CONFIG") == 0))
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  chauth_flag =
                    check_chauthtok (expected_rec, actual_rec, chauth_flag);
          ...
          else if (strcmp (expected_rec->type, "MAC_POLICY_LOAD") == 0)
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  pol_flag =
                    check_load_pol (expected_rec, actual_rec, pol_flag);
                   ...
                   || (strcmp (expected_rec->type, "AUDIT_USYS_CONFIG") == 0))
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  dev_flag =
                    check_dev_usys (expected_rec, actual_rec, dev_flag);
          ...
          else if (strcmp (expected_rec->type, "ANOM_RBAC_FAIL") == 0)
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  rbac_flag =
                    check_rbac (expected_rec, actual_rec, rbac_flag);
          ...
          else if (strcmp (expected_rec->type, "USER_ROLE_CHANGE") == 0)
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  role_chng_flag =
                    check_role_change (expected_rec, actual_rec,
                                       role_chng_flag);
                   ...
                   || (strcmp (expected_rec->type, "MAC_UNLBL_ALLOW") == 0))
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  cipso_flag =
                    check_cipso (expected_rec, actual_rec, cipso_flag);
                   ...
                   || (strcmp (expected_rec->type, "MAC_IPSEC_ADDSPD") == 0))
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  ipsec_flag =
                    check_ipsec (expected_rec, actual_rec, ipsec_flag);
                   ...
                   || (strcmp (expected_rec->type, "LABEL_OVERRIDE") == 0))
            {
              ...
              if (strcmp (actual_rec->type, expected_rec->type) == 0)
                {
                  cups_flag =
                    check_cups (expected_rec, actual_rec, cups_flag);
...
parse_syscall (char *type)
{
  ...
  token = strtok (NULL, delim);
  if (token[0] == 's')
    {                           /* we have success and exit fields */
  ...
  if (token[2] == 'd' && token[3] == 'i')
  ...
  else if (token[2] == 'i' && token[3] == 'd')
    {
      ...
      while ((token = strtok (NULL, delim)) != NULL)
        {
          if (token[0] == 'r' && token[1] == 'e' && token[3] == 's')
            {
      ...
      while ((token = strtok (NULL, delim)) != NULL)
        {
          ...
          if (token[0] == 'a' && token[1] == 'c' && token[3] == 't')
            {
 ...
 */
void
parse_msg (rec_part ** rec, char *tmp_buff)
{
  char *token;
      ...
      while ((token = strtok (NULL, delim)) != NULL)
        {
          ...
          if (token[0] == 'a' && token[1] == 'c'
              && token[2] == 'c' && token[4] == '=')
            {
              strcpy ((*rec)->data.chauthtok.acct, extract_value (token));
              break;
            }
          else if (token[0] == 'i' && token[1] == 'd' && token[2] == '=')
            {
              (*rec)->data.chauthtok.id = atol (extract_value (token));
              break;
            }
          strncat ((*rec)->data.chauthtok.op, " ", LOGIN_OP_SIZE);
          strncat ((*rec)->data.chauthtok.op, token, LOGIN_OP_SIZE);
        }
    }
  else
    {
 ...
 */
void
parse_role_msg (rec_part ** rec, char *tmp_buff)
{
  char *token;
  ...
  if (token[0] == 'o' && token[1] == 'p' && token[2] == '=')
      ...
      while ((token = strtok (NULL, delim)) != NULL)
        {
          ...
          if (token[0] == 'a' && token[1] == 'c'
              && token[2] == 'c' && token[4] == '=')
            {
              strcpy ((*rec)->data.role_chng.acct, extract_value (token));
              break;
            }
          strncat ((*rec)->data.role_chng.op, " ", LOGIN_OP_SIZE);
          strncat ((*rec)->data.role_chng.op, token, LOGIN_OP_SIZE);
        }
      token = strtok (NULL, delim);
  ...
  else
    {
      ...
      if (token[0] == 'd' && token[1] == 'e' && token[2] == 'f'
          && token[3] == 'a')
        {
          strcpy ((*rec)->data.role_chng.def_cntx, extract_value (token));

          token = strtok (NULL, delim);
          strcpy ((*rec)->data.role_chng.sel_cntx, extract_value (token));
               ...
               && token[3] == '-' && token[4] == 'c')
        {
          ...
          strcpy ((*rec)->data.role_chng.old_cntx, extract_value (token));

          token = strtok (NULL, delim);
          strcpy ((*rec)->data.role_chng.new_cntx, extract_value (token));
        }
      else
        {
 ...
 */
rec_part *
parse_user_labeled_export (char *type)
{
  rec_part *rec = NULL;
  char *token;
  if ((rec = (rec_part *) malloc (sizeof (rec_part))) == NULL)
 ...
 */
rec_part *
parse_label_override (char *type)
{
  rec_part *rec = NULL;
  char *token;
  if ((rec = (rec_part *) malloc (sizeof (rec_part))) == NULL)
 ...
 */
main_list *
parse_audit_log (time_t start, time_t end, int *no_record)
{
  char buf[BUFF_SIZE];
 ...
 */
int
parse_for_record (struct audit_record *src)
{
  int rc = -1;
