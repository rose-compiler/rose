/*
 * Kamal Sharma sharma9@llnl.gov Aug 10, 2011
 * Modified the original code to integrate with other
 ...
 */
{
	...
	*size = length-k; // return back the size
 ...
 * t - no. of bits that can be corrected
 */
int initBCH(int degree, int noErrorBits)
{
	cout << " Degree : " << degree << " noErrBits: " << noErrorBits << endl;
	m = degree;
	t = noErrorBits;
