...
unsigned int calculateIntCheckBits(int value)
{
...
void applySECDED(void *memLoc, string type, unsigned int retrievedCheckBits, bool retrievedParity ,unsigned int calCheckBits, bool calParity)
{
	...
	{
		/* 2 bit error */
		cerr << " 2-bit Error Detected. Correction not possible. " << endl;
		exit(0);
	}
	else
	{
