...
--     package ACU renames Lal.Compilation_Units;
--
--     -----------------------------------------------------------------------------
--     -- Unit_ID support
--
...
--     begin
--        return Lal.Set_Get.Get_Unit_Id (Unit);
--     end Get_Unit_ID;
--
--     function To_Unit_ID
...
--     begin
--        return a_nodes_h.Unit_ID (Lal.Set_Get.Get_Unit_Id (Unit));
--     end Get_Unit_ID;
--
--     function To_String
...
--       (This           : in out class;
--        Units_In       : in     Lal.Compilation_Unit_List;
...
--       (This           : in out class;
--        Elements_In    : in     Lal.Element_List;
--        Dot_Label_Name : in     String;
...
--       (This            : in out Class;
--        Lal_Unit       : in Lal.Compilation_Unit;
--        Include_Pragmas : in Boolean := True)
--     is
--        Context_Clauses : constant Lal.Element_List :=
--          Lal.Elements.Context_Clause_Elements
--            (Compilation_Unit => Lal_Unit,
...
--        Lal_Unit       : in Lal.Compilation_Unit)
--     is
--        Compilation_Pragmas : constant Lal.Element_List :=
--          Lal.Elements.Compilation_Pragmas (Lal_Unit);
--     begin
...
--        Include_Pragmas    : in     Boolean := True)
--     is
--        Top_Element_Lal  : Lal.Element := Lal.Elements.Unit_Declaration (Lal_Unit);
--     begin
--        if Do_Context_Clauses then
--           Process_Context_Clauses (This, Lal_Unit, Include_Pragmas);
--        end if;
--        Process_Element_Tree (This, Top_Element_Lal);
--        -- TODO: later
--        -- Process_Compilation_Pragmas (This, Lal_Unit);
--     end Process_Element_Trees;
--
--
--     function To_Wide_String (this : in Lal.Unit_Classes) return Wide_String is
--     begin
--        case this is
--           when Lal.A_Public_Declaration |
--                Lal.A_Private_Declaration =>
--              return "spec";
--           when Lal.A_Public_Body              |
--                Lal.A_Public_Declaration_And_Body |
--                Lal.A_Private_Body =>
--              return "body";
--           when Lal.A_Separate_Body =>
--              return "subunit";
--           when others =>
--              return Lal.Unit_Classes'Wide_Image(this);
--        end case;
--     end To_Wide_String;
--
--
...
--
--        Unit_Class     : constant Lal.Unit_Classes := ACU.Unit_Class (Unit);
--        Unit_Full_Name : constant Wide_String       := Acu.Unit_Full_Name (Unit);
--        Unit_Kind      : constant Lal.Unit_Kinds   := ACU.Unit_Kind (Unit);
--
...
--           Add_Element_List
--             (This           => This,
--              Elements_In    => Lal.Elements.Compilation_Pragmas (Unit),
...
--           Add_Element_List
--             (This           => This,
--              Elements_In    => Lal.Elements.Context_Clause_Elements (Unit),
...
--  --           Container : constant Lal.Ada_Environments.Containers.Container :=
...
--          Context : constant Lal.Context := ACU.Enclosing_Context (Unit);
--        begin
--           null; -- TODO: Finish if needed:
...
--           Value : Boolean := Lal.Set_Get.Is_Standard (Unit);
--        begin
...
--           Lal_Element : constant Lal.Element :=
--             Lal.Elements.Unit_Declaration (Unit);
--           anhS_Element_ID : constant a_nodes_h.Element_ID :=
--             Element.Get_Element_ID (Lal_Element);
--        begin
...
--        end;
--
--        use all type Lal.Unit_Kinds;
--     begin -- Process_Unit
--        If Unit_Kind /= Not_A_Unit then
--           Start_Output;
--        end if;
--
--        -- Not common items, in Lal order:
--        case Unit_Kind is
--           when Not_A_Unit =>
