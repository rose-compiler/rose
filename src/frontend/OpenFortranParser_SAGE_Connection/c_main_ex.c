...
#define JNI_VERSION_1_1 1
  ...
  void runOFP(int argc, char **argv);
  ...
  void runOFP(int argc, char **argv)
  {
	 ...
	 ofp_class = NULL;
	 ofp_class = (*env)->FindClass(env, "parser/java/FortranMain");
	 if(ofp_class == NULL)
	 ...
	 type = getJavaString(env, "parser.java.FortranParserActionNull");
