...
class RoseBin_Graph {
 ...
 public:
  ...
  typedef __gnu_cxx::hash_multimap < SgDirectedGraphNode*, SgDirectedGraphEdge*> edgeType;
  edgeType edges;
  edgeType edgesR;

  typedef __gnu_cxx::hash_multimap < SgDirectedGraphNode*, SgDirectedGraphEdge*> edgeTypeUnique;
