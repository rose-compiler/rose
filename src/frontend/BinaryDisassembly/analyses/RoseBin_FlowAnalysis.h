...
class RoseBin_FlowAnalysis : public AstSimpleProcessing {
 protected:
  ...
  typedef __gnu_cxx::hash_map< uint64_t, SgDirectedGraphNode*> tabletype_inv;
  ...
  __gnu_cxx::hash_map <std::string, SgAsmInstruction*> local_visited;
  ...
  // vector of graphs
  __gnu_cxx::hash_map <std::string, SgDirectedGraph*> graphs;
