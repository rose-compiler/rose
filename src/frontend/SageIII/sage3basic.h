...
// If you mark a function or variable as deprecated, then BE SURE TO FIX PLACES WHERE IT IS USED IN ROSE!!!
#if defined(__GNUC__)
#   define ROSE_DEPRECATED __attribute__((deprecated))
#elif defined(_MSC_VER)
#   define ROSE_DEPRECATED /*deprecated*/
#else
#   define ROSE_DEPRECATED /*deprecated*/
#endif
