...
public:
  UnparseSageVisitor(llvm::raw_ostream &out, int indentationAmount,
      ...
      : out_{out}, indentationAmount_{indentationAmount}, encoding_{encoding},
        ...
        preStatement_{preStatement}, asFortran_{nullptr}, cooked_{cooked} {}
...
void Unparse(llvm::raw_ostream &out, /*const*/ A &root, Encoding encoding,
  ...
  UnparseSageVisitor visitor{out, 1, encoding, capitalizeKeywords, backslashEscapes,
      preStatement, asFortran};
  Walk(root, visitor);
  visitor.Done();
}
template void Unparse<Program>(llvm::raw_ostream &, Program &, Encoding,
    bool, bool, preStatementType *, parser::AllCookedSources *);
template void Unparse<Expr>(llvm::raw_ostream &, Expr &, Encoding, bool,
    bool, preStatementType *, parser::AllCookedSources *);

#else
template <typename A>
void Unparse(llvm::raw_ostream &out, A &root, Encoding encoding,
             bool capitalizeKeywords, bool backslashEscapes, parser::AllCookedSources* cooked,
...
template void Unparse<Program>(llvm::raw_ostream &, Program &, Encoding,
    bool, bool, parser::AllCookedSources *, preStatementType *);
template void Unparse<Expr>(llvm::raw_ostream &, Expr &, Encoding,
    bool, bool, parser::AllCookedSources *, preStatementType *);
