...
public:
  ExternalVisitor(std::ostream &out, int indentationAmount, Encoding encoding,
...
void ExternalVisitor::PutNormalized(const std::string &str) {
...
void Build(std::ostream &out, const parser::Program &program, Encoding encoding,
    bool capitalizeKeywords, bool backslashEscapes,
    preStatementType *preStatement, TypedExprAsFortran *expr) {
  ExternalVisitor visitor{out, 1, encoding, capitalizeKeywords, backslashEscapes,
      preStatement, expr};
