 ...
 *  instructions; architecture-specific components are in subclasses such as AssemblerAarch64, AssemblerPowerpc, and
 *  AssemblerX86.
 *
 ...
 *  Disassembler::BasePtr d = Disassembler::lookup(interp);
