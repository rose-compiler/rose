 ...
 *
 * Most instructions modify the instruction pointer to advancing it to the fall-through address (the instruction at the
 * following memory address), in which this function returns false. This function returns true if @c this instruction can
 * cause the instruction pointer to point somewhere other than the following instruction. */
...
SgAsmArm64Instruction::description() const {
    ...
    switch (get_kind()) {
        ...
        // case Kind::ARM64_INS_BFI: bitfield insert (alias of BFM)
        ...
        // case Kind::ARM64_INS_CINC: conditional increment (alias of CSINC)
        // case Kind::ARM64_INS_CINV: conditonal invert (alias of CSINV)
        ...
        // case Kind::ARM64_INS_CMN: compare negative (alias of ADDS)
        // case Kind::ARM64_INS_CMP: compare (alias of SUBS)
        // case Kind::ARM64_INS_CMPP: compare with tag (ARMv8.5)
        case Kind::ARM64_INS_CMTST:             return "cmpare bitwise test";
        // case Kind::ARM64_INS_CNEG: conditional negate (alias of CSNEG)
        ...
        // case Kind::ARM64_INS_CSET: conditional set (alias of CSINC)
        // case Kind::ARM64_INS_CSETM: conditional set mask (alias of CSINV)
        ...
        // case Kind::ARM64_INS_DC: data cache (alias of SYS)
        ...
        // case Kind::ARM64_INS_IC: instruction cache operation (alias of SYS)
        ...
        // case Kind::ARM64_INS_MNEG: multiply-negate (alias of MSUB)
        ...
        // case Kind::ARM64_INS_MVN: bitwise NOT (alias of NOT)
        case Kind::ARM64_INS_MVNI:              return "move inverted immediate";
        case Kind::ARM64_INS_NEG:               return "negate";
        // case Kind::ARM64_INS_NEGS: negate, setting flags
        // case Kind::ARM64_INS_NGC: negate with carry (alias of SBC)
        // case Kind::ARM64_INS_NGCS: negate with carry, setting flags (alias of SBCS)
        // case Kind::ARM64_INS_NOP: no operation
        ...
        // case Kind::ARM64_INS_SBFIZ: signed bitfield insert in zeros (alias of SBFM)
        case Kind::ARM64_INS_SBFM:              return "signed bitfield move";
        // case Kind::ARM64_INS_SBFX: signed bitfield extract (alias of SBFM)
        ...
        // case Kind::ARM64_INS_SEV: send event
        // case Kind::ARM64_INS_SEVL: send event local
        ...
        // case Kind::ARM64_INS_SMNEGL: signed multiply-negate long (alias of SMSUBL)
        ...
        // case Kind::ARM64_INS_SXTB: signed extend byte (alias of SBFM)
        // case Kind::ARM64_INS_SXTH: signed extend halfword (alias of SBFM)
        ...
        // case Kind::ARM64_INS_SXTW: sign extend word (alias of SBFM)
        ...
        // case Kind::ARM64_INS_TLBI: TLB invalidate operation (alias of SYS)
        ...
        // case Kind::ARM64_INS_TST: test bits (alias of ANDS)
        ...
        // case Kind::ARM64_INS_UBFIZ: unsigned bitfield insert in zeros (alias of UBFM)
        ...
        // case Kind::ARM64_INS_UMNEGL: unsigned multiply-negate (alias of UMSUBL)
        ...
        // case Kind::ARM64_INS_UXTB: unsigned extend byte (alias of UBFM)
        // case Kind::ARM64_INS_UXTH: unsigned extend halfword (alias of UBFM)
        ...
        // case Kind::ARM64_INS_WFE: wait for event
        // case Kind::ARM64_INS_WFI: wait for interrupt
        ...
        // case Kind::ARM64_INS_YIELD: no succinct description
