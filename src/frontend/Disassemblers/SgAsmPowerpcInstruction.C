...
SgAsmPowerpcInstruction::description() const {
    switch (get_kind()) {
        ...
        case powerpc_bc:                        return "branch conditional";
        case powerpc_bca:                       return "branch conditional";
        case powerpc_bcl:                       return "branch conditional";
        case powerpc_bcla:                      return "branch conditional";
        case powerpc_bcctr:                     return "branch conditional to count register";
        case powerpc_bcctrl:                    return "branch conditional to count register";
        case powerpc_bclr:                      return "branch conditional link register";
        case powerpc_bclrl:                     return "branch conditional link register";
        case powerpc_cmp:                       return "compare";
        case powerpc_cmpi:                      return "compare immediate";
        case powerpc_cmpl:                      return "compare logical";
        case powerpc_cmpli:                     return "compare logical immediate";
