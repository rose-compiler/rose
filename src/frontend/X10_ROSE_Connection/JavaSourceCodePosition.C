...
JavaSourceCodePosition::JavaSourceCodePosition(int line_start, int line_end, int col_start, int col_end) : line_number_start(line_start),
                                                                                                           line_number_end(line_end),
...
int JavaSourceCodePosition::getLineStart() {
    return line_number_start;
}

int JavaSourceCodePosition::getLineEnd() {
    return line_number_end;
}

int JavaSourceCodePosition::getColStart() {
    return column_number_start;
}

int JavaSourceCodePosition::getColEnd() {
