...
JNIEXPORT void JNICALL Java_JavaParser_cactionCompilationUnitList (JNIEnv *env, jclass, jint, jobjectArray) {
    ...
    astJavaScopeStack.push_front(globalScope); // Push the global scope onto the stack.
...
// REMOVE THIS !
// if(! isSgGlobal(astJavaScopeStack.front())) {
// cout << "The bottom Scope Stack element is a " << astJavaScopeStack.front() -> class_name()
//      << endl;
// cout.flush();
// }
...
// REMOVE  THIS!!!
// cout << "Pre-Processing constructor header for " << name << " ... pushing void result type " << endl;
// cout.flush();
...
// REMOVE  THIS!!!
////    outputJavaState("At TOP of cactionConstructorDeclarationHeader");
    ...
    SgClassDefinition* classDefinition = isSgClassDefinition(astJavaScopeStack.front());
// REMOVE  THIS!!!
// if (classDefinition == NULL) { // we must be inside a class scope
// cout << "Expected ClassDefinition but found " << astJavaScopeStack.front() -> class_name()
//      << endl;
// cout.flush();
// }
    ...
    //
// REMOVE  THIS!!!
// cout << "Invoking (1) buildDefiningMemberFunction for function " << name
//      << endl;
// cout.flush();
...
// REMOVE  THIS!!!
////    outputJavaState("At BOTTOM of cactionConstructorDeclarationHeader");
}
...
// REMOVE  THIS!!!
// cerr << "The Scope Environment for this constructor is "
//      << astJavaScopeStack.front() -> class_name()
//      << endl;
// cerr.flush();
...
JNIEXPORT void JNICALL Java_JavaParser_cactionMethodDeclarationHeader(JNIEnv *env, jclass,
                                                                      ...
                                                                      jobject jToken) {
// REMOVE  THIS!!!
////    outputJavaState("At TOP of cactionMethodDeclarationHeader");
    ...
    //
// REMOVE  THIS!!!
// cout << "Invoking (2) buildDefiningMemberFunction for function " << name
//      << endl;
// cout.flush();
    SgMemberFunctionDeclaration *functionDeclaration = buildDefiningMemberFunction(name, classDefinition, numberOfArguments);
...
// REMOVE  THIS!!!
////    outputJavaState("At BOTTOM of cactionMethodDeclarationHeader");
}
...
////    outputJavaState("At TOP of cactionMethodDeclarationEnd");
    ...
    astJavaScopeStack.pop_front(); // pop the body block
...
// REMOVE  THIS!!!
// if (type == NULL) {
// cout << "Could not find type " << type_name << endl;
// cout.flush();
// }
...
// REMOVE  THIS!!!
// cout << "Pushed type " << type_name << endl;
// cout.flush();
    astJavaComponentStack.push(type);

// REMOVE  THIS!!!
////     outputJavaState("At BOTTOM of cactionTypeReference");
}
...
// REMOVE  THIS!!!
// cout << "About to process Argument declaration for "
//      << argument_name << endl;
// cout.flush();
    if (is_catch_argument) {
// REMOVE  THIS!!!
// cout << "It is a Catch Argument "
//      << endl;
// cout.flush();
...
// REMOVE  THIS!!!
////     outputJavaState("At BOTTOM of cactionArgument()");
}
...
// REMOVE  THIS!!!
// cout << "About to pop info for Argument declaration of "
//      << argument_name << endl;
// cout.flush();
    SgType *argument_type = astJavaComponentStack.popType();
    ROSE_ASSERT(argument_type);
// REMOVE  THIS!!!
// cout << "Popped type \"" <<  argument_type -> class_name() << "\" for Argument declaration: "
//      << argument_name << endl;
// cout.flush();
    ...
    if (is_catch_argument) {
// REMOVE  THIS!!!
// cout << "Completing  catch argument " << argument_name << " in scope " << astJavaScopeStack.front() -> class_name()
//      << endl;
// cout.flush();
        SgCatchOptionStmt *catch_option_stmt = isSgCatchOptionStmt(astJavaScopeStack.front());
...
// REMOVE  THIS!!!
////    outputJavaState("At BOTTOM of cactionArgumentEnd()");
}
...
// REMOVE  THIS!!!
//        type_name = type_name.getString().substr(0, type_name.getString().size() - (number_of_dimensions * 2)); // remove [] suffixes , if any!
//        type_name = processNameOfRawType(type_name);
        type = lookupTypeFromQualifiedName(type_name);
// REMOVE  THIS!!!
// if (type == NULL) {
// cout << "***Could not locate type " << type_name << endl;
// cout.flush();
// }
        ROSE_ASSERT(type != NULL);
    }
...
// REMOVE  THIS!!!
////    outputJavaState("At BOTTOM of cactionArrayTypeReference");
}
...
// REMOVE  THIS!!!
// cout << "At MessageSend start of " << name << endl;
// cout.flush();
  ...
  // ROSE_ASSERT(functionSymbol != NULL);
    if (functionSymbol == NULL) {
        astJavaComponentStack.push(SgTypeVoid::createType()); // push a dummy void return type for the function below.
// REMOVE  THIS!!!
// cout << "Invoking (3) buildDefiningMemberFunction for function " << name
//      << endl;
// cout.flush();
...
JNIEXPORT void JNICALL Java_JavaParser_cactionMessageSendEnd(JNIEnv *env, jclass, jint numTypeArguments, jint numArguments, jobject jToken) {
...
// REMOVE  THIS!!!
// cout << "At MessageSend end with " << numArguments << " arguments." << endl;
// cout.flush();
...
// REMOVE  THIS!!!
// cout << "Argument " << i << " is "
//      << astJavaComponentStack.top() -> class_name()
//      << endl;
// cout.flush();
        arguments.push_front(astJavaComponentStack.popExpression());
    }
...
// REMOVE  THIS!!!
// cout << "I was here and the predecessor is "
//      << astJavaComponentStack.top() -> class_name()
//      << endl;
// cout.flush();
    }
...
// REMOVE  THIS!!!
// cout << "Invoking buildNonDefiningMemberFunction for function " << name
//      << endl;
// cout.flush();
...
////     outputJavaState("At TOP of cactionGenerateType");
     ...
     SgName name = convertJavaStringToCxxString(env,java_string);
// REMOVE  THIS!!!
// cout << "About to generate type " << name << endl;
// cout.flush();
...
// REMOVE  THIS!!!
//    outputJavaS//tate("At BOTTOM of cactionAssertStatement");
}
