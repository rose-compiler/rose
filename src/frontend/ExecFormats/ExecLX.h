...
#ifndef Exec_ExecLX_h
#define Exec_ExecLX_h

#include "ExecDOS.h"
#include "ExecPE.h" /* for Exec::PE::ExtendedDOSHeader */
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ExtendedDOSHeader -- extra components of the DOS header when used in an LX file
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/* The extended DOS header for LX is the same as for PE */
typedef PE::ExtendedDOSHeader ExtendedDOSHeader;

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LX File Header
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/* File format of an LX File Header. */
struct LXFileHeader_disk {
    unsigned char e_magic[2];           /* 0x00 magic number "LX" */
    unsigned char e_byte_order;         /* 0x02 byte order (0=>little endian; 1=>big endian) */
    unsigned char e_word_order;         /* 0x03 word order (0=>little endian; 1=>big endian) */
    uint32_t    e_format_level;         /* 0x04 LX file format version number */
    uint16_t    e_cpu_type;             /* 0x08 1=>80286, 2=>80386, 3=>80486 */
    ...
    uint32_t    e_page_offset_shift;    /* 0x2c used by page table's page offset field */
...
class LXFileHeader : public ExecHeader {
  public:
    LXFileHeader(ExecFile *f, addr_t offset)
        : ExecHeader(f, offset, sizeof(LXFileHeader_disk)),
        dos2_header(NULL)
        {ctor(f, offset);}
    ...
    unsigned e_eip_section, e_esp_section, e_page_offset_shift, e_fixup_sect_cksum, e_loader_sect_cksum, e_secttab_nentries;
    unsigned e_rsrctab_nentries, e_fmtdirtab_nentries, e_import_modtab_nentries, e_preload_npages, e_nonresnametab_size;
    unsigned e_nonresnametab_cksum, e_auto_ds_section, e_debug_info_size, e_num_instance_preload, e_num_instance_demand;
    unsigned e_heap_size;
  ...
  private:
    ...
    void *encode(ByteOrder sex, LXFileHeader_disk*);
