...
*/
       // DQ (3/5/2006): Copies from ROSE class (deprecated in there previous location)
          //! Get name.suffix from /path/name.suffix
           ...
           //! Get the file name suffix (extension) without the leading dot, fileName could be either base name or name with full path. If no dot is found in the input fileName, the function just return the original fileName
