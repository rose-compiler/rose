...
/*!
\defgroup ROSEHPCT_XERCESC  ROSE-HPCT XML processing based on Xerces-C
\ingroup ROSEHPCT
...
specifically uses the Xerces-C library to parse the XML.

See also, \ref ROSEHPCT_LIBXML2.

$Id: xml.hh,v 1.1 2008/01/08 02:56:43 dquinlan Exp $
*/

/*!
 *  file rosehpct/xml-xercesc/xml.hh
...
#if !defined(INC_XML_XML_HH)
//! rosehpct/xml-xercesc/xml.hh included
#define INC_XML_XML_HH
 ...
 *  around the Xerces C++ library.
 */
namespace XMLUtil
{
  //! \addtogroup ROSEHPCT_XERCESC
  //@{

  //! Use Xerces-C namespace.
  ...
  //! Value class representing an XML elemtn attribute
  struct XMLAttr
  {
  ...
  struct XMLElem
  {
    ...
    XMLElem (const std::string& n, const AttributeList& attr);
