...
FortranCodeGeneration_locatedNode::unparseProcessControlStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
     ...
     switch (kind)
        {
          case SgProcessControlStatement::control_enum::e_stop:
             {
                curprint("STOP ");
          ...
          case SgProcessControlStatement::control_enum::e_error_stop:
             {
                curprint("ERROR STOP ");
                unparseExpression(ctrl_stmt->get_code(), info);
                // F2018 syntax
          ...
          case SgProcessControlStatement::control_enum::e_pause:
             {
                curprint("PAUSE ");
                unparseExpression(ctrl_stmt->get_code(), info);
                break;
