...
MatlabUnparserBottomUpTraversal::evaluateSynthesizedAttribute(SgNode *node, SynthesizedAttributesList childAttributes)
{
  switch(node->variantT())
  {
    ...
    case V_SgIntVal:
      return handleIntVal(node, childAttributes);
      break;
...
MatlabUnparserBottomUpTraversal::handleIntVal(SgNode *node, SynthesizedAttributesList childAttributes)
{
  ...
  double value = isSgIntVal(node)->get_value();
  ss << value;
...
std::string
MatlabUnparserBottomUpTraversal::handleRangeExp(SgNode *node, SynthesizedAttributesList childAttributes)
{
...
std::string
MatlabUnparserBottomUpTraversal::handleMatrixTransposeOp(SgNode *node, SynthesizedAttributesList childAttributes)
{
...
std::string
MatlabUnparserBottomUpTraversal::handleReturnStmt(SgNode *node, SynthesizedAttributesList childAttributes)
{
...
std::string
MatlabUnparserBottomUpTraversal::handleFunctionDeclaration(SgNode *node, SynthesizedAttributesList childAttributes)
{
...
std::string
MatlabUnparserBottomUpTraversal::handleIfStmt(SgNode *node, SynthesizedAttributesList childAttributes)
{
...
std::string
MatlabUnparserBottomUpTraversal::handleSourceFile(SgNode *node, SynthesizedAttributesList childAttributes)
{
  ...
  std::string             sourceFileName = sourceFilePath.stem().string();
