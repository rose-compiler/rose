...
//
void 
Unparse_X10::unparseX10File(SgSourceFile *sourcefile, SgUnparse_Info& info) {
    if (sourcefile -> attributeExists("error")) {
// TODO: Remove this !
/*
cout << "*** @ Don't unparseX10File " << sourcefile -> getFileName()
<< endl;
cout.flush();
*/
...
//-----------------------------------------------------------------------------------
void 
Unparse_X10::unparseOneElemConInit(SgConstructorInitializer* con_init, SgUnparse_Info& info)
   {
     ASSERT_not_null(con_init);
  /* code inserted from specification */

#if OUTPUT_DEBUGGING_FUNCTION_BOUNDARIES
     printf ("\n\nInside of Unparse_X10::unparseOneElemConInit (%p) \n",con_init);
     curprint( "\n /* Inside of Unparse_X10::unparseOneElemConInit */ \n");
#endif

#if OUTPUT_DEBUGGING_FUNCTION_BOUNDARIES
     printf ("Leaving of Unparse_X10::unparseOneElemConInit \n\n\n");
     curprint( "\n /* Leaving of Unparse_X10::unparseOneElemConInit */ \n");
#endif
   }

void
Unparse_X10::unparseLanguageSpecificStatement(SgStatement* stmt, SgUnparse_Info& info)
   {
...
//               printf("Unparse_X10::unparseLanguageSpecificStatement: Error: No handler for %s (variant: %d)\n",stmt->sage_class_name(), stmt->variantT());
                             // if (stmt->sage_class_name() == "SgFinishStmt") {
                                if (stmt->class_name() == "SgFinishStmt") {
//                                      cout << "SgFinishStmt found" << endl;
                             ...
                             // else if (stmt->sage_class_name() == "SgAsyncStmt") {
                                else if (stmt->class_name() == "SgAsyncStmt") {
                             ...
                             // else if (stmt->sage_class_name() == "SgAtStmt") {
                                else if (stmt->class_name() == "SgAtStmt") {
...
/*
void
Unparse_X10::unparseGlobalStmt (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseNestedStatement(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::curprint_indented(const string str, SgUnparse_Info& info) const {
    unp->cur.insert_newline(0, 4 * info.get_nestingLevel());
    curprint(str);
}

void
Unparse_X10::unparseImportDeclarationStatement (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseName(SgName name, SgUnparse_Info& info)
   {
        curprint(name.getString());
   }

void
Unparse_X10::unparseNamespaceDeclarationStatement (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseNamespaceDefinitionStatement ( SgStatement* stmt, SgUnparse_Info & info )
   {
     ASSERT_not_null(stmt);
...
void
Unparse_X10::unparseNamespaceAliasDeclarationStatement (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseUsingDirectiveStatement (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseUsingDeclarationStatement (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void 
Unparse_X10::unparseTemplateInstantiationDirectiveStmt (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseTemplateInstantiationDeclStmt (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseTemplateInstantiationFunctionDeclStmt (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseTemplateInstantiationMemberFunctionDeclStmt (SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseCaseOrDefaultBasicBlockStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
     SgBasicBlock* basic_stmt = isSgBasicBlock(stmt);
     ASSERT_not_null(basic_stmt);
...
void Unparse_X10::unparseSynchronizedStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void Unparse_X10::unparseThrowStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseInitializedName(SgInitializedName* init_name, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseForInitStmt (SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseForStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseExceptionSpecification(const SgTypePtrList& exceptionSpecifierList, SgUnparse_Info& info)
   {
#if 0
...
void
Unparse_X10::unparseFuncDeclStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
     ROSE_ASSERT(!"Unexpected function declaration. All x10 functions should be SgMemberFunctions");
   }


// NOTE: Bug in Sage: No file information provided for FuncDeclStmt. 
void
Unparse_X10::unparseFuncDefnStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseFunctionParameterList(SgStatement* stmt, SgUnparse_Info& info)
{
...
string
Unparse_X10::trimGlobalScopeQualifier ( string qualifiedName )
   {
...
void
Unparse_X10::unparseVarDefnStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::initializeDeclarationsFromParent ( 
...
void
Unparse_X10::unparseX10PackageStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseClassDeclStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseClassDefnStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseEnumDeclStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseExprStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void Unparse_X10::unparseLabelStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseWhileStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseDoWhileStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseSwitchStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseCaseStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseTryStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseCatchStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseDefaultStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseBreakStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseContinueStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseReturnStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseAssertStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseGotoStmt(SgStatement* stmt, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseTypeDefStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
...
void
Unparse_X10::unparseTemplateDeclStmt(SgStatement* stmt, SgUnparse_Info& info)
   {
   }

void
Unparse_X10::unparseDeclarationModifier(SgDeclarationModifier& mod, SgUnparse_Info& info) {
       if (mod.isJavaAbstract()) curprint("abstract ");
...
#if 0
void
Unparse_X10::unparseDeclarationModifier2(SgDeclarationModifier& mod, SgUnparse_Info& info) {
       if (mod.isJavaAbstract()) curprint("abstract ");
       if (mod.isFinal()) curprint("val ");
       else curprint("var ");
       unparseAccessModifier(mod.get_accessModifier(), info);
...
void
Unparse_X10::unparseAccessModifier(SgAccessModifier& mod, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseStorageModifier(SgStorageModifier& mod, SgUnparse_Info& info) {
    if (mod.isStatic()) curprint("static ");
}

void
Unparse_X10::unparseConstVolatileModifier(SgConstVolatileModifier& mod, SgUnparse_Info& info) {
    if (mod.isVolatile()) curprint("volatile ");
    if (mod.isJavaTransient()) curprint("transient ");
}

void
Unparse_X10::unparseTypeModifier(SgTypeModifier& mod, SgUnparse_Info& info) {
    unparseConstVolatileModifier(mod.get_constVolatileModifier(), info);
}

void
Unparse_X10::unparseFunctionModifier(SgFunctionModifier& mod, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseBaseClass(SgBaseClass* base, SgUnparse_Info& info) {
...
void
Unparse_X10::unparseParameterType(SgType *bound_type, SgUnparse_Info& info) {
    ...
    if (class_type)
         unparseClassType(class_type, info);
    else unparseX10ParameterizedType(parameterized_type, info);
}


void
Unparse_X10::unparseEnumBody(SgClassDefinition *class_definition, SgUnparse_Info& info) {
    curprint(" {");
    unp->cur.insert_newline();
