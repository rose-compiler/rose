...
{
    m_pixmapMap.insert(0x01, ((const char **) var));
    m_pixmapMap.insert(0x05, ((const char **) var));
    m_pixmapMap.insert(0x200,((const char **) var));
    m_pixmapMap.insert(0x400, ((const char **) var));
