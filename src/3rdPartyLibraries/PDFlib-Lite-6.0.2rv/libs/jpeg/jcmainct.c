 ...
 *
 * This file contains the jmain buffer controller for compression.
 * The jmain buffer lies between the pre-processor and the JPEG
...
{
  my_main_ptr jmain = (my_main_ptr) cinfo->jmain;
...
jinit_c_main_controller (j_compress_ptr cinfo, boolean need_full_buffer)
{
  ...
  cinfo->jmain = (struct jpeg_c_main_controller *) jmain;
