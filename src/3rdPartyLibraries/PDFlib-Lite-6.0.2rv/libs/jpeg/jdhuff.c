 ...
 *
 * The savable_dstate subrecord contains fields that change within an MCU,
...
typedef struct {
  ...
  savable_dstate saved;		/* Other state at start of MCU */
...
/* PDFlib GmbH: add hook for OJPEG kludge in libtiff */
