...
/* $Id: p_truetype.c,v 1.1 2005/10/11 17:18:15 vuduc2 Exp $
 *
...
pdf_set_tt_fontvalues(PDF *p, tt_file *ttf, pdc_font *font)
{
    ...
    if (ttf->tab_OS_2) {
        ...
        w               = ttf->tab_OS_2->usWeightClass / 65.0;
	    ...
	    /* guess */
            font->xHeight       = (int) (0.66 * font->ascender);
        }
...
#define PDF_MACSTYLE_BOLD     0x01
        ...
        font->xHeight   = (int) (0.66 * font->descender);
