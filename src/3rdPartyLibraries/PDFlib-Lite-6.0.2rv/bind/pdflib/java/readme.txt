Using the Java binding with PDFlib Lite
=======================================

PDFlib Lite does not support "unicode" encoding; therefore you must
change the encoding entry in the hello.java sample to "winansi".
