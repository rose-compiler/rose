...
#warning "This should be using the BUILD_LIST_ACCESS_FUNCTIONS"
  ...
  // Rasmussen, 5/07/2024: initialized to true to be consistent with SgFile::initialization()
     File.setDataPrototype         ( "bool", "openmp_parse_only", "= true",
                                     NO_CONSTRUCTOR_PARAMETER, BUILD_FLAG_ACCESS_FUNCTIONS, NO_TRAVERSAL, NO_DELETE);
  ...
  // immediately before the unparsing of each file.
