...
#define DEBUG_NEW_DELETE_IN_MEMORY_POOL 0
     ...
     includeHeaderString += "#define ROSE_ALLOC_MEMSET 2\n";
     includeHeaderString += "#define ROSE_ALLOC_TRACE 1\n";
     includeHeaderString += "#include \"memory-pool-snapshot.h\"\n\n";
#else
     includeHeaderString += "#define ROSE_ALLOC_MEMSET 1\n";
     includeHeaderString += "#define ROSE_ALLOC_TRACE 0\n";
#endif
     includeHeaderString += "#define ROSE_ALLOC_MEMSET_OFFSET 1\n"; // prevents erasing the vtable pointer when ROSE_ALLOC_MEMSET is set
     includeHeaderString += "#define ROSE_ALLOC_AUTH_ALT_SIZE 1\n";
     includeHeaderString += "#define ROSE_DEALLOC_ASSERT 1\n\n";
