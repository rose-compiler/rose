...
//     /data1/ROSE_CompileTree/git-LINUX-64bit-10.3.0-EDG65-BOOST_1_75-master-binary-CMake-dwarf-rc/bin/rosebud --no-locations
//         --backend=sawyer '--serializer=boost,cereal' --sawyer-generated=./src/generated/Rose/Sarif
