...
template <>
void Driver<Sage>::loadSymbols<SgDeclarationStatement>(unsigned long file_id, SgSourceFile * file) {
...
unsigned long Driver<Sage>::createStandaloneSourceFile(const std::string & name, const std::string & path, std::string suffix) {
...
unsigned long Driver<Sage>::loadStandaloneSourceFile(const std::string & name, const std::string & path, std::string suffix) {
  std::string filename;
  ...
  unsigned long id = addStandaloneSourceFile(file);
