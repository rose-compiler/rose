...
bool
SMTSolver::satisfiable(const std::vector<boost::shared_ptr<const InsnSemanticsExpr::TreeNode> > &exprs)
{
    bool retval = false;
...
bool
SMTSolver::satisfiable(const boost::shared_ptr<const InsnSemanticsExpr::TreeNode> &tn)
{
