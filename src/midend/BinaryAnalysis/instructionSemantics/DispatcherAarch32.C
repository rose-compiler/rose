...
DispatcherAarch32::initializeInsnDispatchTable() {
    iproc_set(ARM_INS_ADC,      new Aarch32::IP_adc);
    iproc_set(ARM_INS_ADD,      new Aarch32::IP_add);
    iproc_set(ARM_INS_AND,      new Aarch32::IP_and);
    iproc_set(ARM_INS_B,        new Aarch32::IP_b);
    iproc_set(ARM_INS_BFC,      new Aarch32::IP_bfc);
    iproc_set(ARM_INS_BFI,      new Aarch32::IP_bfi);
    iproc_set(ARM_INS_BIC,      new Aarch32::IP_bic);
    iproc_set(ARM_INS_BL,       new Aarch32::IP_bl);
    iproc_set(ARM_INS_BLX,      new Aarch32::IP_blx);
    iproc_set(ARM_INS_BX,       new Aarch32::IP_bx);
    iproc_set(ARM_INS_CLZ,      new Aarch32::IP_clz);
    iproc_set(ARM_INS_CMN,      new Aarch32::IP_cmn);
    iproc_set(ARM_INS_CMP,      new Aarch32::IP_cmp);
    iproc_set(ARM_INS_CPS,      new Aarch32::IP_cps);
    iproc_set(ARM_INS_EOR,      new Aarch32::IP_eor);
    iproc_set(ARM_INS_HVC,      new Aarch32::IP_hvc);
    iproc_set(ARM_INS_LDC,      new Aarch32::IP_ldc);
    iproc_set(ARM_INS_LDM,      new Aarch32::IP_ldm);
    iproc_set(ARM_INS_LDMDA,    new Aarch32::IP_ldmda);
    iproc_set(ARM_INS_LDMDB,    new Aarch32::IP_ldmdb);
    iproc_set(ARM_INS_LDMIB,    new Aarch32::IP_ldmib);
    iproc_set(ARM_INS_LDR,      new Aarch32::IP_ldr);
    iproc_set(ARM_INS_LDRB,     new Aarch32::IP_ldrb);
    iproc_set(ARM_INS_LDRBT,    new Aarch32::IP_ldrbt);
    iproc_set(ARM_INS_LDRD,     new Aarch32::IP_ldrd);
    iproc_set(ARM_INS_LDRH,     new Aarch32::IP_ldrh);
    iproc_set(ARM_INS_LDRHT,    new Aarch32::IP_ldrht);
    iproc_set(ARM_INS_LDRSB,    new Aarch32::IP_ldrsb);
    iproc_set(ARM_INS_LDRSBT,   new Aarch32::IP_ldrsbt);
    iproc_set(ARM_INS_LDRSH,    new Aarch32::IP_ldrsh);
    iproc_set(ARM_INS_LDRSHT,   new Aarch32::IP_ldrsht);
    iproc_set(ARM_INS_LDRT,     new Aarch32::IP_ldrt);
    iproc_set(ARM_INS_MCR,      new Aarch32::IP_mcr);
    iproc_set(ARM_INS_MCRR,     new Aarch32::IP_mcrr);
    iproc_set(ARM_INS_MLA,      new Aarch32::IP_mla);
    iproc_set(ARM_INS_MLS,      new Aarch32::IP_mls);
    iproc_set(ARM_INS_MOV,      new Aarch32::IP_mov);
    iproc_set(ARM_INS_MOVT,     new Aarch32::IP_movt);
    iproc_set(ARM_INS_MRC,      new Aarch32::IP_mrc);
    iproc_set(ARM_INS_MRS,      new Aarch32::IP_mrs);
    iproc_set(ARM_INS_MSR,      new Aarch32::IP_msr);
    iproc_set(ARM_INS_MUL,      new Aarch32::IP_mul);
    iproc_set(ARM_INS_MVN,      new Aarch32::IP_mvn);
    iproc_set(ARM_INS_ORR,      new Aarch32::IP_orr);
    iproc_set(ARM_INS_PKHBT,    new Aarch32::IP_pkhbt);
    iproc_set(ARM_INS_PKHTB,    new Aarch32::IP_pkhtb);
    iproc_set(ARM_INS_PLD,      new Aarch32::IP_pld);
    iproc_set(ARM_INS_POP,      new Aarch32::IP_pop);
    iproc_set(ARM_INS_PUSH,     new Aarch32::IP_push);
    iproc_set(ARM_INS_QADD,     new Aarch32::IP_qadd);
    iproc_set(ARM_INS_QADD16,   new Aarch32::IP_qadd16);
    iproc_set(ARM_INS_QADD8,    new Aarch32::IP_qadd8);
    iproc_set(ARM_INS_QASX,     new Aarch32::IP_qasx);
    iproc_set(ARM_INS_QDADD,    new Aarch32::IP_qdadd);
    iproc_set(ARM_INS_QDSUB,    new Aarch32::IP_qdsub);
    iproc_set(ARM_INS_QSAX,     new Aarch32::IP_qsax);
    iproc_set(ARM_INS_QSUB,     new Aarch32::IP_qsub);
    iproc_set(ARM_INS_QSUB16,   new Aarch32::IP_qsub16);
    iproc_set(ARM_INS_QSUB8,    new Aarch32::IP_qsub8);
    iproc_set(ARM_INS_RFEDA,    new Aarch32::IP_rfeda);
    iproc_set(ARM_INS_RFEDB,    new Aarch32::IP_rfedb);
    iproc_set(ARM_INS_RFEIA,    new Aarch32::IP_rfeia);
    iproc_set(ARM_INS_RFEIB,    new Aarch32::IP_rfeib);
    iproc_set(ARM_INS_RSB,      new Aarch32::IP_rsb);
    iproc_set(ARM_INS_RSC,      new Aarch32::IP_rsc);
    iproc_set(ARM_INS_SADD16,   new Aarch32::IP_sadd16);
    iproc_set(ARM_INS_SADD8,    new Aarch32::IP_sadd8);
    iproc_set(ARM_INS_SASX,     new Aarch32::IP_sasx);
    iproc_set(ARM_INS_SBC,      new Aarch32::IP_sbc);
    iproc_set(ARM_INS_SBFX,     new Aarch32::IP_sbfx);
    iproc_set(ARM_INS_SEL,      new Aarch32::IP_sel);
    iproc_set(ARM_INS_SHADD16,  new Aarch32::IP_shadd16);
    iproc_set(ARM_INS_SHADD8,   new Aarch32::IP_shadd8);
    iproc_set(ARM_INS_SHASX,    new Aarch32::IP_shasx);
    iproc_set(ARM_INS_SHSAX,    new Aarch32::IP_shsax);
    iproc_set(ARM_INS_SHSUB16,  new Aarch32::IP_shsub16);
    iproc_set(ARM_INS_SHSUB8,   new Aarch32::IP_shsub8);
    iproc_set(ARM_INS_SMLABB,   new Aarch32::IP_smlabb);
    iproc_set(ARM_INS_SMLABT,   new Aarch32::IP_smlabt);
    iproc_set(ARM_INS_SMLAD,    new Aarch32::IP_smlad);
    iproc_set(ARM_INS_SMLADX,   new Aarch32::IP_smladx);
    iproc_set(ARM_INS_SMLAL,    new Aarch32::IP_smlal);
    iproc_set(ARM_INS_SMLALBB,  new Aarch32::IP_smlalbb);
    iproc_set(ARM_INS_SMLALBT,  new Aarch32::IP_smlalbt);
    iproc_set(ARM_INS_SMLALD,   new Aarch32::IP_smlald);
    iproc_set(ARM_INS_SMLALDX,  new Aarch32::IP_smlaldx);
    iproc_set(ARM_INS_SMLALTB,  new Aarch32::IP_smlaltb);
    iproc_set(ARM_INS_SMLALTT,  new Aarch32::IP_smlaltt);
    iproc_set(ARM_INS_SMLATB,   new Aarch32::IP_smlatb);
    iproc_set(ARM_INS_SMLATT,   new Aarch32::IP_smlatt);
    iproc_set(ARM_INS_SMLAWB,   new Aarch32::IP_smlawb);
    iproc_set(ARM_INS_SMLAWT,   new Aarch32::IP_smlawt);
    iproc_set(ARM_INS_SMLSD,    new Aarch32::IP_smlsd);
    iproc_set(ARM_INS_SMLSDX,   new Aarch32::IP_smlsdx);
    iproc_set(ARM_INS_SMMLA,    new Aarch32::IP_smmla);
    iproc_set(ARM_INS_SMMLAR,   new Aarch32::IP_smmlar);
    iproc_set(ARM_INS_SMMLS,    new Aarch32::IP_smmls);
    iproc_set(ARM_INS_SMMLSR,   new Aarch32::IP_smmlsr);
    iproc_set(ARM_INS_SMULBB,   new Aarch32::IP_smulbb);
    iproc_set(ARM_INS_SMULBT,   new Aarch32::IP_smulbt);
    iproc_set(ARM_INS_SMULL,    new Aarch32::IP_smull);
    iproc_set(ARM_INS_SMULTB,   new Aarch32::IP_smultb);
    iproc_set(ARM_INS_SMULTT,   new Aarch32::IP_smultt);
    iproc_set(ARM_INS_SMULWB,   new Aarch32::IP_smulwb);
    iproc_set(ARM_INS_SMULWT,   new Aarch32::IP_smulwt);
    iproc_set(ARM_INS_SSAT,     new Aarch32::IP_ssat);
    iproc_set(ARM_INS_SSAX,     new Aarch32::IP_ssax);
    iproc_set(ARM_INS_SSUB16,   new Aarch32::IP_ssub16);
    iproc_set(ARM_INS_SSUB8,    new Aarch32::IP_ssub8);
    iproc_set(ARM_INS_STC,      new Aarch32::IP_stc);
    iproc_set(ARM_INS_STM,      new Aarch32::IP_stm);
    iproc_set(ARM_INS_STMDA,    new Aarch32::IP_stmda);
    iproc_set(ARM_INS_STMDB,    new Aarch32::IP_stmdb);
    iproc_set(ARM_INS_STMIB,    new Aarch32::IP_stmib);
    iproc_set(ARM_INS_STR,      new Aarch32::IP_str);
    iproc_set(ARM_INS_STRB,     new Aarch32::IP_strb);
    iproc_set(ARM_INS_STRBT,    new Aarch32::IP_strbt);
    iproc_set(ARM_INS_STRD,     new Aarch32::IP_strd);
    iproc_set(ARM_INS_STRH,     new Aarch32::IP_strh);
    iproc_set(ARM_INS_STRHT,    new Aarch32::IP_strht);
    iproc_set(ARM_INS_STRT,     new Aarch32::IP_strt);
    iproc_set(ARM_INS_SUB,      new Aarch32::IP_sub);
    iproc_set(ARM_INS_SVC,      new Aarch32::IP_svc);
    iproc_set(ARM_INS_SXTAB,    new Aarch32::IP_sxtab);
    iproc_set(ARM_INS_SXTAB16,  new Aarch32::IP_sxtab16);
    iproc_set(ARM_INS_SXTAH,    new Aarch32::IP_sxtah);
    iproc_set(ARM_INS_TEQ,      new Aarch32::IP_teq);
    iproc_set(ARM_INS_TST,      new Aarch32::IP_tst);
    iproc_set(ARM_INS_UADD16,   new Aarch32::IP_uadd16);
    iproc_set(ARM_INS_UADD8,    new Aarch32::IP_uadd8);
    iproc_set(ARM_INS_UASX,     new Aarch32::IP_uasx);
    iproc_set(ARM_INS_UBFX,     new Aarch32::IP_ubfx);
    iproc_set(ARM_INS_UDF,      new Aarch32::IP_udf);
    iproc_set(ARM_INS_UHADD16,  new Aarch32::IP_uhadd16);
    iproc_set(ARM_INS_UHADD8,   new Aarch32::IP_uhadd8);
    iproc_set(ARM_INS_UHASX,    new Aarch32::IP_uhasx);
    iproc_set(ARM_INS_UHSAX,    new Aarch32::IP_uhsax);
    iproc_set(ARM_INS_UHSUB16,  new Aarch32::IP_uhsub16);
    iproc_set(ARM_INS_UMAAL,    new Aarch32::IP_umaal);
    iproc_set(ARM_INS_UMLAL,    new Aarch32::IP_umlal);
    iproc_set(ARM_INS_UMULL,    new Aarch32::IP_umull);
    iproc_set(ARM_INS_UQASX,    new Aarch32::IP_uqasx);
    iproc_set(ARM_INS_UQSAX,    new Aarch32::IP_uqsax);
    iproc_set(ARM_INS_UQSUB16,  new Aarch32::IP_uqsub16);
    iproc_set(ARM_INS_UQSUB8,   new Aarch32::IP_uqsub8);
    iproc_set(ARM_INS_USADA8,   new Aarch32::IP_usada8);
    iproc_set(ARM_INS_USAT,     new Aarch32::IP_usat);
    iproc_set(ARM_INS_USAX,     new Aarch32::IP_usax);
    iproc_set(ARM_INS_USUB16,   new Aarch32::IP_usub16);
    iproc_set(ARM_INS_USUB8,    new Aarch32::IP_usub8);
    iproc_set(ARM_INS_UXTAB16,  new Aarch32::IP_uxtab16);
}
