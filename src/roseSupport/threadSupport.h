...
public:
     ...
     *  prefix generator, then writing the phrase "<%s resumed> ".  If a name is not provided (i.e., the empty string) then the
     *  space which follows the name in these phrases will also be omitted.
     *
     ...
     *  name was supplied, or there was no previous multipart() invocation, then the phrase will be "<resume> ".
     *
     *  The @p fmt and following arguments are the same as for printf().
     *
     *  No output is produced and the lock is not acquired if the file pointer provided in the constructor is a null pointer.
