#ifndef ROSE_BinaryAnalysis_InstructionSemantics_BaseSemantics_Merger_H
#define ROSE_BinaryAnalysis_InstructionSemantics_BaseSemantics_Merger_H
...
public:
     ...
     *
     *  If set and the @c Rose::BinaryAnalysis::InstructionSemantics diagnostic stream is also enabled, then memory merge
