...
Mips32::instructionDescription(const SgAsmInstruction *insn_) const {
    ...
    switch (insn->get_kind()) {
        ...
        case mips_cfc1:                 return "move control word from fp";
        case mips_cfc2:                 return "move control word from coprocessor 2";
        ...
        case mips_ctc1:                 return "move control word to fp";
        case mips_ctc2:                 return "move control word to coprocessor 2";
        ...
        case mips_mfc0:                 return "move from coprocessor 0";
        case mips_mfc1:                 return "move word from fp";
        case mips_mfc2:                 return "move word from coprocessor 2";
        case mips_mfhc1:                return "move word from high half of fp register";
        case mips_mfhc2:                return "move word from high half of coprocessor 2";
        case mips_mfhi:                 return "move from hi register";
        case mips_mflo:                 return "move from lo register";
        case mips_mov_s:                return "fp move";
        case mips_mov_d:                return "fp move";
        case mips_mov_ps:               return "fp move";
        case mips_movf:                 return "move conditional on fp false";
        case mips_movf_s:               return "fp move conditional on fp false";
        case mips_movf_d:               return "fp move conditional on fp false";
        case mips_movf_ps:              return "fp move conditional on fp false";
        case mips_movn:                 return "move conditional on not zero";
        case mips_movn_s:               return "fp move conditional on not zero";
        case mips_movn_d:               return "fp move conditional on not zero";
        case mips_movn_ps:              return "fp move conditional on not zero";
        case mips_movt:                 return "move conditional on fp true";
        case mips_movt_s:               return "fp move conditional on fp true";
        case mips_movt_d:               return "fp move conditional on fp true";
        case mips_movt_ps:              return "fp move conditional on fp true";
        case mips_movz:                 return "move conditional on zero";
        case mips_movz_s:               return "fp move conditional on zero";
        case mips_movz_d:               return "fp move conditional on zero";
        case mips_movz_ps:              return "fp move conditional on zero";
        ...
        case mips_mtc0:                 return "move to coprocessor 0";
        case mips_mtc1:                 return "move word to fp";
        case mips_mtc2:                 return "move word to coprocessor 2";
        case mips_mthc1:                return "move word to high half of fp register";
        case mips_mthc2:                return "move word to high half of coprocessor 2";
        case mips_mthi:                 return "move to hi register";
        case mips_mtlo:                 return "move to lo register";
