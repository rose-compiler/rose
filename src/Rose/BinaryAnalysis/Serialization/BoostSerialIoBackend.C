...
// data member that's a smart pointer to type `P` then header file "T.h" only needs a forward delcaraton for `P`, but
...
//    +-------------------------------------------------------------------------------------------
//
// We'd rather do this in order to eliminate the `#include <P.h>` from "T.h":
//
//    +-------------------------------------------------------------------------------------------
//    |// T.h
//    |#include <Rose/BasicTypes.h>                     // forward decls for most common things
...
template <class S>
void
Definition::serialize(S& s, const unsigned /*version*/) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Serialization class versions must be at global scope
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
