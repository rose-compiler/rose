...
// Protected mode exceptions. These strange names come directly from the Intel documentation, section 3.1.1.11 in the Instruction
// Set Reference (except for x86_exception_int, which ROSE uses internally for the INT instruction.
enum X86Exception {
