...
SgAsmMipsInstruction *
Mips::makeInstruction(rose_addr_t insn_va, MipsInstructionKind kind, SgAsmExpression *op1, SgAsmExpression *op2,
                      SgAsmExpression *op3, SgAsmExpression *op4) const
{
