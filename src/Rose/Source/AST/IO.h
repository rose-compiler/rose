#ifndef ROSE_Source_AST_IO_H
#define ROSE_Source_AST_IO_H
#include <RoseFirst.h>
 ...
 * This function will leave the AST in an inconsistent state and Rose::Source::AST::merge must be run to fix it.
 */
 ...
 * It simply calls three functions in sequence: Rose::Source::AST::share, Rose::Source::AST::prune, and Rose::Source::AST::link.
