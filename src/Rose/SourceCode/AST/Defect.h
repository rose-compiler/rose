#ifndef ROSE_SourceCode_AST_Defect_H
#define ROSE_SourceCode_AST_Defect_H
...
/**
 * \brief Main interface for Rose::SourceCode::AST::Defects.
 *
...
#endif /* ROSE_SourceCode_AST_Defect_H */
