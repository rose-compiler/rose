#ifndef ROSE_SourceCode_AST_Checker_H
#define ROSE_SourceCode_AST_Checker_H
 ...
 *
 * Any defect found is saved in Rose::SourceCode::AST::Defect::all (aka Rose::SourceCode::AST::Defects::defect_t<Defects::Kind::any>::all).
 *
 */
...
#endif /* ROSE_SourceCode_AST_Checker_H */
