 ...
 * This function will leave the AST in an inconsistent state and Rose::AST::merge must be run to fix it.
 */
 ...
 * It simply calls three functions in sequence: Rose::AST::share, Rose::AST::prune, and Rose::AST::link.
