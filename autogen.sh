...
if [[ ! -e src/frontend/CxxFrontend/EDG/Makefile.am ]]; then
    for file in \
        ...
        src/frontend/CxxFrontend/EDG/EDG_6.2/Makefile.in \
        src/frontend/CxxFrontend/EDG/EDG_6.2/misc/Makefile.in \
        src/frontend/CxxFrontend/EDG/EDG_6.2/src/Makefile.in \
        src/frontend/CxxFrontend/EDG/EDG_6.2/src/disp/Makefile.in \
        src/frontend/CxxFrontend/EDG/EDG_6.2/lib/Makefile.in \
