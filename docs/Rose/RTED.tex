...
To run one specific test run:
  ...
  make run/tests/C/memoryleaks/assignment_scope_dowhile
...
Example for step 3:
  ...
  35 : -I../../../ROSE-git/src/util/stringSupport
  ...
  74 : -I../../../ROSE-git/src/3rdPartyLibraries/qrose/Components/QueryBox
