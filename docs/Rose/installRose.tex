...
\begin{itemize}
   \item Double Click on ``My_Computer'' icon
...
corner of the screen.
   ...
   \item Goto ``My Computer TUX270-0'', ``Local Disk(C:)'', ``putty_keys''
   \item Click on file ``id_rsa.ppk''  (this will load the private  key for 
use by ssh).
   \item Now try to run the git command:
         git clone ssh://hudson-rose@tux269/usr/casc/overture/ROSE/git/ROSE.git c:\ROSE\hudson\workspace\test-windows\label\windows-server
\end{itemize}
\end{itemize}
