     ...
     \begin{enumerate}
        ...
        \begin{enumerate}
          ...
          \item Persistent Attributes (persistantAttributes.C) \\
                Persistent attributes may be added the the AST for access to stored results
...
\fixme{Consider a section on ``Program Analysis'' with subsections.}
...
%    \item Calling something from Qing's work \\
%          \fixme{Ask Qing what she might like to show off here.}
...
\fixme{Comments at the top of each tutorial example should match the comments in the
       caption for the figures that introduce them in the text.}
