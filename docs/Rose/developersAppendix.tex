...
\begin{enumerate}
 ...
 % \item In {\em ROSE/configure.in} modify version number (X.Y.ZZL) at the top of the file.
   ...
   \item Run {\tt make} && {\tt make docs} && {\tt make check} && {\tt make dist} && 
         {\tt make distcheck} && {\tt make install} && {\tt make installcheck}, depending
         on how agressively you want your changes to be tests.
   \begin{itemize}
...
\commentout{ %--------------out dated information -------------
...
} % end of comment out, out dated information. ---------------
