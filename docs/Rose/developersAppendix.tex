...
\subsection{ROSE API Refactoring}

This is the design for the ROSE API which is
where high level function interfaces will be located that
call meshangism for analysis, transformation, and 
expected user level support for ROSE tools.
There are 4 levels:

\begin{enumerate}
   \item ROSE Frontend \\
      Generation of AST from source code.
   ...
   \begin{enumerate}
      ...
      \begin{enumerate}
         ...
         \item General Transforamtions

      \end{enumerate}
   \end{enumerate}

   \item ROSE AST Backend \\
      Code generation from the AST (unparsing).
