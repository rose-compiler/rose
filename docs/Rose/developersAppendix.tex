...
\fixme{How about Fortran loops?}
      ...
      /* Check if a for-loop has a canonical form, return loop index, 
       ...
       /*  Fuse two loops into one loop and return the fused loop */
       SgForStatement* loopFusion (SgForStatement* loop1, SgForStatement* loop2);
      
       /* Loop fission: break a loop into multiple loops */
       std::vector<std::SgForStatement*> loopFission (SgForStatement* src_loop);
