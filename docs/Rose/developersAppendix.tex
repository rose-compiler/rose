...
%and offline (can commit without active connection with the shared repository).
The developer can commit changes to the private repository without maintaining an active connect to 
...
%will submit the code so that it can be considered for
...
%We provide developers with a git repository where a repository
%where 
%the actual development is done on a develop copy of this repository and a developer
