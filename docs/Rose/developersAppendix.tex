...
make this information as clear and consistant as possible we have two
...
svn merge -r 402:428 https://outreach.scidac.gov/svn/rose/trunk
   ...
   \item If you mix a merge and a local contribution (via svn merge) (we don't suggest mixing them)\\
	    Here's an example specific to a commit on an SVN branch ({\em note first line}):
	    {\indent
	       \begin{verbatim}
svn merge -r 402:428
Adjusted test case for new binary function detection
