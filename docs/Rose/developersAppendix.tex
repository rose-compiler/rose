...
\begin{enumerate}
   ...
   \item Write test codes to test your code (these are assembled in the {\tt ROSE/tests}
         directory (or subdirectories of {\tt ROSE/tests/nonsmoke/functional/roseTests}).
...
\begin{enumerate}
   ...
   See Rose/BinaryAnalysis/Disassembler.h
\end{enumerate}
...
\end{lstlisting}
   ...
   \begin{enumerate}
      \item InstructionSemantics \\
      See doxygen documentation for the
      Rose::BinaryAnalysis::InstructionSemantics namespace.
      \item Library Identification (FLIRT) \\
...
\end{lstlisting}
   ...
   \begin{enumerate}
      ...
      \item {\bf std::string Rose::utility\_stripPathFromFileName ( const std::string \& fileNameWithPath );} \\
   ...
   See Rose/BinaryAnalysis/MemoryMap.h
...
The look for the names (e.g. "F77\_only") in "sage\_support.C" in ROSE/src/frontend/SageIII/sage\_support
...
function (located in sage\_support.C):
{
\indent
\begin{verbatim}
...
Also, don't forget to document your option in SgFile::usage() (also in sage\_support/cmdline.C).
