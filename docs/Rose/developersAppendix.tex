...
integration as soon as possible. When a developer submits a code for integration
it will be tested by our test suite and integrated into our master branch if
it passes all tests.

The testing of each developers work is done by a continuous integration server
...
We have an external git repository. To clone it, simply type:

\textit{git clone http://www.rosecompiler.org/rose.git/}

Depending on your network speed, the commandline above may take 3 to 5
