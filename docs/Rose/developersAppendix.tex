...
This is the design for the ROSE API which is where high level function interfaces will be
located that call meshangism for analysis, transformation, and expected user level support
for ROSE tools. There are four levels:
\begin{enumerate}
   \item ROSE Frontend \\
