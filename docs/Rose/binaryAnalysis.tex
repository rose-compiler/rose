...
instruction bytes from a supplied buffer.  An {\tt RvaFileMap} object is supplied in
...
An {\tt RvaFileMap} object can be built that describes the entire virtual address space
