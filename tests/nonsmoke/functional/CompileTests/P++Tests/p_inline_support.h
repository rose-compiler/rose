...
#ifndef _PPP_INLINE_SUPPORT_H
#define _PPP_INLINE_SUPPORT_H
...
#if 0
inline Array_Descriptor_Type* Array_Descriptor_Type::Build_Temporary_By_Example ( const Array_Descriptor_Type & X )
   {
   }
#endif
#endif
...
#endif  /* !defined(_PPP_INLINE_SUPPORT_H) */
