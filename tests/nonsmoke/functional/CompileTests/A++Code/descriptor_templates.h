...
// class Array_Descriptor_Type : Parallel_Access_Descriptor
#else
// for A++ we don't need the Parallel_Access_Descriptor
//class Array_Descriptor_Type
#endif
#endif
...
class Array_Descriptor_Type
  ...
  // friend class Partitioning_Type;
     ...
     private:
        static Array_Descriptor_Type *Current_Link;
        Array_Descriptor_Type        *freepointer;
     ...
     // Access functions for the serialArray object
        inline const SerialArray & getSerialArray () const
           { return *SerialArray; }
        inline SerialArray* getSerialArrayPointer () const
           { return SerialArray; }

        inline void setDataPointer ( SerialArray *inputPointer )
     ...
     // use of the restrict keyword (which is not a part of standard C++ or C -- yet)
        ...
        inline T* APP_RESTRICT_MACRO getArrayData () const
           { return Array_Data; }
        inline void setDataPointer ( T* APP_RESTRICT_MACRO inputPointer )
     ...
     // to allow it to be treated as a lower dimensional array object.
        ...
        T* APP_RESTRICT_MACRO Array_View_Pointer0;
#if MAX_ARRAY_DIMENSION>1
        T* APP_RESTRICT_MACRO Array_View_Pointer1;
#endif
#if MAX_ARRAY_DIMENSION>2
        T* APP_RESTRICT_MACRO Array_View_Pointer2;
#endif
#if MAX_ARRAY_DIMENSION>3
        T* APP_RESTRICT_MACRO Array_View_Pointer3;
#endif
#if MAX_ARRAY_DIMENSION>4
        T* APP_RESTRICT_MACRO Array_View_Pointer4;
#endif
#if MAX_ARRAY_DIMENSION>5
        T* APP_RESTRICT_MACRO Array_View_Pointer5;
#endif
#if MAX_ARRAY_DIMENSION>6
        T* APP_RESTRICT_MACRO Array_View_Pointer6;
#endif
#if MAX_ARRAY_DIMENSION>7
        T* APP_RESTRICT_MACRO Array_View_Pointer7;
#endif
     ...
     // T* ExpressionTemplateDataPointer;
        T* APP_RESTRICT_MACRO ExpressionTemplateDataPointer;
     ...
     // Access to pointer specific to expression template indexing
        inline T* APP_RESTRICT_MACRO getExpressionTemplateDataPointer () const 
...
// end of defined(USE_EXPRESSION_TEMPLATES)
        ...
        inline T* APP_RESTRICT_MACRO getDataPointer () const
           {
#if defined(PPP)
     ...
     // friend inline int  APP_Pop_Array_ID ();
        ...
        void Initialize_View_Of_Target ( int Axis , int x , 
                                         const Array_Descriptor_Type & Target_Descriptor );
        ...
        void Initialize_Indirect_Addressing_View_Of_Target ( int Axis , const intArray & X , 
                                         const Array_Descriptor_Type & Target_Descriptor );
#if defined(PPP)
        void Compute_Local_Index_Arrays ( const Array_Descriptor_Type & Original_Descriptor );
        void Initialize_Parallel_Parts_Of_Descriptor ( const Array_Descriptor_Type & X );
     ...
     // I don't know why Sage has a problem with this -- the input arguments seem to be correct!
        inline void Fixup_Array_Descriptor_For_Copy_Constructor ( const Array_Descriptor_Type & X )
           { Array_Domain.Fixup_Array_Domain_For_Copy_Constructor(X.Array_Domain); }
#endif
#endif

     public:
     // Used to free memory-in-use internally in Array_Descriptor_Type objects! 
     ...
     // ********************************************************************************
     // ********************************************************************************
     // *******************  Array_Descriptor_Type DESTRUCTORS  ********************
     // ********************************************************************************
     // ********************************************************************************
     ...
     // void Initialize_Descriptor ( const Array_Descriptor_Type & X ,
     ...
     // void Initialize_Non_Indexed_Dimension ( int x , const Array_Descriptor_Type & X );
     // void Initialize_Indirect_Addressing_View_Of_Target_Non_Indexed_Dimension ( int x , const Array_Descriptor_Type & X );
     // void Preinitialize_Descriptor ( const Array_Descriptor_Type & X );
// if !defined(USE_SAGE)
...
// endif
     ...
     // ********************************************************************************
     // ********************************************************************************
     // *******************  Array_Descriptor_Type CONSTRUCTORS  *******************
     // ********************************************************************************
     // ********************************************************************************
     ...
     // ********************************************************************************
        Array_Descriptor_Type();
        Array_Descriptor_Type( int Number_Of_Valid_Dimensions , 
     ...
     // Array_Descriptor_Type ( ARGUMENT_LIST_MACRO_INTEGER , bool Force_Memory_Allocation );
        Array_Descriptor_Type ( ARGUMENT_LIST_MACRO_INTEGER );
     ...
     //                           const Index_Pointer_Array_MAX_ARRAY_DIMENSION_Type Index_List );
        Array_Descriptor_Type ( const Array_Domain_Type & X, 
                                  const Index_Pointer_Array_MAX_ARRAY_DIMENSION_Type Index_List );

     // Array_Descriptor_Type ( const Integer_Array_MAX_ARRAY_DIMENSION_Type Integer_List );
  ...
  // This simplifies the preinitialization lists.
     ...
     Array_Descriptor_Type ( const Internal_Index & I );
#if (MAX_ARRAY_DIMENSION >= 2)
     Array_Descriptor_Type ( const Internal_Index & I, const Internal_Index & J );
#endif
#if (MAX_ARRAY_DIMENSION >= 3)
     Array_Descriptor_Type ( const Internal_Index & I, const Internal_Index & J,
...
#error MAX_ARRAY_DIMENSION exceeded!
  ...
  // Array_Descriptor_Type( const char* );
     Array_Descriptor_Type( const AppString & X );
     ...
     // Array_Descriptor_Type( const Integer_Array_MAX_ARRAY_DIMENSION_Type Array_Size ,
     //                          const Internal_Partitioning_Type & Internal_Partition );
...
// endif for defined(APP) || defined(PPP)
...
#else
        Array_Descriptor_Type ( const * Data_Pointer, ARGUMENT_LIST_MACRO_CONST_REF_RANGE );

     // This is a redundent constructor
     // Array_Descriptor_Type ( const * Data_Pointer, ARGUMENT_LIST_MACRO_INTEGER);
#endif
     ...
     // they are used in the preinitialization lists for the array object constructors
#if defined(PPP)
        Array_Descriptor_Type( const SerialArray* SerialArray_Pointer ,
             Array_Descriptor_Type<,MAX_ARRAY_DIMENSION>*
             Array_Descriptor_Pointer, Operand_Storage* Array_Storage_Pointer );
#else
        Array_Descriptor_Type( const * Array_Data_Pointer ,
             Array_Descriptor_Type<,MAX_ARRAY_DIMENSION>*
             Array_Descriptor_Pointer , Operand_Storage* Array_Storage_Pointer );
#endif
#endif
        ...
        static void fixupLocalBase ( 
                              Array_Descriptor_Type & New_Parallel_Descriptor,
                        SerialArray_Descriptor_Type & New_Serial_Descriptor,
                  const       Array_Descriptor_Type & Old_Parallel_Descriptor,
                  const SerialArray_Descriptor_Type & Old_Serial_Descriptor );
        void Update_Parallel_Information_Using_Old_Descriptor ( const Array_Descriptor_Type & Old_Array_Descriptor );
#endif
#endif
     ...
     // template<class S, int SecondDimension>
     // Array_Descriptor_Type & operator= ( const Array_Descriptor_Type<S,SecondDimension> & X );

        Array_Descriptor_Type & operator= ( const Array_Descriptor_Type & X );
     // Array_Descriptor_Type & operator= ( const Array_Descriptor_Type<double,MAX_ARRAY_DIMENSION> & X );
     ...
     // This builds a descriptor to represent a 1D (linear) view any data described by the input descriptor.
        static Array_Descriptor_Type *Vectorizing_Descriptor ( const Array_Descriptor_Type & X );

        void Build_Temporary_By_Example ( const Array_Descriptor_Type & X );
...
// ********************************************************************
     ...
     // Dimension independent query functions
        bool isSameBase   ( const Array_Descriptor_Type & X ) const { return Array_Domain.isSameBase(X.Array_Domain); }
        bool isSameBound  ( const Array_Descriptor_Type & X ) const { return Array_Domain.isSameBound(X.Array_Domain); }
        bool isSameStride ( const Array_Descriptor_Type & X ) const { return Array_Domain.isSameStride(X.Array_Domain); }
        bool isSameLength ( const Array_Descriptor_Type & X ) const { return Array_Domain.isSameLength(X.Array_Domain); }
#if defined(PPP)
        bool isSameGhostBoundaryWidth (const Array_Descriptor_Type & X ) const;
        bool isSameDistribution ( const Array_Descriptor_Type & X ) const;
#endif

     // We have a definition of similar which means that the 
     // bases bounds and strides are the same.
        bool isSimilar ( const Array_Descriptor_Type & X ) const { return Array_Domain.isSimilar(X.Array_Domain); }
#endif

     // void expandGhostBoundariesOfRawData ( SerialArray_Descriptor_Type & X, 
...
#if 0
        static bool isPartitioned ( const Array_Descriptor_Type & Parallel_Descriptor, 
                                       const SerialArray_Descriptor_Type & Serial_Descriptor, int Axis );
#endif
	...
	int* setupProcessorListOnPosition 
     ...
     // static int computeArrayDimension ( int Array_Size_I, int Array_Size_J, int Array_Size_K, int Array_Size_L );
        ...
        static int computeArrayDimension ( const Array_Descriptor_Type & X );
...
#if !defined(PPP)
        static void Put_Descriptor_Into_Cache ( Array_Descriptor_Type* & X );

        static Array_Descriptor_Type *Get_Descriptor_From_Cache ( 
             int Array_Size_I , int Array_Size_J , int Array_Size_K , int Array_Size_L );
        static Array_Descriptor_Type *Get_Descriptor_From_Cache ( const Array_Descriptor_Type & X );
        static Array_Descriptor_Type *Get_Descriptor_From_Cache ();
        Array_Descriptor_Type *Get_Descriptor_From_Cache ( const Internal_Index & I );
        Array_Descriptor_Type *Get_Descriptor_From_Cache ( const Internal_Index & I , const Internal_Index & J );
        Array_Descriptor_Type *Get_Descriptor_From_Cache ( const Internal_Index & I , const Internal_Index & J , 
                                                             const Internal_Index & K );
        Array_Descriptor_Type *Get_Descriptor_From_Cache ( const Internal_Index & I , const Internal_Index & J , 
                                                             const Internal_Index & K , const Internal_Index & L );
