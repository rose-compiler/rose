// This test code generates a different error for Charles, and we will resolve this in the morning.
// For now we can at least identify that it does generate an error in the frontend of ROSE (a case ot handled).
