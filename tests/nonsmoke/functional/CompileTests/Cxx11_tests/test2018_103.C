...
namespace std __attribute__ ((__visibility__ ("default")))
{
  ...
  template<typename _Unqualified>
    ...
    { typedef _Unqualified __type; /* CYCLE */ };
  ...
  template<typename _Qualified, typename _Unqualified,
    ...
    public:
      typedef typename __match::__type __type; // CYCLE
    };
  ...
  template<typename _Tp>
    ...
    public:
      typedef typename __cv_unsigned::__type __type; // CYCLE
    };
  ...
  template<typename _Tp>
    ...
    { typedef typename __make_unsigned_selector<_Tp>::__type type; /* CYCLE */ };
