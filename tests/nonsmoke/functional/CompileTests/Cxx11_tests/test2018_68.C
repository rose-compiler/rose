...
namespace Namespace1
   {
     ...
     template <typename t_ty_Parm11, typename t_ty_Parm12>
     struct t_Struct1 {};

     template <typename t_ty_Parm13>
     struct t_Struct1 <t_ty_Parm13, typename t_ty_Parm13::Typedef4>
        {
          typedef int t_ty_Typedef7;
        }; // end t_Struct1

     template<typename t_ty_Parm14, typename t_ty_Parm15> t_Class0<t_Class6<typename t_Struct1<t_ty_Parm14, t_ty_Parm15>::t_ty_Typedef7> >
     t_func1();
