...
namespace NewLaserNamespace
   {
#if 0
  // DQ (8/19/2014): g++ reports this as a bug (so I moved the template instantiation directive to the outer scope).
...
// Error: unparses as: template class NewLaserMaterialDataBase< LRTMeshTypes  > ;
template class NewLaserMaterialDataBase<LRT_namespace::LRTMeshTypes>;
