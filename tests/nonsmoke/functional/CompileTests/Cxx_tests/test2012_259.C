// DQ (11/26/2012):
// This test code is the same as 2004_15.C, except that
// it has been a basis for removing some pragmas that
// were a problem for the current switch statement handling.
// However the best fix to date was to disable some of the 
// most recent pragma support in switch statements.  A
// better implementation of switch is required in the future.
// But this is not a suprise, since switch is a complex subject
