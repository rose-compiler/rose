...
main() {
    ...
    SymbolicExpression::Ptr a = SymbolicExpression::makeIntegerVariable(32, "a");
    SymbolicExpression::Ptr b = SymbolicExpression::makeIntegerConstant(32, 4);
    SymbolicExpression::Ptr c = SymbolicExpression::makeAdd(a, b);
