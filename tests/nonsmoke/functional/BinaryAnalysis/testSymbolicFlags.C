...
testSetting() {
    ...
    SymbolicExpression::Ptr e1 = SymbolicExpression::makeIntegerVariable(32, "e1");
    ASSERT_always_require(e1->flags() == 0);

    // Flags are always specified after a comment string
    SymbolicExpression::Ptr e2 = SymbolicExpression::makeIntegerVariable(32, "e2", UNDEFINED);
    ASSERT_always_require(e2->flags() == UNDEFINED);

    // Flags can be specified for things other than variables
    SymbolicExpression::Ptr e3 = SymbolicExpression::makeIntegerConstant(32, 0, "e3", INVALID);
    ASSERT_always_require(e3->flags() == INVALID);
    SymbolicExpression::Ptr e4 = SymbolicExpression::makeIntegerConstant(Sawyer::Container::BitVector(128), "e4", UNDEFINED|INVALID);
    ASSERT_always_require(e4->flags() == (UNDEFINED|INVALID));
    SymbolicExpression::Ptr e5 = SymbolicExpression::makeBooleanConstant(true, "e5", UNDEFINED);
    ASSERT_always_require(e5->flags() == UNDEFINED);
    SymbolicExpression::Ptr e6 = SymbolicExpression::makeMemoryVariable(32, 32, "e6", INVALID);
...
testInternal() {
    ...
    SymbolicExpression::Ptr e1 = SymbolicExpression::makeIntegerVariable(32, "e1", UNDEFINED);
    SymbolicExpression::Ptr e2 = SymbolicExpression::makeIntegerVariable(32, "e2", INVALID);
    SymbolicExpression::Ptr e3 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_ADD, e1, e2);
...
testPrinting() {
    ...
    SymbolicExpression::Ptr b = SymbolicExpression::makeIntegerVariable(32, "b", INVALID);
    SymbolicExpression::Ptr a = SymbolicExpression::makeIntegerVariable(32, "a", UNDEFINED);
    SymbolicExpression::Ptr e1 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_ADD, a, b);
    std::cout <<"  e1 = " <<*e1 <<"\n";
}
...
testDiscardRule() {
    ...
    SymbolicExpression::Ptr e1 = SymbolicExpression::makeIntegerVariable(32, "e1", UNDEFINED);
    SymbolicExpression::Ptr e2 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_NEGATE, e1);
    SymbolicExpression::Ptr e3 = SymbolicExpression::makeIntegerVariable(32, "e3", INVALID);
    SymbolicExpression::Ptr e4 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_ADD, e1, e2, e3);
    std::cout <<"  e4 = " <<*e4 <<"\n";
...
testNewExprRule() {
    ...
    SymbolicExpression::Ptr e1 = SymbolicExpression::makeIntegerVariable(32, "e1", UNDEFINED);
    SymbolicExpression::Ptr e2 =
        SymbolicExpression::Interior::instance(SymbolicExpression::OP_ADD, e1,
                                               SymbolicExpression::Interior::instance(SymbolicExpression::OP_NEGATE, e1,
                                                                                      SmtSolverPtr()),
                                               SmtSolverPtr());
    std::cout <<"  e2 = " <<*e2 <<"\n";
    ASSERT_always_require(e2->flags() == 0);

    SymbolicExpression::Ptr e3 =
        SymbolicExpression::Interior::instance(SymbolicExpression::OP_ADD, e1,
                                               SymbolicExpression::Interior::instance(SymbolicExpression::OP_INVERT, e1,
                                                                                      SmtSolverPtr()),
                                               SmtSolverPtr());
    std::cout <<"  e3 = " <<*e3 <<"\n";
    ASSERT_always_require(e3->flags() == 0);

    SymbolicExpression::Ptr e4 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_XOR, e1, e1);
    std::cout <<"  e4 = " <<*e4 <<"\n";
...
testFoldingRule() {
    ...
    SymbolicExpression::Ptr e1 = SymbolicExpression::makeIntegerConstant(32, 7, "e1", UNDEFINED);
    SymbolicExpression::Ptr e2 = SymbolicExpression::makeIntegerConstant(32, 8, "e2", INVALID);
    SymbolicExpression::Ptr e3 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_ADD, e1, e2);
    std::cout <<"  e3 = " <<*e3 <<"\n";
    ASSERT_always_require(e3->flags() == (UNDEFINED|INVALID));
}
...
testHashing() {
    ...
    SymbolicExpression::Ptr e1 = SymbolicExpression::makeIntegerConstant(32, 7, "", 0);
    SymbolicExpression::Ptr e2 = SymbolicExpression::makeIntegerConstant(32, 7, "", UNDEFINED);
...
testRelationalFolding() {
    ...
    SymbolicExpression::Ptr e3 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_ULT, e1, e2);
    std::cout <<"  e3 = " <<*e3 <<"\n";
    ASSERT_always_require(e3->flags() == (UNDEFINED|INVALID));

    SymbolicExpression::Ptr e4 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_ULT, e2, e1);
    std::cout <<"  e4 = " <<*e4 <<"\n";
    ASSERT_always_require(e4->flags() == (UNDEFINED|INVALID));

    SymbolicExpression::Ptr e5 = SymbolicExpression::makeIntegerVariable(32, "e5", UNDEFINED);
    SymbolicExpression::Ptr e6 = SymbolicExpression::Interior::instance(SymbolicExpression::OP_EQ, e5, e5);
    std::cout <<"  e6 = " <<*e6 <<"\n";
