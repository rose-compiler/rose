...
MyTraversal::visit(SgNode* astNode)
{
    ...
    if (symsec && symsec->get_name()->get_string()==".dynsym") {
        ...
        ASSERT_always_require(strsec!=NULL);
        ...
        ASSERT_always_require(test!=NULL);
        ...
        ASSERT_always_require(s1->get_string()==""); /*must comply with spec!*/
        s1->set_string("fprintf");
        ASSERT_always_require(s1->get_offset()!=SgAsmStoredString::unallocated);
        ASSERT_always_require(s1->get_offset()!=0);
        ...
        ASSERT_always_require(s1->get_offset()!=SgAsmStoredString::unallocated);
        ASSERT_always_require(s1->get_offset()==test->get_offset());
        ...
        ASSERT_always_require(s1->get_offset()!=SgAsmStoredString::unallocated);
        ASSERT_always_require(s1->get_offset()==test->get_offset()+1);
        ...
        ASSERT_always_require(s1->get_offset()!=SgAsmStoredString::unallocated);
        ASSERT_always_require(s1->get_offset()+s1->get_string().size()+1 <= test->get_offset() ||  /*left of test*/
        ...
        ASSERT_always_require(s1->get_offset()!=SgAsmStoredString::unallocated);
        ASSERT_always_require(s1->get_offset()==copy.get_offset());
        ASSERT_always_require(s1->get_string()==copy.get_string());
        ...
        s1->set_string("");
        ASSERT_always_require(s1->get_offset()==0);
        ASSERT_always_require(copy.get_offset()==0);
        ASSERT_always_require(copy.get_string()=="");
        ...
        ASSERT_always_require(orig_size==strsec->get_size());
        ...
        ASSERT_always_require(s2->get_offset()==0);
        ASSERT_always_require(s2->get_string()=="");
