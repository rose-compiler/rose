void (*OUT_3_jacobi_141p)(void **);
void (*OUT_2_jacobi_206p)(void **);
void (*OUT_1_jacobi_249p)(void **);
#include <stdio.h>
#include <math.h>
#include <assert.h>
// Add timing support
...
//double PI=3.1415926;
  ...
  OUT_3_jacobi_141p = findFunctionUsingDlopen("OUT_3_jacobi_141","./jacobi_with_OUT.so");
/* Initialize initial condition and RHS */
  ( *OUT_3_jacobi_141p)(__out_argv3__1527__);
}
...
/* Copy new solution into old */
    ...
    OUT_2_jacobi_206p = findFunctionUsingDlopen("OUT_2_jacobi_206","./jacobi_with_OUT.so");
    ( *OUT_2_jacobi_206p)(__out_argv2__1527__);
/* Error check */
    k = k + 1;
    if (k % 500 == 0) 
...
void error_check()
{
  ...
  OUT_1_jacobi_249p = findFunctionUsingDlopen("OUT_1_jacobi_249","./jacobi_with_OUT.so");
  ( *OUT_1_jacobi_249p)(__out_argv1__1527__);
  error = sqrt(error) / (n * m);
