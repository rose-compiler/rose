...
void visitorTraversal::analyzePath(vector<VertexID>& pth) {
        ...
        //if (find(pths.begin(), pths.end(), pth) == pths.end()) {
          //  std::cout << "confirmed path" << std::endl;
            cps++;
        if (cps % 10000 == 0) {
...
int main() {
       ...
       EdgeID g2;
       boost::tie(g2, ok) = boost::add_edge(vidComplex[0], vidComplex[2], *graph1);
       EdgeID g3;
       boost::tie(g3, ok) = boost::add_edge(vidComplex[2], vidComplex[3], *graph1);
       EdgeID g4;
       boost::tie(g4, ok) = boost::add_edge(vidComplex[1], vidComplex[3], *graph1);
       EdgeID g5;
       boost::tie(g5, ok) = boost::add_edge(vidComplex[2], vidComplex[1], *graph1);
       EdgeID g6;
       boost::tie(g6, ok) = boost::add_edge(vidComplex[1], vidComplex[2], *graph1);
       

       EdgeID g7;
       boost::tie(g7, ok) = boost::add_edge(vidComplex[4], vidComplex[5], *graph2);
       EdgeID g8;
       boost::tie(g8, ok) = boost::add_edge(vidComplex[5], vidComplex[6], *graph2);
       EdgeID g23;
       boost::tie(g23, ok) = boost::add_edge(vidComplex[6], vidComplex[7], *graph2);
       EdgeID g24;
       boost::tie(g24, ok) = boost::add_edge(vidComplex[6], vidComplex[5], *graph2);
       EdgeID g9;
       boost::tie(g9, ok) = boost::add_edge(vidComplex[5], vidComplex[8], *graph2);
       EdgeID g10;
       boost::tie(g10, ok) = boost::add_edge(vidComplex[8], vidComplex[5], *graph2);
       EdgeID g11;
       boost::tie(g11, ok) = boost::add_edge(vidComplex[5], vidComplex[7], *graph2);
       EdgeID g12;
       boost::tie(g12, ok) = boost::add_edge(vidComplex[7], vidComplex[5], *graph2);
       EdgeID g13;
       boost::tie(g13, ok) = boost::add_edge(vidComplex[8], vidComplex[9], *graph2);
       EdgeID g26;
       boost::tie(g26, ok) = boost::add_edge(vidComplex[7], vidComplex[8], *graph2);

       

       EdgeID g25;
       boost::tie(g25, ok) = boost::add_edge(vidComplex[16], vidComplex[10], *graph3);
       EdgeID g14;
       boost::tie(g14, ok) = boost::add_edge(vidComplex[10], vidComplex[11], *graph3);
       EdgeID g15;
       boost::tie(g15, ok) = boost::add_edge(vidComplex[10], vidComplex[12], *graph3);
       EdgeID g16;
       boost::tie(g16, ok) = boost::add_edge(vidComplex[10], vidComplex[13], *graph3);
       EdgeID g17;
       boost::tie(g17, ok) = boost::add_edge(vidComplex[10], vidComplex[14], *graph3);
       EdgeID g18;
       boost::tie(g18, ok) = boost::add_edge(vidComplex[14], vidComplex[13], *graph3);
       EdgeID g19;
       boost::tie(g19, ok) = boost::add_edge(vidComplex[14], vidComplex[12], *graph3);
       EdgeID g20;
       boost::tie(g20, ok) = boost::add_edge(vidComplex[14], vidComplex[11], *graph3);
       EdgeID g21;
       boost::tie(g21, ok) = boost::add_edge(vidComplex[14], vidComplex[10], *graph3);
       EdgeID g22;
       boost::tie(g22, ok) = boost::add_edge(vidComplex[14], vidComplex[15], *graph3);
       EdgeID g27;
       boost::tie(g27, ok) = boost::add_edge(vidComplex[11], vidComplex[12], *graph3);
       EdgeID g28;
       boost::tie(g28, ok) = boost::add_edge(vidComplex[12], vidComplex[13], *graph3);
       EdgeID g29;
       boost::tie(g29, ok) = boost::add_edge(vidComplex[13], vidComplex[14], *graph3);
...
visitorTraversal* xis1 = new visitorTraversal;
       ...
       xis1->constructPathAnalyzer(graph1, false, vidComplex[0], vidComplex[3]);
       std::cout << "end xis1" << std::endl;
       std::cout << "xis1 cps: " << xis1->cps << " repeats: " << xis1->repeats2 << std::endl;
visitorTraversal* xis2 = new visitorTraversal;
       xis2->cps = 0;
       xis2->repeats2 = 0;
       std::cout << "begin xiz2" << std::endl;
       xis2->constructPathAnalyzer(graph2, false, vidComplex[4], vidComplex[9]);
       std::cout << "end xiz2" << std::endl;
       std::cout << "xis2 cps: " << xis2->cps << " repeats: " << xis2->repeats2 << std::endl;
visitorTraversal* xis3 = new visitorTraversal;
       xis3->cps = 0;
       xis3->repeats2 = 0;
       std::cout << "begin xis3" << std::endl;
       xis3->constructPathAnalyzer(graph3, false, vidComplex[16], vidComplex[15]);
       std::cout << "end xis3" << std::endl;
       std::cout << "xis3 cps: " << xis3->cps << " repeats: " << xis3->repeats2 <<  std::endl;

/*
for (int i = 0; i < xis1->pths.size(); i++) {
    for (int j = 0; j < xis1->pths[i].size(); j++) {
