...
// Criminy!  We don't need more than one of these!!! -JNJ
//   T *bare_ptr () const { return p; } // Better know what you're doing!

   // Added to supplant SmartPointer class in ReferenceField.  Forgive me.
   // Jeffrey Johnson, 07.23.2001
