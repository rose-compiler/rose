...
void
RPM_unparser::unparse(std::ostream &o, SgAsmInstruction *insn)
{
    pre(o, insn);
...
void
RPM_unparser::unparse(std::ostream &o, SgAsmBlock *blk)
{
    pre(o, blk);
...
void
RPM_unparser::unparse(std::ostream &o, SgAsmFunctionDeclaration *func)
{
    pre(o, func);
...
void
RPM_unparser::unparse(std::ostream &o, SgAsmInterpretation *interp)
{
    pre(o, interp);
