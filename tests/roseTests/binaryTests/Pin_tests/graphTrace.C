...
// DQ (3/9/2009): Static linking of ROSE (using --enable-static on the conrigure commandline) 
// allows Intel Pin to preperly work with Pin tools that use ROSE (librose.a).
// I can't figure out how to put this into ROSE and make -lrose link with a pin tool
// (fails to load the pin tool, I requested help from the user group). for now just
// include the common support code that helps support our use of Pin.
// #include "pinSupport.C"
