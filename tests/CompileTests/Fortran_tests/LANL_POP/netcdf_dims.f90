  ...
  !
  ! -----------
  function nf90_def_dim(ncid, name, len1, dimid)
    ...
    nf90_def_dim = nf_def_dim(ncid, name, len1, dimid)
  ...
  ! -----------
  function nf90_inquire_dimension(ncid, dimid, name, len2)
    integer,                       intent( in) :: ncid, dimid
    character (len = *), optional, intent(out) :: name
    integer,             optional, intent(out) :: len2
