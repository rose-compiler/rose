...
// Don't require OpenMP for these C++ regression tests (this is tested elsewhere in ROSE).
// However, this code should still compile without the omp.h header file..
// #include "omp.h" 
