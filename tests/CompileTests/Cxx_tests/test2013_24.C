...
namespace BoxLib
{
    extern long total_bytes_allocated_in_fabs;
    extern long total_bytes_allocated_in_fabs_hwm;
}

// # 71 "/home/dquinlan/ROSE/BOXLIB/BoxLib/Src/C_BaseLib/BaseFab.H"
template <class T>
class BaseFab
{
public:
...
// # 176 "/home/dquinlan/ROSE/BOXLIB/BoxLib/Src/C_BaseLib/BaseFab.H"
    T* dataPtr (int n = 0) 
       {
         return 0L;
       }
