...
// # 25 "/usr/include/glob.h" 3 4

// # 89 "/usr/include/glob.h" 3 4
struct stat;
...
extern int statfs (__const char *__file, struct statfs *__buf) __asm__ ("" "statfs64") __attribute__ ((__nothrow__))
...
extern int fstatfs (int __fildes, struct statfs *__buf) __asm__ ("" "fstatfs64") __attribute__ ((__nothrow__))
