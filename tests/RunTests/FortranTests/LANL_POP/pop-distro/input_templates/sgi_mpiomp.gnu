...
FBASE = $(ABI) -r10000 -mp $(NETCDFINC) -I$(ObjDepDir)
...
LDFLAGS = $(ABI) -mips4 -r10000 -mp -Wl,-u,MAIN__
...
%.o: %.f
	@echo SGI MPI OPENMP Compiling with implicit rule $<
	@$(FC) $(FFLAGS) -c $<
...
$(SrcDepDir)/%$(DEPSUF): %.F
	@echo 'SGI MPI OPENMP Making depends for preprocessing' $<
...
$(ObjDepDir)/%$(DEPSUF): %.f
	...
	@echo 'SGI MPI OPENMP Making depends for compiling' $<
