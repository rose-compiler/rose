 ...
 */
/* $Id: var.c,v 1.136 2010/04/11 04:15:43 dmh Exp $ */
...
int
DISPNAME(def_var)( int ncid, const char *name, nc_type type,
...
int
DISPNAME(rename_var)(int ncid, int varid, const char *unewname)
{
	int status;
	NC *ncp;
	NC_var *varp;
