...
// if !defined(AVOID_FACIST_STL_OPERATORS)
// STL has forced a particularly bad problem here such that 
// array definitions of these functions (as member functions)
// can not be readily seen at compile time.
...
// endif // if defined(AVOID_FACIST_STL_OPERATORS)
