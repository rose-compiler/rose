...
AC_DEFUN([GET_COMPILER_SPECIFIC_DEFINES],[
    ...
    FRONTEND_CXX_VENDOR_AND_VERSION="$FRONTEND_CXX_COMPILER_VENDOR-$FRONTEND_CXX_VERSION_TRIPLET"
    AC_SUBST(FRONTEND_CXX_VENDOR_AND_VERSION)

    BACKEND_CXX_VENDOR_AND_VERSION="$BACKEND_CXX_COMPILER_VENDOR-$BACKEND_CXX_VERSION_TRIPLET"
    AC_SUBST(BACKEND_CXX_VENDOR_AND_VERSION)
