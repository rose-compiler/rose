// This test was normalized to use it as an analyterix test. Code that was normalized
//  is marked with "ADJUSTED".
...
/*  Now, finally, sort the keys:  */
    for( i=0; i<NUM_KEYS; i++ ) {
      // ADJUSTED!! normalized decrement operator
        key_array[key_buff_ptr_global[key_buff2[i]] -= 1] = key_buff2[i];
    }
...
/*  In this section, the keys themselves are used as their
    ...
    individual population                                       */
        // ADJUSTED!! normalized increment operator
        prv_buff1[key_buff2[i]] += 1;  /* Now they have individual key   */
    }
                                       /* population                     */
