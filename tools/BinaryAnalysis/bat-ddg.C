static const char *purpose = "data dependence graphs";
static const char *description =
    "Computes and prints data dependence graphs.";

#include <rose.h>                                       // legacy header needed by some other headers

#include <batSupport.h>

#include <Rose/BinaryAnalysis.h>
...
main(int argc, char *argv[]) {
    ...
    mlog.comment("operating on data dependence graphs");
    ...
    for (const P2::Function::Ptr &function: selectedFunctions) {
        DataDependence::Graph ddg = DataDependence::createFromFunction(partitioner, function);
        std::cout <<ddg;
    }
}
