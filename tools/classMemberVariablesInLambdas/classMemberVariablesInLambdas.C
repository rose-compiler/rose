...
struct Traversal : public SgTopDownBottomUpProcessing<InheritedAttribute,SynthesizedAttribute> {
    Traversal();

    // Functions required
    InheritedAttribute evaluateInheritedAttribute(SgNode* astNode, InheritedAttribute inheritedAttribute);
    SynthesizedAttribute evaluateSynthesizedAttribute(SgNode* astNode, InheritedAttribute inheritedAttribute,
...
SynthesizedAttribute
Traversal::evaluateSynthesizedAttribute(SgNode* /*astNode*/,
                                        InheritedAttribute /*inheritedAttribute*/,
