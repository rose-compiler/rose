...
// Provide implementations of global new and delete operators
void operator delete (void* pointer) {}
void* operator new (size_t size) { return 0L; }
...
void* B3::operator new    (size_t size) { return 0L; }
void  B3::operator delete (void* pointer) {}
