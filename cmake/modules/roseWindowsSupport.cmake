...
elseif (MSVC_VERSION STREQUAL "1924")
  set(BACKEND_CXX_COMPILER_MAJOR_VERSION_NUMBER 19)
  set(BACKEND_CXX_COMPILER_MINOR_VERSION_NUMBER 24)
else()
  string(SUBSTRING "${MSVC_VERSION}" 0 2 BACKEND_CXX_COMPILER_MAJOR_VERSION_NUMBER)
  string(SUBSTRING "${MSVC_VERSION}" 2 2 BACKEND_CXX_COMPILER_MINOR_VERSION_NUMBER)
endif()
